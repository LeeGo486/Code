...
namespace ElegantWM.Tools
{
    ...
    public class MessageBoxHelper
    {
        ...
        /// 输出</from>
        /// </summary>
        /// <param name="page">当</param>
        /// <param name="script">输出脚本</param>
        public static void ResponseScriptFrom(System.Web.UI.Page page, string script)
        {
            page.ClientScript.RegisterClientScriptBlock(page.GetType(), "message", "<script>" + script + "</script>");
