...
{
    [Description("Game_QARst")]
    public class GameQARstController : BaseController
    {
        [Page]
        [Description("Game_QARst")]
        ...
        {
            int totalCount = 0;
            var list = WMFactory.GameQARst.FindByPage(start, limit, out totalCount,
        ...
        [Description("更新")]
        [HttpPut]
        public JsonResult Put(Game_QARst _t)
        {
            IGameQARstService service = WMFactory.GameQARst;
            Game_QARst entity = service.GetById(_t.Id.ToString());
            entity = AutoMapper<Game_QARst, Game_QARst>.Convert(_t, entity);
        ...
        [Description("新增")]
        [HttpPost]
        public JsonResult Post(Game_QARst _t)
        {
            if (WMFactory.GameQARst.Insert(_t))
        ...
        [Description("删除")]
        [HttpDelete]
        public JsonResult Delete(Game_QARst _t)
        {
            if (WMFactory.GameQARst.Delete(s => s.Id == _t.Id ))
