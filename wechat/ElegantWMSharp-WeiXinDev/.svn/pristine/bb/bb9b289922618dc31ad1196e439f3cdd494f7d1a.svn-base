Ext.define('WMC.controller.Main', {
    ...
    models: ['WXLKRegMemberFans'],
    stores: ['WXLKRegMemberFans'],
    views: ['MainGrid'],
    ...
    onLaunch: function () {
        //根据权限控制界面按钮状态
        //Ext.Tools.CtrlButtonsByPermession("WXLKRegMemberFans", this.getMainGrid(), false);
    },
    //解决rowEditor插件的按钮bug
    ...
    addRecord: function () {
        ...
        var r = Ext.create('WMC.model.WXLKRegMemberFans', {
