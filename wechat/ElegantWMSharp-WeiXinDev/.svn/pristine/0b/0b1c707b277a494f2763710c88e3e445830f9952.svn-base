...
{
    public class HZYAuthFilter : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (!string.IsNullOrEmpty(filterContext.HttpContext.Request["sid"]) && !string.IsNullOrEmpty(filterContext.HttpContext.Request["oid"]))
            {
                ...
                //{
                //    filterContext.Result = new RedirectResult("http://mp.weixin.qq.com/s?__biz=MzIwODAxNzA1OQ==&mid=209452489&idx=1&sn=d725ac690920900789eb1f5f713290f7#rd");
                //    return;
                //}
