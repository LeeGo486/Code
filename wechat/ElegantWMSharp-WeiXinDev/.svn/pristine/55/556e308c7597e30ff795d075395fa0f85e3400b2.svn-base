...
{
    [Description("GameUserInfo")]
    public class GameUserInfoController : BaseController
    {
        [Page]
        [Description("GameUserInfo")]
        ...
        {
            int totalCount = 0;
            var list = WMFactory.GameUserInfo.FindByPage(start, limit, out totalCount,
        ...
        {
            IGameUserInfoService service = WMFactory.GameUserInfo;
        ...
        {
            if (WMFactory.GameUserInfo.Insert(_t))
        ...
        {
            if (WMFactory.GameUserInfo.Delete(s => s.Id == _t.Id))
