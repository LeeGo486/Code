...
{
    [Description("Game_Img")]
    public class Game_ImgController : BaseController
    {
        [Page]
        [Description("Game_Img")]
        ...
        {
            int totalCount = 0;
            var list = WMFactory.Game_Img.FindByPage(start, limit, out totalCount,
        ...
        [Description("更新")]
        [HttpPut]
        public JsonResult Put(Game_Img _t)
        {
            IGame_ImgService service = WMFactory.Game_Img;
            Game_Img entity = service.GetById(_t.Id.ToString());
            entity = AutoMapper<Game_Img, Game_Img>.Convert(_t, entity);
        ...
        [Description("新增")]
        [HttpPost]
        public JsonResult Post(Game_Img _t)
        {
            if (WMFactory.Game_Img.Insert(_t))
        ...
        [Description("删除")]
        [HttpDelete]
        public JsonResult Delete(Game_Img _t)
        {
            if (WMFactory.Game_Img.Delete(s => s.Id == _t.Id ))
