...
{
    [Description("")]
    public class Game_QrstController : BaseController
    {
        [Page]
        [Description("")]
        ...
        {
            int totalCount = 0;
            var list = WMFactory.Game_Qrst.FindByPage(start, limit, out totalCount,
        ...
        [Description("更新")]
        [HttpPut]
        public JsonResult Put(Game_Qrst _t)
        {
            IGame_QrstService service = WMFactory.Game_Qrst;
            Game_Qrst entity = service.GetById(_t.Id.ToString());
            entity = AutoMapper<Game_Qrst, Game_Qrst>.Convert(_t, entity);
        ...
        [Description("新增")]
        [HttpPost]
        public JsonResult Post(Game_Qrst _t)
        {
            if (WMFactory.Game_Qrst.Insert(_t))
        ...
        [Description("删除")]
        [HttpDelete]
        public JsonResult Delete(Game_Qrst _t)
        {
            if (WMFactory.Game_Qrst.Delete(s => s.Id == _t.Id ))
