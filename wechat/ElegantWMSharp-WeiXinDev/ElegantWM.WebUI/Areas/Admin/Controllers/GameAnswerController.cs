...
{
    [Description("Game_Answer")]
    public class GameAnswerController : BaseController
    {
        [Page]
        [Description("Game_Answer")]
        ...
        {
            int totalCount = 0;
            var list = WMFactory.GameAnswer.FindByPage(start, limit, out totalCount,
        ...
        [Description("更新")]
        [HttpPut]
        public JsonResult Put(Game_Answer _t)
        {
            IGameAnswerService service = WMFactory.GameAnswer;
            Game_Answer entity = service.GetById(_t.Id.ToString());
            entity = AutoMapper<Game_Answer, Game_Answer>.Convert(_t, entity);
        ...
        [Description("新增")]
        [HttpPost]
        public JsonResult Post(Game_Answer _t)
        {
            if (WMFactory.GameAnswer.Insert(_t))
        ...
        [Description("删除")]
        [HttpDelete]
        public JsonResult Delete(Game_Answer _t)
        {
            if (WMFactory.GameAnswer.Delete(s => s.Id == _t.Id ))
