...
{
    [Description("GLGame_Record")]
    public class GLGameRecordController : BaseController
    {
        [Page]
        [Description("GLGame_Record")]
        ...
        {
            int totalCount = 0;
            var list = WMFactory.GLGameRecord.FindByPage(start, limit, out totalCount,
        ...
        {
            IGLGameRecordService service = WMFactory.GLGameRecord;
        ...
        {
            if (WMFactory.GLGameRecord.Insert(_t))
        ...
        {
            if (WMFactory.GLGameRecord.Delete(s => s.Id == _t.Id ))
