Ext.define('WMC.controller.Main', {
    ...
    models: ['Fire_Question'],
    stores: ['Fire_Question'],
    views: ['MainGrid'],
    ...
    onLaunch: function () {
        //根据权限控制界面按钮状态
        //Ext.Tools.CtrlButtonsByPermession("Fire_Question", this.getMainGrid(), false);
    },
    //解决rowEditor插件的按钮bug
    ...
    addRecord: function () {
        ...
        var r = Ext.create('WMC.model.Fire_Question', {
