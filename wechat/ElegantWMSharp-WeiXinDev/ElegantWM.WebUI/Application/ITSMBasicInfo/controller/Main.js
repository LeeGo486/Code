Ext.define('WMC.controller.Main', {
    ...
    models: ['ITSMBasicInfo'],
    stores: ['ITSMBasicInfo'],
    views: ['MainGrid'],
    ...
    onLaunch: function () {
        //根据权限控制界面按钮状态
        //Ext.Tools.CtrlButtonsByPermession("ITSMBasicInfo", this.getMainGrid(), false);
    },
    //解决rowEditor插件的按钮bug
    ...
    addRecord: function () {
        ...
        var r = Ext.create('WMC.model.ITSMBasicInfo', {
