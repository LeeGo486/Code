Ext.define('WMC.controller.Main', {
    ...
    models: ['WXFans', 'Account'],
    stores: ['WXFans', 'Account'],
    views: ['MainGrid'],
    ...
    init: function () {
        this.control({
            'maingrid combobox[name=cbAccount]': {
                select: this.loadWXFans
            }
        }); 
    },
    onLaunch: function () {
        //根据权限控制界面按钮状态
        //Ext.Tools.CtrlButtonsByPermession("WXFans", this.getMainGrid(), false);
    },
    ...
    addRecord: function () {
        ...
        var r = Ext.create('WMC.model.WXFans', {
