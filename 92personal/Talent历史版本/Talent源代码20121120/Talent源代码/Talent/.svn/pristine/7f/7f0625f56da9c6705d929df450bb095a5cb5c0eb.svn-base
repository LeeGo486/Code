...
namespace Talent.DAL
{
	...
	public partial class TB_RC_Permission
	{
        ...
        public bool isAdmin(string name)
        {
            ...
            strSql.Append("select count(1) from TB_RC_Permission");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into TB_RC_Permission(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update TB_RC_Permission set ");
		...
		public bool Delete(int PM_No)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from TB_RC_Permission ");
			strSql.Append(" where PM_No=@PM_No");
			SqlParameter[] parameters = {
					new SqlParameter("@PM_No", SqlDbType.Int,4)
			};
        ...
        public Talent.Model.TB_RC_Permission GetModel(int PM_No)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 PM_No,PM_Login,PM_Level,PM_Province from TB_RC_Permission ");
			strSql.Append(" where PM_No=@PM_No");
			SqlParameter[] parameters = {
					new SqlParameter("@PM_No", SqlDbType.Int,4)
			};
            ...
            Talent.Model.TB_RC_Permission model = new Talent.Model.TB_RC_Permission();
		...
		public DataSet GetList(string strWhere)
		{
            ...
            strSql.Append(" FROM TB_RC_Permission  where PM_Level!=9 ");
			if(strWhere.Trim()!="")
			{
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, int pager)
        {
            ...
            strSql.Append(" TB_RC_Permission where PM_Level!=9 ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" and " + strWhere);
            }
        ...
        public Object GetTotal(string strWhere)
        {
            ...
            strSql.Append(" TB_RC_Permission ");
            if (strWhere.Trim() != "")
            {
