...
<div class="pageContent">
    <div class="panelBar">
		<ul class="toolBar">
            <li <%=Request["level"] == "9" ?"":"style='display:none'" %> ><a class="add" href="Authority/EditAuthority.aspx" target="dialog" rel="editauthority" width="530" height="300" ><span>新增</span></a></li>
            <li><a class="edit" href='Authority/EditAuthority.aspx?PM_No={sid_authority}&level=<%=Request["level"] %>'  target="dialog" rel="editauthority" width="530" height="300" ><span>编辑</span></a></li>
