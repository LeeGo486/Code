    ...
    public partial class TalentLlist : System.Web.UI.Page
    {
        ...
        protected void GetListManager(StringBuilder sb, List<Model.TB_RC_TalentInfor> list,int itemindex)
        {
            foreach (var obj in list)
            {
                ...
                sb.Append("</td><td>");
                sb.Append("<input name='TI_BrandName' class='textInput lgray' onblur='switchjs(this)'  value='" + obj.TI_BrandName + "' size='30' />");
                sb.Append("</td><td>");
                sb.Append("<input name='TI_Industry' class='textInput lgray' onblur='switchjs(this)'  value='" + obj.TI_Industry + "' size='30' />");
                sb.Append("</td><td>");
                //sb.Append("<input name='TI_TalentClass' class='textInput lgray' onblur='switchjs(this)' value='" + obj.TI_TalentClass + "' size='25' />");
                sb.Append(GetTalentOption(obj.TI_TalentClass));
                sb.Append("</td><td>");
                sb.Append("<input name='TI_Name' class='textInput lgray' onblur='switchjs(this)' value='" + obj.TI_Name + "' size='25' />");
                sb.Append("</td><td>");
                ...
                sb.Append("</td><td>");
                sb.Append("<input name='TI_Phone' class='textInput lgray' onblur='switchjs(this)' size='15' value='" + obj.TI_Phone + "' />");
                sb.Append("</td><td>");
                sb.Append("<input name='TI_Work' class='textInput lgray' onblur='switchjs(this)' size='67' value='" + obj.TI_Work + "' />");
                sb.Append("</td><td>");
                sb.Append("<input name='TI_Src' class='textInput lgray' onblur='switchjs(this)' size='15' value='" + obj.TI_Src + "' />");
                sb.Append("</td><td>");
                sb.Append("<input name='TI_Recommend' class='textInput lgray' onblur='switchjs(this)' size='15' value='" + obj.TI_Recommend + "' />");
                sb.Append("</td><td>");
                sb.Append("<input name='TI_RecommendDate' class='date lgray' size='15' value='" +( obj.TI_RecommendDate == null ? "" : obj.TI_RecommendDate.Value.ToString("yyyy-MM-dd")) + "' />");
                sb.Append("</td><td>");
                sb.Append("<input name='TI_RecommendPost' class='textInput lgray' onblur='switchjs(this)' size='15' value='" + obj.TI_RecommendPost + "' />");
                sb.Append("</td><td>");
                sb.Append("<input name='TI_Mark' class='textInput lgray' size='15' onblur='switchjs(this)' value='" + obj.TI_Mark + "' />");
                sb.Append("</td><td>");
                ...
                sb.Append("</td><td>");
                sb.Append("<input name='TI_AuditionResult' onblur='switchjs(this)' class='textInput lgray' size='15'  value='" + obj.TI_AuditionResult + "' />");
                sb.Append("</td><td>");
                sb.Append("<input name='TI_FollowUpPeople' onblur='switchjs(this)' class='textInput lgray'  size='15' value='" + obj.TI_FollowUpPeople + "' />");
                sb.Append("</td><td>");
                ...
                //sb.Append("</td><td>");
                sb.Append("<a href='TalentInfo/TalentUpkeep.aspx?CB_No=" + obj.TI_CB_No + "&TI_No=" + obj.TI_No + "' target='dialog' mask=true  rel='ducument_dia' title='' width='400' height='500'>维护" + updb.GetTotal((obj.TI_CB_No == null ? 0 : obj.TI_CB_No.Value), obj.TI_No) + "次</a>");
                sb.Append("</td><td>");
                sb.Append("<a href='TalentInfo/TalentDocument.aspx?CB_No=" + obj.TI_CB_No + "&TI_No=" + obj.TI_No + "' target='dialog' mask=true  rel='ducument_dia' title='' width='400' height='500'>简历" + tddb.GetTotal((obj.TI_CB_No == null ? 0 : obj.TI_CB_No.Value), obj.TI_No) + "封</a>");
                sb.Append("</td></tr>");
            }
        }
        ...
        protected void GetListReadOnly(StringBuilder sb, List<Model.TB_RC_TalentInfor> list,int itemindex)
        {
          ...
          //      sb.Append("</td><td>");
                ...
                sb.Append("</td><td>");
                sb.Append(obj.TI_RecommendDate == null ? "" : obj.TI_RecommendDate.Value.ToString("yyyy-MM-dd"));
                sb.Append("</td><td>");
                ...
                //sb.Append("</td><td>");
                sb.Append("<a href='TalentInfo/TalentUpkeep.aspx?status=99&CB_No=" + obj.TI_CB_No + "&TI_No=" + obj.TI_No + "' target='dialog' mask=true  rel='ducument_dia' title='' width='400' height='500'>维护" + updb.GetTotal((obj.TI_CB_No == null ? 0 : obj.TI_CB_No.Value), obj.TI_No) + "次</a>");
              //  sb.Append("</td><td>");
        ...
        public static StringWriter ReportTalent(string queryStr)
        {
            ...
            sw.WriteLine("序号,品牌或企业,行业,人才类别,姓名,性别,联系方式,工作经历,来源,推荐人,推荐日期,推荐岗位,特点,是否面试,面试结果,跟进人,维护时间,维护结果");
            ...
            foreach (var obj in list)
            {
                ...
                sw.Write(",=\"" + (obj.TI_RecommendDate == null ? "" : obj.TI_RecommendDate.Value.ToString("yyyy-MM-dd")) + "\"");
