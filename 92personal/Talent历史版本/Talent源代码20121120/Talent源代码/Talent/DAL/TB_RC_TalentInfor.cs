...
namespace Talent.DAL
{
	...
	public partial class TB_RC_TalentInfor
	{
		...
		public bool Update(Talent.Model.TB_RC_TalentInfor model)
		{
            ...
            parameters[18].Value = model.TI_Recommend;
            parameters[19].Value = model.TI_RecommendDate;
            parameters[20].Value = model.TI_No;
		...
		public Talent.Model.TB_RC_TalentInfor GetModel(int TI_No)
		{
			...
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select  top 1 TI_No,TI_CB_No,TI_BrandName,TI_TalentClass,TI_Name,TI_Sex,TI_Phone,TI_Src,TI_RecommendPost,TI_Audition,TI_AuditionResult,TI_FollowUpPeople,TI_MaintainDate,TI_MaintainResult,TI_CreatePer,TI_CreateDate,TI_Mark,TI_Work,TI_Industry,TI_Recommend,TI_RecommendDate from TB_RC_TalentInfor ");
			strSql.Append(" where TI_No=@TI_No");
			SqlParameter[] parameters = {
					new SqlParameter("@TI_No", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select TI_No,TI_CB_No,TI_BrandName,TI_TalentClass,TI_Name,TI_Sex,TI_Phone,TI_Src,TI_RecommendPost,TI_Audition,TI_AuditionResult,TI_FollowUpPeople,TI_MaintainDate,TI_MaintainResult,TI_CreatePer,TI_CreateDate,TI_Mark,TI_Work,TI_Industry,TI_Recommend,TI_RecommendDate ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select CB_Name,CB_Position,TI_No,TI_CB_No,TI_BrandName,TI_TalentClass,TI_Name,TI_Sex,TI_Phone,TI_Src,TI_RecommendPost,TI_Audition,TI_AuditionResult,TI_FollowUpPeople,TI_MaintainDate,TI_MaintainResult,TI_CreatePer,TI_CreateDate,TI_Mark,TI_Work,TI_Industry,TI_Recommend,TI_RecommendDate  from (");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  TI_No,TI_CB_No,TI_BrandName,TI_TalentClass,TI_Name,TI_Sex,TI_Phone,TI_Src,TI_RecommendPost,TI_Audition,TI_AuditionResult,TI_FollowUpPeople,TI_MaintainDate,TI_MaintainResult,TI_CreatePer,TI_CreateDate,TI_Mark,TI_Work,TI_Industry,TI_Recommend,TI_RecommendDate  from (");
            strSql.Append(" select top " + pager + " * from ( ");
            strSql.Append(" select top " + (PageIndex * PageSize).ToString() + " * from ");
