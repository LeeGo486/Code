    ...
    public partial class Map : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    sb.Append("<option value='" + tc.TC_Color + "'>"+ tc.TC_Class+"</option>");
                }
        ...
        public static string GetModelListAndClass(string querystr)
        {
            ...
            else
            {
                ...
                Model.TB_RC_CompanyBasic cur = null;
                LabelPoint lab = null;
                int i = 0;
                foreach (var cb in cbarr)
                {
                    ...
                    if (cur == null || cur.CB_No != cb.CB_No)
                    {
                        ...
                        if (cur == null)
                        {
                            lab = new LabelPoint();
                            lab.ID = cb.CB_No;
                            lab.ColorInfo = "<DIV style='BACKGROUND-COLOR: " + (cb.TC_Color == null ? "#000" : cb.TC_Color) + ";width:#width' class='colorPicker-picker-self'></div>";
