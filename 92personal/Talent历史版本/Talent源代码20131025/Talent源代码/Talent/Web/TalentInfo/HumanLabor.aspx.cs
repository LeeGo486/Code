...
{
    public partial class HumanLabor : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    if (model != null)
                    {
                        ...
                        //    {
                        //        if (count < 5)
                        //            selectstr += GetTalentOption(tc.WT_No);
                        //        else
                        //            selectstr2 += GetTalentOption(tc.WT_No);
                        //    }
                        //    else
                        //    {
                        //        if (count < 5)
                        //            selectstr += GetTalentOptionReadonly(tc.WT_No);
                        //        else
                        //            selectstr2 += GetTalentOptionReadonly(tc.WT_No);
                        //    }
                        //    count++;
                        //}
