    ...
    public class ajaxWebServices : IHttpHandler,IRequiresSessionState 
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            */
                ...
                switch (tmp)
                {
                  /*  case "addTopic":
                    ...
                    case "updateTalentInfo":
                        ...
                        break;
                    case "updateTalentInfo1":
                        callbackType = "closeCurrent";
                        statusCode = TalentInfo.TalentInfo.UpdateTalentInfo1(context.Request, ref message, ref id);
                        break;
                    case "updateTalentInfo2":
                        callbackType = "closeCurrent";
                        statusCode = TalentInfo.TalentInfo.UpdateTalentInfo2(context.Request, ref message, ref id);
                        break;
                    case "updateTalentInfo3":
                        callbackType = "closeCurrent";
                        statusCode = TalentInfo.TalentInfo.UpdateTalentInfo3(context.Request, ref message, ref id);
                        break;
                    case "delTalentInfo":
                        statusCode = TalentInfo.TalentInfo.DelTalentInfo(context.Request, ref message);
                        break;
                    case "SearchHistoryInfo":
                        statusCode = TalentInfo.TalentInfo.SearchHistoryInfo(context.Request, ref message, ref id);
                        bs = "1";
                        break;
            ...
            //else
            //{
            //    context.Response.Write("{\"statusCode\":\"" + statusCode + "\",\"message\":\"" + message + "\", \"navTabId\":\"" + navTabId + "\", \"rel\":\"" + Common.Constants.getReqValue(context.Request, "rel") + "\", \"callbackType\":\"" + callbackType + "\",\"forwardUrl\":\"" + forwardurl + "\",\"confirmMsg\":\"\",\"saveOrSummit\":\"" + saveOrSummit + "\",\"addId\":\"" + id + "\",\"bs\":\"" + bs + "\"}");
            //    context.Response.End();
            //}
