...
namespace Talent.BLL
{
    ...
    {
        private readonly Talent.DAL.TB_CG_Permission dal = new Talent.DAL.TB_CG_Permission();
        ...
        /// 获得数据列表
        /// </summary>
        public List<Talent.Model.TB_CG_Permission> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Talent.Model.TB_CG_Permission> DataTableToList(DataTable dt)
        {
            List<Talent.Model.TB_CG_Permission> modelList = new List<Talent.Model.TB_CG_Permission>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Talent.Model.TB_CG_Permission model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new Talent.Model.TB_CG_Permission();
        ...
        public List<Talent.Model.TB_CG_Permission> GetModelList(int PageSize, int PageIndex, string strWhere, int pager)
        {
