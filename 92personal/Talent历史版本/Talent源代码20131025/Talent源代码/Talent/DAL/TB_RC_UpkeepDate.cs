...
namespace Talent.DAL
{
	...
	public partial class TB_RC_UpkeepDate
	{
		...
		public int Add(Talent.Model.TB_RC_UpkeepDate model)
		{
            ...
            strSql.Append("insert into TB_CG_UpkeepDate(");
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("update TB_CG_UpkeepDate set ");
		...
		public bool Delete(int UD_No)
		{
			...
			StringBuilder strSql=new StringBuilder();
            strSql.Append("delete from TB_CG_UpkeepDate ");
			strSql.Append(" where UD_No=@UD_No");
			SqlParameter[] parameters = {
					new SqlParameter("@UD_No", SqlDbType.Int,4)
			};
        ...
        public Talent.Model.TB_RC_UpkeepDate GetModel(int UD_No)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 UD_No,UD_CB_No,UD_TI_No,UD_Date,UD_Result,UD_CreatePer,UD_CreateDate from TB_CG_UpkeepDate ");
            strSql.Append(" where UD_No=@UD_No");
            SqlParameter[] parameters = {
					new SqlParameter("@UD_No", SqlDbType.Int,4)
			};
		...
		public DataSet GetList(string strWhere)
		{
            ...
            strSql.Append(" FROM TB_CG_UpkeepDate ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
        ...
        public Object GetTotal(int CB_NO,int TI_NO)
        {
            ...
            strSql.Append(" TB_CG_UpkeepDate ");
            strSql.Append(" where UD_CB_No='" + CB_NO + "' and UD_TI_No='"+TI_NO+"'");
