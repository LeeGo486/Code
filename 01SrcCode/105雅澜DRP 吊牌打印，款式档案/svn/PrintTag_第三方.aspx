<%@ page language="C#" autoeventwireup="true" inherits="PrintTag, App_Web_wnru4wfq" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .Mt td {
            padding:8px;border: 1px solid #C0C0C0;
    ...
    <script type="text/javascript">
        function PrintCodeBar(size,clothingid) {
            ...
            LODOP.ADD_PRINT_TEXT("61.9mm", "1mm", "46mm", "6.6mm", "经销商:浙江雅澜商业地产管理有限公司\n浙江省嘉兴市秀洲区昌盛中路2029号1号楼1楼");
...
<body>
    <form id="form1" runat="server">
        <p align="center"><asp:Label ID="lbInfo" runat="server" ForeColor="Red"></asp:Label></p>
        <table class="Mt" align="center">
            ...
            <tr>
                <td colspan="8" align="center">
                    <table>
                        <tr><th>尺码</th><th>打印吊牌</th></tr>
                    <asp:Repeater ID="RPSize" runat="server">
                        <ItemTemplate>
                            <tr><td><%# Eval("SizeId").ToString() %></td><td><input type="button" onclick="PrintCodeBar('<%# Eval("SizeId").ToString() %>','<%# Eval("ClothingId").ToString() %>');" value="打 印" /></td></tr>
                        </ItemTemplate>
                    </asp:Repeater>
                    </table>
                </td>
