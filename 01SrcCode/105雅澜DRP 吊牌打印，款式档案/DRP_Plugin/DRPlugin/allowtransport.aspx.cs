...
public partial class allowtransport : System.Web.UI.Page
{
    ...
    {
        using (SqlConnection conn = new SqlConnection(DBPWDHelper.GetDBPwd.GetDBConString_MSSQL(ConfigurationManager.AppSettings["AuthKey157"], "001", "EP_X6", "PROD")))//ConfigurationManager.AppSettings["x6con"]
        {
            conn.Open();
