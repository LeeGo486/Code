...
public partial class Inventory : System.Web.UI.Page
{
    ...
    private void LongAction(object state)
    {
        try
        {
            ...
            string errorSKU = "";
            CJ_DevelopHelper.SqlConn_Str = DBPWDHelper.GetDBPwd.GetDBConString_MSSQL(ConfigurationManager.AppSettings["AuthKey102"], "004", "EP_DRP_ZH", "PROD");
            int totalnum = 0;
    ...
    {
        string result = "";
        using (SqlConnection conn = new SqlConnection(DBPWDHelper.GetDBPwd.GetDBConString_MSSQL(ConfigurationManager.AppSettings["AuthKey102"], "004", "EP_DRP_ZH", "PROD")))
        {
            conn.Open();
