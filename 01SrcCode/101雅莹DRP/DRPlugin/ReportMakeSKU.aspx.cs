...
{
    public static string connstr = DBPWDHelper.GetDBPwd.GetDBConString_MSSQL(ConfigurationManager.AppSettings["AuthKey86"], "001", "EP_ERP_AS", "PROD");
    public static string connstr2 = DBPWDHelper.GetDBPwd.GetDBConString_MSSQL(ConfigurationManager.AppSettings["AuthKey102"], "004", "EP_DRP_ZH", "PROD");
