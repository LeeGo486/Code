<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportMakeSKU.aspx.cs" Inherits="ReportMakeSKU" %>
        ...
        <table style="font-family: 楷体">
                ...
                <table class="Tmain">
                 ...
                 <p style=" color: Red; font-size: small; font-family: 楷体;">
                            说明：1、若出现某行数据背景为红色、可造件数为0时,需要款式客定,请与公司相关人员联系。</p>
              
               <p style=" color: Red; font-size: small; font-family: 楷体;">
                                   2、若出现某行数据背景为黄色，说明此物料虽无可用库存，但存在待检库存，如需款式客定，请与公司相关人员联系。</p>
    </div>
    </form>
</body>
</html>
