...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function PrintCodeBarNoLogo(size, clothingid,oldclothingid) {
            //获取数据
        ...
        //V2014.5.8
        function PrintCodeBar2014(size, clothingid,oldclothingid) {
            //获取数据
            var gbk = document.getElementById("<%= TxtGBK.ClientID %>").value;
            var price = document.getElementById("<%= lbdprice.ClientID %>").innerText;
            var safetype = document.getElementById("<%= TxtSafeType.ClientID %>").value;
            ...
            LODOP.ADD_PRINT_BARCODE("65.1mm", "0.3mm", "37mm", "6.6mm", "Code93", clothingid);
            LODOP.SET_PRINT_STYLEA(0, "FontSize", 6);
            LODOP.SET_PRINT_STYLEA(0, "Horient", 3);
        ...
        function PrintCodeBarNew(size, clothingid,oldclothingid) {
            //获取数据
            var gbk = document.getElementById("<%= TxtGBK.ClientID %>").value;
            var price = document.getElementById("<%= lbdprice.ClientID %>").innerText;
            var safetype = document.getElementById("<%= TxtSafeType.ClientID %>").value;
        ...
        function PrintCodeBar(size, clothingid,oldclothingid) {
            //获取数据
            var gbk = document.getElementById("<%= TxtGBK.ClientID %>").value;
            var price = document.getElementById("<%= lbdprice.ClientID %>").innerText;
            var safetype = document.getElementById("<%= TxtSafeType.ClientID %>").value;
                        ...
                        <asp:Repeater ID="RPSize" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <input type="button" onclick="PrintCodeBar2014('<%# Eval("SizeId").ToString() %>','<%# Eval("ClothingId").ToString() %>','<%# Eval("OldClothingId").ToString()%>');" value="打印（竖）" /><br />
                                        <input type="button" onclick="PrintCodeBarNew('<%# Eval("SizeId").ToString() %>','<%# Eval("ClothingId").ToString() %>','<%# Eval("OldClothingId").ToString()%>');" value="打印（横）" /><br />
                                        <input type="button" onclick="PrintCodeBarNoLogo('<%# Eval("SizeId").ToString() %>','<%# Eval("ClothingId").ToString() %>','<%# Eval("OldClothingId").ToString()%>');" value="打印（无）" /><br />
                                        <input type="button" onclick="PrintCodeBarAnnaSu('<%# Eval("SizeId").ToString() %>','<%# Eval("ClothingId").ToString() %>','<%# Eval("OldClothingId").ToString()%>');" value="小条码" /><br />
                                        <input type="button" onclick="PrintCodeBarJJP('<%# Eval("SizeId").ToString() %>','<%# Eval("ClothingId").ToString() %>','<%# Eval("OldClothingId").ToString()%>');" value="家居品合格证" /><br />
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
