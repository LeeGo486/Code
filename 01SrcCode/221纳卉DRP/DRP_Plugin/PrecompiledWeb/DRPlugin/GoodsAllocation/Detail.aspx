<%@ page language="C#" autoeventwireup="true" inherits="GoodsAllocation_Detail, App_Web_fizkkrdw" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function Back2Search() {
            window.location.href = "Search.aspx?depotid=" + GetQueryString("depotid") + "&userid=" + GetQueryString("userid");
        }
