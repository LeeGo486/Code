...
//                            )";
        ...
        private void GetPDReview(DataTable pdt)
        {
            ...
            string strSQL = @"
                            SELECT DESERI,DERWPE FROM dbo.PDReview
                            WHERE DEBRAN=@Param0
                                                  ";
            m_Return = conn.GetDataSet(strSQL, new string[] { strDEBRAN });
        }
        #endregion
