...
{
    /// <summary>
    ///MDM_System_User_ExceuteGetFromEHRForPresent 从EHR辅助系统中，抽取数据到MDM中
    /// </summary>
    public class MDM_System_User_ExceuteGetFromEHRForPresent : LogicBase, ILogicExecute
    {
        public MDM_System_User_ExceuteGetFromEHRForPresent()
        {
