...
{
    /// <summary>
    ///MDM_System_User_ExceuteGetFromGPF22ForHZYCYWX 从GP的F22系统中，抽取用户数据到MDM中，成主维修系统专用
    /// </summary>
    public class MDM_System_User_ExceuteGetFromGPF22ForHZYCYWX : LogicBase, ILogicExecute
    {
        public MDM_System_User_ExceuteGetFromGPF22ForHZYCYWX()
        {
