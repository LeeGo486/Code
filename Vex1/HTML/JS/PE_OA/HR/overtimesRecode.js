...
var m_OTApply = '';
var m_MID = '';
var m_curM = dateUtil_dateFomaterA(new Date(), '-').substring(0, 7);
m_curM = '2015-03';
var m_EmpList = [];
...
function actSave() {
    ...
    var type = dataUtil_undefinedOrNull(basedata_getUrlParam("v0"), '');
    var preM = dateUtil_getPreMonth('', '-').substring(0, 7);
    ...
    if (type == '1') {
        ...
        $(m_DatagridID).datagrid({
            ...
            columns: [[
                ...
                { field: 'hr2_empcode', title: '职员代码', width: 70, sortable: true, editor: 'text' },
                ...
                { field: 'hr2_remark', title: '备注', width: 150, sortable: true, editor: 'text' },
