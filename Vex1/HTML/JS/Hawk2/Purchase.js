...
$(function () {
    ...
    $('#formselect #txtbr1_name').combogrid({
        panelWidth: 110,
        url: GetWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8') + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GETBRANDSEARCH'),
        idField: 'br1_name',
        textField: 'br1_name',
        mode: 'remote',
        columns: [[
    ...
    if (m_divi == "GL") {
        $('#formselect #txtpd1_season').combobox({
            url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "SSON" + "'",
            panelHeight: 'auto',
            editable: false,
            valueField: 'id',
            textField: 'text'
    ...
    $('#formselect #txtpd1_years').combobox({
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "YEAR" + "'",
        panelHeight: 'auto',
        editable: false,
        valueField: 'id',
        textField: 'text'
    ...
    $('#formselect #txtpo1_suppliercode').combogrid({
        panelWidth: 380,
        url: GetWSRRURL('643a8280-09c8-4e52-aaff-1d27440b7d41') + "&XML=" + GetFormJson(m_data, 'SupplierInfo'),
    ...
    $('#formselect #txtpo1_pc1_contractcode').combogrid({
        panelWidth: 100,
        url: GetWSRRURL('ac31b57a-a197-4e08-8d4e-433b006af792') + "&XML=" + GetFormJson(m_data, 'GETCONTRACTCOMBOGRID'),
    ...
    var url = GetWSRRURL('47a9a2ce-92d8-4bea-800b-fabf87dd7850') + "&XML=" + GetFormJson(m_data, 'GET') + "&Where=PO1_DIVI='" + m_divi + "'";//组成URL，供加载采购单主表信息
...
function InitGird_PO1_POHeadSelect() {
    ...
    url = GetWSRRURL('47a9a2ce-92d8-4bea-800b-fabf87dd7850') + "&XML=" + GetFormJson(data, 'GET') + "&WHERE=" + escape(url) + " AND PO1_DIVI='" + m_divi + "'";
...
function onClickRow(RowIndex, RowData) {
    ...
    var url = GetWSRRURL('47a9a2ce-92d8-4bea-800b-fabf87dd7850') + "&XML=" + GetFormJson("", 'GETPODETIL') + "&WHERE=" + " PO2_POCode = '" + mPO1POCode + "' and PO2_DIVI='" + m_divi + "'";
    m_url = GetWSRRURL('47a9a2ce-92d8-4bea-800b-fabf87dd7850') + "&XML=" + GetFormJson("", 'GETPODETILFORPRINT') + "&WHERE=" + " PO2_POCode = '" + mPO1POCode + "' and PO2_DIVI='" + m_divi + "'";//用于打印、导出采购单明细
...
function Type(type) {
    ...
    $('#formAddEdit #txtpo1_potypecode').combobox({
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "ITCL" + "'",
        valueField: 'id',
        textField: 'text',
        required: true,
        panelHeight: 'auto',
        ...
        //    $('#formAddEdit #txtpo1_potypecode').val($('#formAddEdit #txtpo1_potypename').combobox('getValue'));
        //}
    });

    //加载合同数据   
    function init_select_contract(Selectcontractcode) {
        var url = GetWSRRURL('ac31b57a-a197-4e08-8d4e-433b006af792') + "&XML=" + GetFormJson([], 'GETCONTRACTCOMBOGRID')
            + "&Where=PC1_SP1_SupplierCode='" + Selectcontractcode + "' and PC1_DIVI='" + m_divi + "'";
        htmlobj = $.ajax({
            url: url,
            async: false
        });
    ...
    $('#formAddEdit #txtpo1_currency').combobox({
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "CUCD" + "'",
        panelHeight: 'auto',
        required: true,
        editable: false,
        valueField: 'id',
    ...
    function initselectexchangerate(strselectexchangerate) {
        ...
        url = GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&XML=" + GetFormJson(dataParam, 'GET2Level');
        //初始化汇率下拉
    ...
    $('#formAddEdit #txtpo1_transportratio').combobox({
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "FRHT" + "'",
        panelHeight: 'auto',
        editable: false,
        valueField: 'text',
        textField: 'text',
    ...
    $('#formAddEdit #txtpo1_paymenttypename').combobox({
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "TEPY" + "'",
        panelHeight: 'auto',
        editable: false,
        required: true,
        valueField: 'text',
    ...
    $('#formAddEdit #txtpo1_paymentchannelname').combobox({
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "PYTP" + "'",
        panelHeight: 'auto',
        editable: false,
        valueField: 'text',
        required: true,
    ...
    $('#formAddEdit #txtpo1_increaseratio').combobox({
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "VTCD" + "'",
        panelHeight: 'auto',
        editable: false,
        valueField: 'text',
        textField: 'text',
    ...
    $('#formAddEdit #txtpo1_tariffratio').combobox({
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "TARI" + "'",
        panelHeight: 'auto',
        editable: false,
        valueField: 'text',
        textField: 'text',
    ...
    //初始化公司
    $('#txtpo1_company').combobox({
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "COMP" + "'",
        panelHeight: 'auto',
        valueField: 'id',
        required: true,
        textField: 'text'
    ...
    if (type == "Add") {
        ...
        if (m_divi == 'GL') {
            $('#formAddEdit #txtpo1_company').combobox('setValue', 'GL');
            $('#formAddEdit #txtpo1_company').combobox('disable');
        } else {
            $('#formAddEdit #txtpo1_company').combobox('enable');
            $('#formAddEdit #txtpo1_company').combobox('setValue', '');
        }
    }
        //如果是edit就修改
    else if (type == "Edit") {
...
function SearchStyle() {
    ...
    url += " and ST1_SupplierCode = '" + txtpo1_suppliercode + "'" + " AND  st1_br1_brandcode = " + "'" + txtpo1_br1_brandcode +
        "' AND ST2_DIVI='" + m_divi + "' AND ST1_BrandID='" + txtpo1_company + "'";
    url = GetWSRRURL('47a9a2ce-92d8-4bea-800b-fabf87dd7850') + "&XML=" + GetFormJson("", 'GETSTYLE') + "&WHERE=" + escape(url);
    SelectStyleInfo(url);
}
        ...
        onSubmit: function (e) {
            ...
            $.messager.confirm('提示框', '是否确认提交', function (r) {
                if (r) {
                    ...
                    data[data.length] = { "name": "txtpo1_company", "value": $('#txtpo1_company').combobox('getValue') };
