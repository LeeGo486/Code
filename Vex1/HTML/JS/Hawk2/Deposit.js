...
function EditPaymentDetail(type) {
    ...
    if (getRows.length > 0) {
        ...
        getRows[getRows.length] = { "Type": type, "pocode": getPOCode, "suppliercode": suppliercode, "currency": currency };
