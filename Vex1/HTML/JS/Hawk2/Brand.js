...
$(function () {
    ...
    $('#formBrand #txtbr1_country').combogrid({
        panelWidth: 100,
        url: GetWSRRURL('93837c9f-7fba-49a6-abc2-5fc950d26ff0') + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "COTY" + "'",
        idField: 'ct1_options',
    ...
    //初始化品牌数据
    var url = GetWSRRURL('7fdd2974-380f-428a-b38f-2223737eb445') + "&XML=" + GetFormJson(m_data, 'BrandInfoForPageList');
    initGird(url);
})
        ...
        onSubmit: function (e) {
            ...
            $.messager.confirm('提示框', '是否确认提交', function (r) {
                if (r) {
                    ...
                    $.ajax({
                        url: GetWSRRURL('7fdd2974-380f-428a-b38f-2223737eb445'),
                        type: 'post',
                        async: true, //异步,
                        data: { "XML": XMLData },
...
function doSearch() {
    ...
    url = GetWSRRURL('7fdd2974-380f-428a-b38f-2223737eb445') + "&XML=" + GetFormJson(m_data, 'BrandInfoForPageList') + "&WHERE=" + escape(url);
    initGird(url);
}