...
--------------------------------------------------------------------------------------------------------------------*/
    ...
    //初始化品牌数据
    var url = GetWSRRURL('7fdd2974-380f-428a-b38f-2223737eb445') + "&XML=" + GetFormJson([], 'BrandInfoForPageList');
    initGird(url);
})
...
function doSearch() {
    ...
    url = GetWSRRURL('7fdd2974-380f-428a-b38f-2223737eb445') + "&XML=" + GetFormJson([], 'BrandInfoForPageList') + "&WHERE=" + escape(url);
    initGird(url);
}