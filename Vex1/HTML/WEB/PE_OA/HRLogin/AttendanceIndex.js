...
function btndologin() {
    ...
    if (UserName == "" || Password == "") {
        ...
        if (dologinInfo.rows[0].c_oid == "" || dologinInfo.rows[0].c_oid == undefined) {
            ...
            //window.location = "http://192.168.0.35/PE_OA/WEB/PE_OA/HR/login_hr.html" + "?r=" + Math.random() + "&namec=" + UserNameC + "&name=" + UserName + "&c_oid=" + c_oid;
            window.location = "http://localhost:8084/WEB/PE_OA/HR/login_hr.html" + "?r=" + Math.random() + "&namec=" + UserNameC + "&name=" + UserName + "&c_oid=" + c_oid;
        }
    }
}
function doReset() {
