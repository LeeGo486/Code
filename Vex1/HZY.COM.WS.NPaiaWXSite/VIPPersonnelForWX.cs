        ...
        private void EDITVIPPersonnel()
        {
            ...
            string strSQL = @"
                        insert into dbo.vip_user 
                                (vipcode,vipname,vipsex,mobtel,vipid,depotid,vipstate,crdate,is_vip,vipapply)
                             ( SELECT      
                                @Param0 vipcode,@Param1 vipname,@Param2 vipsex,@Param3 mobtel,
                                @Param4 vipid,'Y0016027' depotid,'金卡' vipstate,@Param5 crdate  ,'0' is_vip,'微信' vipapply
                                    )";
