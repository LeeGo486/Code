...
/// 类名：MDM_Entity_EditByStoreMarket 
/// 类说明：根据MDM店铺信息来编辑Entity
/// 创建人：马卫清
/// 创建日期：2013-06-19
/// 修改人：
/// 修改日期：
...
{
    /// <summary>
    ///MDM_Entity_EditByStoreMarket 根据MDM店铺信息来编辑Entity
    /// </summary>
    public class MDM_Entity_EditByStoreMarket : LogicBase, ILogicGetData
    {
        public MDM_Entity_EditByStoreMarket()
        {
        ...
        public DataSet GetData()
        {
            ...
            try
            {
                ...
                string strStoreEntityCode = "0006";
                ...
                clsPropertyList.Request = Common.Common.GetRequestDataSet(new string[2] { "Entity", "MarketTableName" }, new string[2] { strStoreEntityCode, "Store_App_For_FM" });
    ...
    //XML案例
    //<Interface WSID="6d6f7eea-d80c-4cfb-bbb7-32a6877ef21e" 
    ...
    //<Request_UserName>马卫清</Request_UserName>
    //<Request_Type>Windows</Request_Type>
    //<Prod>正式</Prod>
    //</ROW>
    //<ROW>    
    //<Request_Code></Request_Code>
    //<Request_UserName>王秀宝</Request_UserName>
