...
namespace HZY.COM.WS.MDM2
{
    ...
    /// 编辑公司信息
    /// </summary>
    public class MDM2_Com_Edit : LogicBase, ILogicGetData
    {
        public MDM2_Com_Edit()
        {
        ...
        public DataSet GetData()
        {
            ...
            try
            {
                ...
                string strMDM_Class = "0001";

                conn.LockTableList.Add("MDM_0001_B");
                conn.LockTableList.Add("MDM_0001_E");
