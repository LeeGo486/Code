...
{
    public class IBMWCSOrderInterface : HZYLogicBase, ILogicGetData
    {
        #region 构造函数
        public IBMWCSOrderInterface()
        {
        ...
        public DataSet GetData()
        {
            try
            {
                ...
                if (dt_OPTYPE.Rows[0][0].ToString().ToUpper() == "Insert".ToUpper())      //数据写入
                {
                    Insert();
                }
            ...
            catch (SqlException ex)
            {
                ...
                {
                    dt_EditResult.Rows.Add(new object[] { 1, "插入了重复键值，请检查相应Orderid，Sku是否已经插入！" });
                ...
                HZY.COM.Common.Log.WirteLog(ex, null);
        ...
        private void Insert()
        {
            ...
            m_conn.InsertBYSQLBC("Get_IBMWCSOrder", dtList);
