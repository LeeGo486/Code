...
/// 类名：FluxWMSShopReturnDToWInterface
/// 类说明：门店退货订单接口WMS	DRP->WMS	退货发货单登账
/// 创建人：郭琦琦
/// 创建日期：2014-03-12
/// 修改人：
/// 修改日期：
...
{
    public class FluxWMSShopReturnDToWInterface : HZYLogicBase, ILogicExecute
    {
        #region 构造函数
        public FluxWMSShopReturnDToWInterface()
        {
        ...
        public Boolean Execute()
        {
            try
            {
                ...
                {
                    strMaxreQuestid = dtData.Rows[0]["requestid"].ToString();
                    ...
                    else
                    {
                        string strSQLflag = @"
                            ...
                            SET WMSFlag=1
                           -- WHERE requestid <='" + strMaxreQuestid + @"'
                            DROP TABLE #tmp ";
