...
/****** Object:  StoredProcedure [API_GLERP].[Sp_FNP_ReturnDetailPayApplyDetail]    Script Date: 09/12/2013 10:32:43 ******/
SET ANSI_NULLS ON
GO
...
CREATE proc [API_GLERP].[Sp_FNP_ReturnDetailPayApplyDetail]
...
--设置默认值
	...
	begin
		...
		BEGIN	
			...
			'【退货单编号,		 A.PRC_ReturnCode~PRC_ReturnCode,					String,'														 +'】' +  		             
            '【退货金额,		 A.PRC_Amount~PRC_Amount,							String,'													 +'】' +                          
			'【退货数量,		 A.PRC_Total~PRC_Total,								String,'																 +'】' +           
            ...
            '【《W》创建人,				FNPD_RgUser,					String,'+ isnull([~FrameDB].API_COMMON.[GetValueFromList](@ConditionStr,'《W》创建人') ,'')				+'】' +
            '【《W》创建时间,			FNPD_RgDt,						String,'+ isnull([~FrameDB].API_COMMON.[GetValueFromList](@ConditionStr,'《W》创建时间'),'')			+'】' +
            '【《W》最后修改人,			FNPD_LmUser,					String,'+ isnull([~FrameDB].API_COMMON.[GetValueFromList](@ConditionStr,'《W》最后修改人') ,'')			+'】' +
            '【《W》最后修改时间,		FNPD_LmDt,						String,'+ isnull([~FrameDB].API_COMMON.[GetValueFromList](@ConditionStr,'《W》最后修改时间') ,'')		+'】' +
		    '【《W》最后修改时间,		FNPD_LmDt,						String,'+ isnull([~FrameDB].API_COMMON.[GetValueFromList](@ConditionStr,'《W》最后修改时间') ,'')		+'】'
		...
		begin
	     ...
	     LEFT JOIN B02_Bill.PRC_Return A   ON			FNPD_RefBillDetailID=A.PRC_ReturnId  
