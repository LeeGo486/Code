...
<body>
	<!-- <form id="customerAnalysisForm" name="customerAnalysisForm" action="customerAnalysis.do">  -->
		...
		<ec:table  items="customerList" var="customer"  tableId="customerTable"
			...
			retrieveRowsCallback="process" action="vipConsumeSituationDetail.do"
			pageSizeList="2,5,10,50" rowsDisplayed="20" editable="false"
			xlsFileName="VIP消费状况明细.xls"  classic="true" title="VIP消费状况明细" width="120%"
			filterable="true">
			...
			<ec:row>
				...
				<ec:column title="首单实销金额" property="firstvalue" sortable="true"  cell="number" format="0.00" style="text-align:right" calc="total" calcTitle= "合计" calcSpan="1"/>
