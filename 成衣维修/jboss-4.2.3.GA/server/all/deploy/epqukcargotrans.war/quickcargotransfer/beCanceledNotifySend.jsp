  ...
  <body>
  	 ...
  	 <ec:table  items="infos" var="record"  tableId="ecTable"
			...
			<ec:row onmouseover="mouseonChange(this)" onmouseout="mouseoutChange(this)">
				...
				<ec:column title="供方编号" property="GFBH" sortable="true"  width="10%"/>
				<ec:column title="供方名称" property="GFMC" sortable="true" width="10%"/>
				<ec:column title="所属大区" property="GFSSDQ" sortable="true"  width="10%"/>
				
				<ec:column title="店长" property="DZ" sortable="true"  width="10%"/>
				<ec:column title="电话" property="DH" sortable="true"  width="10%"/>
				<ec:column title="供方地址" property="GFDZ" sortable="true"  width="30%"/>
