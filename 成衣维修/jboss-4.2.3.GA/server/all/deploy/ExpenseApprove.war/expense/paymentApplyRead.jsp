...
<body onload="initForm()">
	...
	<html:form action="/paymentApply" styleId="paymentApplyForm">
		...
		<div
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="1"
				...
				<tr>
					...
					<td class="td_text" >
						<html:text styleId="vendorNo" property="vendorNo" styleClass="text_write_common" disabled="true"></html:text>
					</td>
				...
				<tr>
					...
					<td  class="td_text" colspan="5">
						...
						<textarea id="payComment" name="payComment" class="text_write_common"  rows="2" cols="20"  disabled="disabled"></textarea>
		...
		<div>
			...
			<table id='100' width="100%" border="0" cellpadding="2" cellspacing="1"
				...
				<tr id="<%=1101+i%>-tr" >
					...
					<td class="td_text_center">
						<input id="<%=1101+i%>-invoiceCode"  type="text" value="<%=purposeCost.getInvoiceCode() %>" disabled="disabled">
					</td>
					
					<td class="td_text_center">
						<input id="<%=1101+i%>-costCenterCode"  type="text" value="<%=purposeCost.getCostCenterCode() %>" disabled="disabled">
					</td>
					
					<td class="td_text_center">
						<input id="<%=1101+i%>-costCenterName"  type="text" value="<%=purposeCost.getCostCenterName() %>" disabled="disabled">
					</td>
