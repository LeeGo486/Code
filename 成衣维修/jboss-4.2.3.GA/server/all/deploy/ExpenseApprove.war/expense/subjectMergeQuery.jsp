...
<html>
 ...
 function waitDetail(){
 	...
 	function initForm(){
  		$('#applytitle', parent.document).html('科目单据查询');
  	}
  </script>
  ...
  <body onload="initForm()">
    	...
    	<html:form action="/subjectMergeQuery" styleId="basicQueryForm">
    	 ...
    	 <ec:table  items="infolist" var="record"  tableId="ecTable" 
			...
			retrieveRowsCallback="process" action="subjectMergeQuery.do"
			pageSizeList="10,20,30,50" rowsDisplayed="20" editable="false"
		    classic="true"  xlsFileName="科目单据.xls" resizeColWidth="true" style="table-layout:fixed;"
			filterable="true" >
			...
			<%-- <ec:column title="当前节点" property="Node_Name" sortable="true"/>--%>	
				...
				<ec:column title="大类" property="category"  sortable="true"/>
				<ec:column title="所有科目" property="subject"  sortable="true"/>
				<ec:column title="所科目代码 " property="subjectCode"  sortable="true"/>
				<ec:column title="科目金额 " property="subjectAmout" cell="number" format="0.00"  style="text-align:right;" sortable="true"/>
