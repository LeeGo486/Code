...
<body onload="initForm()">
	...
	<html:form action="/customerPrintSelf"
		styleId="customerPrintSelfForm" method="post">
		...
		<tr>
			...
			<td align="center">
				<font size="5" style= "font-weight:bold ">顾客维修单</font> 
			</td>
			<td align="right" width="40%">
				<!-- <font size="2px"> 维修单号&nbsp;<bean:write name="customerPrintSelfForm" property="dh"/></font> -->
				<span id="dhspan" style="display: none;"><bean:write name="customerPrintSelfForm" property="dh"/></span> 
				<div>
			...
			<table width="90%" class="table_thin" align="center">
				...
				<tr>
					...
					<td colspan="7"  width="18.5%" class="td_enabled">
						<bean:write name="customerPrintSelfForm" property="PP"/>
					</td>
				</tr>
				<tr>
					<td class="field_enabled" colspan="2" >
						款号
					</td>
					<td class="field_enabled" colspan="1" >
						颜色
					</td>
					<td class="field_enabled"colspan="1">
						码数
				...
				<tr>
					<td class="td_enabled" colspan="2">
						<bean:write name="customerPrintSelfForm" property="KH" />
					</td>
					<td class="td_enabled" colspan="1" >
						<bean:write name="customerPrintSelfForm" property="YS"/>
					</td>
					<td class="td_enabled" colspan="1" >
						<bean:write name="customerPrintSelfForm" property="MS"/>
					</td>
					<td class="td_enabled" colspan="2">
						<bean:write name="customerPrintSelfForm" property="SCSJ"/>
					</td>
					<td class="td_enabled" colspan="2">
						<bean:write name="customerPrintSelfForm" property="WTMS"/>
					</td>
				</tr>
				<tr>
					...
					<td width="18.5%" class="td_enabled">
						<bean:write name="customerPrintSelfForm" property="dpmc"/>
					</td>
					<td rowspan="4" width="10.5%" class="field_enabled">
						顾客信息
					</td>
				...
				<tr>
					...
					<td class="td_enabled">
						<bean:write name="customerPrintSelfForm" property="DZXM"/>
					...
					<td class="td_enabled">
						<bean:write name="customerPrintSelfForm" property="GKXM"/>
					</td>
					<td class="field_enabled">
						顾客电话
					</td>
					<td class="td_enabled">
						<bean:write name="customerPrintSelfForm" property="GKLXDH"/>
					</td>
				...
				<tr>
					...
					<td class="td_enabled">
						<bean:write name="customerPrintSelfForm" property="DGLXDH"/>
					</td>
					<td class="field_enabled">
						VIP卡号
					</td>
					<td colspan="3" class="td_enabled">
						<bean:write name="customerPrintSelfForm" property="VIPKH"/>
					</td>
				...
				<tr>
					...
					<td class="td_enabled">
						<bean:write name="customerPrintSelfForm" property="SLDG"/>
					</td>
					<td class="field_enabled">
						付费维修
					</td>
		...
		<table width="90%" align="center">
		 <tr>
		 	<td align="left" colspan="2">
		 		<font color="red" size="2">备注：必须凭此单提取衣服！</font>
		 	</td>
		 </tr>		
		 <tr>
		  	<td width="80%" align="right">
		  		<font size="2">顾客签字：</font>
		  	</td>
		 	 <td width="20%">
		 	</td>
		 </tr>
