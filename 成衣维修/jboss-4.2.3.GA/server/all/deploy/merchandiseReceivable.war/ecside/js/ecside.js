...
if (!form[pageid]){
	...
	//form.action=ecsideObj.DEFAULT_ACTION;ע�͵�ԭ���ǻ�����ҳ����
	...
	try {
		if (ecsideObj.doPreload){
			...
			//ecsideObj.ajaxSubmit();   ע�͵�ԭ���ǲ�ʹ��AJAX��ͬʱ�����������ύ
			form.submit();
		}
	}catch (e){
		//try {
...
ECSideUtil.doSort=function(event,columnAlias,sortT1,formid,columnHearderId){
	...
	//form.action=ecsideObj.DEFAULT_ACTION;ע�͵�����Ϊ��������������
...
var ecsideObj=ECSideUtil.getGridObj(formid);
	...
	//try {
		//ecsideObj.ajaxSubmit(); ע������Ϊ��������2���ύ��Ŀǰ��û��ʹ��AJAX����
	//}catch (e2){
		form.submit();
	//}
};
