...
public final class viewCargoApplyRes_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private org.apache.jasper.runtime.TagHandlerPool _005fjspx_005ftagPool_005fec_005fcolumn_005fwidth_005ftitle_005fproperty_005fnobody;
  ...
  public void _jspInit() {
    ...
    _005fjspx_005ftagPool_005fec_005fcolumn_005fwidth_005ftitle_005fproperty_005fnobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    ...
    _005fjspx_005ftagPool_005fec_005fcolumn_005fwidth_005ftitle_005fproperty_005fnobody.release();
  }
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("  \tfunction queryZBinfo(){\r\n");
      out.write("  \t\tdocument.getElementById('action').value='queryZBInfo';\r\n");
      out.write("  \t\tdocument.forms[0].submit();\r\n");
      out.write("  \t\twaitDetail();\r\n");
      out.write("  \t}\r\n");
      out.write("  \r\n");
      out.write("  \tfunction queryDateChange(){\r\n");
      out.write("  \t\tvar select = document.getElementById('queryDate');\r\n");
      out.write("  \t\tvar selValue = select.options[select.options.selectedIndex].value;\r\n");
      out.write("  \t\tif(selValue=='1'){\r\n");
      out.write("  \t\t\tvar url = document.getElementById('path').value+'/quickcargotransfer/openTime.jsp';\r\n");
      out.write("  \t\t\twindow.open(url, \"选择查询日期\", \"scrollbars=yes,width=200px,height=100px,resizable=yes,menubar=no,status=no,location=no\");\t\r\n");
      out.write("  \t\t}else{\r\n");
      out.write("  \t\t\tqueryZBinfo();\r\n");
      out.write("  \t\t}\r\n");
      out.write("  \t}\r\n");
      out.write("  \t\r\n");
      ...
      out.write("  \t\tdocument.frames['mxReport'].location.href=document.getElementById('path').value\r\n");
      out.write("  \t\t\t+'/viewCargoApplyRes.do?action=queryMX&zbguid='+recordKey;\r\n");
      out.write("  \t}\r\n");
      out.write("  \t\r\n");
      out.write("  \tfunction initForm(){\r\n");
      out.write("  \t\tvar checkBoxString = document.getElementById('checkBoxHiddenValue').value;\r\n");
      out.write("  \t\tvar checkBoxArray =  document.getElementsByName(\"zts\");\r\n");
      out.write("  \t\t//checkBoxString.split(',');\r\n");
      out.write("  \t\tfor(var i=0;i<checkBoxArray.length;i++){\r\n");
      out.write("  \t\t\tvar index = checkBoxString.lastIndexOf(checkBoxArray[i].value);\r\n");
      out.write("  \t\t\tif(index>-1){\r\n");
      out.write("  \t\t\t\tcheckBoxArray[i].checked=true;\r\n");
      out.write("  \t\t\t}\r\n");
      out.write("  \t\t}\r\n");
      out.write("  \t\r\n");
      out.write("  \t}\r\n");
      ...
      // /quickcargotransfer/viewCargoApplyRes.jsp(91,6) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f0.setProperty("path");
      // /quickcargotransfer/viewCargoApplyRes.jsp(91,6) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_html_005fhidden_005f0.setValue(path);
      ...
      out.write("\t\t<iframe width=\"100%\" height=\"100%\" name=\"mxReport\" src=\"");
      out.print(path);
      out.write("/viewCargoApplyRes.do?action=queryMX\"></iframe>\r\n");
      out.write("     \t \r\n");
      out.write("     \t </div>\r\n");
      out.write("     \t </div>\r\n");
      out.write("     \t </div>\r\n");
  ...
  private boolean _jspx_meth_html_005fform_005f0(PageContext _jspx_page_context)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(93,6) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fform_005f0.setAction("/viewCargoApplyRes");
    // /quickcargotransfer/viewCargoApplyRes.jsp(93,6) name = styleId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fform_005f0.setStyleId("viewCargoApplyResForm");
    ...
    if (_jspx_eval_html_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        if (_jspx_meth_html_005fhidden_005f5(_jspx_th_html_005fform_005f0, _jspx_page_context))
          return true;
        out.write("\r\n");
        out.write("        <div id=\"queryCondition\" >\r\n");
        out.write("          \r\n");
        out.write("          ");
  ...
  private boolean _jspx_meth_html_005fhidden_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(94,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fhidden_005f1.setProperty("isFirstReq");
  ...
  private boolean _jspx_meth_html_005fhidden_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(95,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fhidden_005f2.setProperty("bgnDate");
  ...
  private boolean _jspx_meth_html_005fhidden_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(96,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(97,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_html_005fhidden_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(98,8) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fhidden_005f5.setProperty("checkBoxHiddenValue");
  ...
  private boolean _jspx_meth_html_005fcheckbox_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(101,10) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fcheckbox_005f0.setProperty("zts");
    // /quickcargotransfer/viewCargoApplyRes.jsp(101,10) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fcheckbox_005f0.setValue("待确认");
    // /quickcargotransfer/viewCargoApplyRes.jsp(101,10) name = onclick type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fcheckbox_005f0.setOnclick("queryZBinfo()");
  ...
  private boolean _jspx_meth_html_005fcheckbox_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  html:checkbox
    org.apache.struts.taglib.html.CheckboxTag _jspx_th_html_005fcheckbox_005f1 = (org.apache.struts.taglib.html.CheckboxTag) _005fjspx_005ftagPool_005fhtml_005fcheckbox_005fvalue_005fproperty_005fonclick.get(org.apache.struts.taglib.html.CheckboxTag.class);
    _jspx_th_html_005fcheckbox_005f1.setPageContext(_jspx_page_context);
    _jspx_th_html_005fcheckbox_005f1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_html_005fform_005f0);
    // /quickcargotransfer/viewCargoApplyRes.jsp(102,10) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fcheckbox_005f1.setProperty("zts");
    // /quickcargotransfer/viewCargoApplyRes.jsp(102,10) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fcheckbox_005f1.setValue("已确认");
    // /quickcargotransfer/viewCargoApplyRes.jsp(102,10) name = onclick type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fcheckbox_005f1.setOnclick("queryZBinfo()");
    ...
    if (_jspx_th_html_005fcheckbox_005f1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _005fjspx_005ftagPool_005fhtml_005fcheckbox_005fvalue_005fproperty_005fonclick.reuse(_jspx_th_html_005fcheckbox_005f1);
      return true;
    }
    _005fjspx_005ftagPool_005fhtml_005fcheckbox_005fvalue_005fproperty_005fonclick.reuse(_jspx_th_html_005fcheckbox_005f1);
    return false;
  ...
  private boolean _jspx_meth_html_005fcheckbox_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  html:checkbox
    org.apache.struts.taglib.html.CheckboxTag _jspx_th_html_005fcheckbox_005f2 = (org.apache.struts.taglib.html.CheckboxTag) _005fjspx_005ftagPool_005fhtml_005fcheckbox_005fvalue_005fproperty_005fonclick.get(org.apache.struts.taglib.html.CheckboxTag.class);
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(103,10) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fcheckbox_005f2.setProperty("zts");
    // /quickcargotransfer/viewCargoApplyRes.jsp(103,10) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fcheckbox_005f2.setValue("已拒绝");
    // /quickcargotransfer/viewCargoApplyRes.jsp(103,10) name = onclick type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fcheckbox_005f2.setOnclick("queryZBinfo()");
    ...
    if (_jspx_th_html_005fcheckbox_005f2.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _005fjspx_005ftagPool_005fhtml_005fcheckbox_005fvalue_005fproperty_005fonclick.reuse(_jspx_th_html_005fcheckbox_005f2);
      return true;
    }
    _005fjspx_005ftagPool_005fhtml_005fcheckbox_005fvalue_005fproperty_005fonclick.reuse(_jspx_th_html_005fcheckbox_005f2);
    return false;
  ...
  private boolean _jspx_meth_html_005fcheckbox_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  html:checkbox
    org.apache.struts.taglib.html.CheckboxTag _jspx_th_html_005fcheckbox_005f3 = (org.apache.struts.taglib.html.CheckboxTag) _005fjspx_005ftagPool_005fhtml_005fcheckbox_005fvalue_005fproperty_005fonclick.get(org.apache.struts.taglib.html.CheckboxTag.class);
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(104,10) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fcheckbox_005f3.setProperty("zts");
    // /quickcargotransfer/viewCargoApplyRes.jsp(104,10) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fcheckbox_005f3.setValue("已关闭");
    // /quickcargotransfer/viewCargoApplyRes.jsp(104,10) name = onclick type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fcheckbox_005f3.setOnclick("queryZBinfo()");
    ...
    if (_jspx_th_html_005fcheckbox_005f3.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _005fjspx_005ftagPool_005fhtml_005fcheckbox_005fvalue_005fproperty_005fonclick.reuse(_jspx_th_html_005fcheckbox_005f3);
      return true;
    }
    _005fjspx_005ftagPool_005fhtml_005fcheckbox_005fvalue_005fproperty_005fonclick.reuse(_jspx_th_html_005fcheckbox_005f3);
    return false;
  ...
  private boolean _jspx_meth_html_005fselect_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(105,10) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f0.setProperty("queryDate");
    // /quickcargotransfer/viewCargoApplyRes.jsp(105,10) name = onchange type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005fselect_005f0.setOnchange("queryDateChange()");
  ...
  private boolean _jspx_meth_html_005foptionsCollection_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_005fselect_005f0, PageContext _jspx_page_context)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(106,14) name = name type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foptionsCollection_005f0.setName("arrayTime");
    // /quickcargotransfer/viewCargoApplyRes.jsp(106,14) name = label type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foptionsCollection_005f0.setLabel("timeLab");
    // /quickcargotransfer/viewCargoApplyRes.jsp(106,14) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_html_005foptionsCollection_005f0.setValue("timeValue");
  ...
  private boolean _jspx_meth_ec_005ftable_005f0(PageContext _jspx_page_context)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(113,7) name = items type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005ftable_005f0.setItems(new String("zbApplyInfo"));
    // /quickcargotransfer/viewCargoApplyRes.jsp(113,7) name = var type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005ftable_005f0.setVar("record");
    // /quickcargotransfer/viewCargoApplyRes.jsp(113,7) name = tableId type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005ftable_005f0.setTableId("ecTable");
    // /quickcargotransfer/viewCargoApplyRes.jsp(113,7) name = useAjax type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005ftable_005f0.setUseAjax("false");
    // /quickcargotransfer/viewCargoApplyRes.jsp(113,7) name = doPreload type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005ftable_005f0.setDoPreload("false");
    // /quickcargotransfer/viewCargoApplyRes.jsp(113,7) name = toolbarContent type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005ftable_005f0.setToolbarContent("navigation|pagejump|pagesize|export|extend|status");
    // /quickcargotransfer/viewCargoApplyRes.jsp(113,7) name = showHeader type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005ftable_005f0.setShowHeader("true");
    // /quickcargotransfer/viewCargoApplyRes.jsp(113,7) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005ftable_005f0.setWidth("100%");
    // /quickcargotransfer/viewCargoApplyRes.jsp(113,7) name = listHeight type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005ftable_005f0.setListHeight("160");
    // /quickcargotransfer/viewCargoApplyRes.jsp(113,7) name = listWidth type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005ftable_005f0.setListWidth("100%");
    // /quickcargotransfer/viewCargoApplyRes.jsp(113,7) name = retrieveRowsCallback type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005ftable_005f0.setRetrieveRowsCallback("process");
    // /quickcargotransfer/viewCargoApplyRes.jsp(113,7) name = action type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005ftable_005f0.setAction("viewCargoApplyRes.do");
    // /quickcargotransfer/viewCargoApplyRes.jsp(113,7) name = pageSizeList type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005ftable_005f0.setPageSizeList("10,20,30,50");
    // /quickcargotransfer/viewCargoApplyRes.jsp(113,7) name = rowsDisplayed type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005ftable_005f0.setRowsDisplayed("20");
    // /quickcargotransfer/viewCargoApplyRes.jsp(113,7) name = editable type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005ftable_005f0.setEditable("false");
    // /quickcargotransfer/viewCargoApplyRes.jsp(113,7) name = classic type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005ftable_005f0.setClassic("true");
    // /quickcargotransfer/viewCargoApplyRes.jsp(113,7) name = filterable type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ec_005frow_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_ec_005ftable_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_ec_005ftable_005f0)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(121,3) name = recordKey type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(121,3) name = onclick type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005frow_005f0.setOnclick("getMXInfos()");
    // /quickcargotransfer/viewCargoApplyRes.jsp(121,3) name = onmouseover type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005frow_005f0.setOnmouseover("mouseonChange(this)");
    // /quickcargotransfer/viewCargoApplyRes.jsp(121,3) name = onmouseout type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ec_005fcolumn_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_ec_005frow_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_ec_005frow_005f0)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(123,4) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f0.setProperty("_0");
    // /quickcargotransfer/viewCargoApplyRes.jsp(123,4) name = title type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f0.setTitle("序号");
    // /quickcargotransfer/viewCargoApplyRes.jsp(123,4) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(123,4) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f0.setWidth("6%");
  ...
  private boolean _jspx_meth_ec_005fcolumn_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_ec_005frow_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_ec_005frow_005f0)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(124,4) name = title type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f1.setTitle("需求款式");
    // /quickcargotransfer/viewCargoApplyRes.jsp(124,4) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f1.setProperty("XQKH");
    // /quickcargotransfer/viewCargoApplyRes.jsp(124,4) name = sortable type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f1.setSortable("true");
    // /quickcargotransfer/viewCargoApplyRes.jsp(124,4) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ec_005fcolumn_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_ec_005frow_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_ec_005frow_005f0)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(125,4) name = title type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f2.setTitle("颜色");
    // /quickcargotransfer/viewCargoApplyRes.jsp(125,4) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f2.setProperty("YS");
    // /quickcargotransfer/viewCargoApplyRes.jsp(125,4) name = sortable type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f2.setSortable("true");
    // /quickcargotransfer/viewCargoApplyRes.jsp(125,4) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ec_005fcolumn_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_ec_005frow_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_ec_005frow_005f0)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(126,4) name = title type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f3.setTitle("尺码");
    // /quickcargotransfer/viewCargoApplyRes.jsp(126,4) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f3.setProperty("CM");
    // /quickcargotransfer/viewCargoApplyRes.jsp(126,4) name = sortable type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f3.setSortable("true");
    // /quickcargotransfer/viewCargoApplyRes.jsp(126,4) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ec_005fcolumn_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_ec_005frow_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_ec_005frow_005f0)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  ec:column
    org.ecside.tag.ColumnTag _jspx_th_ec_005fcolumn_005f4 = (org.ecside.tag.ColumnTag) _005fjspx_005ftagPool_005fec_005fcolumn_005fwidth_005ftitle_005fproperty_005fnobody.get(org.ecside.tag.ColumnTag.class);
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(127,4) name = title type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f4.setTitle("需求数量");
    // /quickcargotransfer/viewCargoApplyRes.jsp(127,4) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f4.setProperty("XQSL");
    // /quickcargotransfer/viewCargoApplyRes.jsp(127,4) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    try {
      ...
      _005fjspx_005ftagPool_005fec_005fcolumn_005fwidth_005ftitle_005fproperty_005fnobody.reuse(_jspx_th_ec_005fcolumn_005f4);
    }
    return false;
  }
  ...
  private boolean _jspx_meth_ec_005fcolumn_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_ec_005frow_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_ec_005frow_005f0)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(128,4) name = title type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f5.setTitle("最晚回复日期");
    // /quickcargotransfer/viewCargoApplyRes.jsp(128,4) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f5.setProperty("YQHFRQ");
    // /quickcargotransfer/viewCargoApplyRes.jsp(128,4) name = sortable type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f5.setSortable("true");
    // /quickcargotransfer/viewCargoApplyRes.jsp(128,4) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f5.setWidth("12%");
  ...
  private boolean _jspx_meth_ec_005fcolumn_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_ec_005frow_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_ec_005frow_005f0)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(129,4) name = title type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f6.setTitle("最晚到货日期");
    // /quickcargotransfer/viewCargoApplyRes.jsp(129,4) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f6.setProperty("XQRQ");
    // /quickcargotransfer/viewCargoApplyRes.jsp(129,4) name = sortable type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f6.setSortable("true");
    // /quickcargotransfer/viewCargoApplyRes.jsp(129,4) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f6.setWidth("12%");
  ...
  private boolean _jspx_meth_ec_005fcolumn_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_ec_005frow_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_ec_005frow_005f0)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(130,4) name = title type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f7.setTitle("申请日期");
    // /quickcargotransfer/viewCargoApplyRes.jsp(130,4) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f7.setProperty("SQRQ");
    // /quickcargotransfer/viewCargoApplyRes.jsp(130,4) name = sortable type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f7.setSortable("true");
    // /quickcargotransfer/viewCargoApplyRes.jsp(130,4) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_ec_005fcolumn_005f8(javax.servlet.jsp.tagext.JspTag _jspx_th_ec_005frow_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_ec_005frow_005f0)
    ...
    // /quickcargotransfer/viewCargoApplyRes.jsp(131,4) name = title type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f8.setTitle("状态");
    // /quickcargotransfer/viewCargoApplyRes.jsp(131,4) name = property type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f8.setProperty("ZT");
    // /quickcargotransfer/viewCargoApplyRes.jsp(131,4) name = sortable type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_ec_005fcolumn_005f8.setSortable("true");
    // /quickcargotransfer/viewCargoApplyRes.jsp(131,4) name = width type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
