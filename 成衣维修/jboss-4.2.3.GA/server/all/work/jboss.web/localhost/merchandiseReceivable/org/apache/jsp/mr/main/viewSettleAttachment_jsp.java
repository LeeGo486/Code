...
public final class viewSettleAttachment_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String settleBillID = request.getParameter("settleBillID");
      ...
      out.print(path);
      out.write("/rest/settleBill/viewAttachment/");
      out.print(settleBillID);
      out.write("\">\r\n");
      out.write("  </body>\r\n");
      out.write("</html>\r\n");
    } catch (Throwable t) {
