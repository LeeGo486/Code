...
UserInfo userinfo = (UserInfo) request.getSession().getAttribute("user_info");
      ...
      out.write("  \twindow.open(url, \"发货\", \"scrollbars=yes,width=1200px,height=800px,resizable=yes,menubar=no,status=no,location=no\");\t\r\n");
      out.write("  }\r\n");
      out.write("    \r\n");
      out.write("  \r\n");
      ...
      out.write("  \twindow.open(url, \"报表查询\", \"scrollbars=yes,width=1200px,height=800px,resizable=yes,menubar=no,status=no,location=no\");\t\r\n");
      out.write("  }\r\n");
      out.write("  \r\n");
