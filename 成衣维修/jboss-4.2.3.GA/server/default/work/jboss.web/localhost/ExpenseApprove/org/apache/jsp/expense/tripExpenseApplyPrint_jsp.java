...
List  detailList =(List)request.getAttribute("detailList"); 
      ...
      out.write("    \t\t\t\t\t");
      out.print(NumberUtil.formatFloatDecimal(2,tripExpenseInfo.getTotalMoney()));
      out.write("\r\n");
      out.write("    \t\t</td>\r\n");
      ...
      out.write("1.The applicants take charge of the application's content and accessories, make sure their were reality,reasonble,nicety,legality. 申请者需对申请内容及附件的真实性、合理性、准确性、合法性负责。<br />\r\n");
      out.write(" 2.This Application Form is just applied for the operation between companies.这张付款表仅针对公司之间的业务往来。\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
