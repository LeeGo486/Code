...
public final class querydetail_005fpjpd2_jsp extends org.apache.jasper.runtime.HttpJspBase
...
out.print(request.getParameter("guid"));
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"0\">  </option><option value=\"1\">产品退仓</option><option value=\"2\">不能维修，退回店铺</option><option value=\"3\">可以维修</option></select></td><th>退仓处理结果</th><td colspan=\"2\"><input id=\"tccljg\"  style=\"width:200px;\"></input></td></tr>\r\n");
