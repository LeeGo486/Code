...
public final class querydetail_005fpjpd_jsp extends org.apache.jasper.runtime.HttpJspBase
...
out.print(request.getParameter("zt"));
      ...
      out.write("  <a id=\"save20\" class=\"easyui-linkbutton\" data-options=\"iconCls:'icon-redo'\" onclick=\"saveMaintain(id,$('#pdclfs').combobox('getValue'))\">品检判定</a>\r\n");
      out.write("  <a id=\"save07\" class=\"easyui-linkbutton\" data-options=\"iconCls:'icon-redo'\"  onclick=\"saveMaintain(id,7)\">维修完成</a>\r\n");
      out.write("  <a id=\"save08\" class=\"easyui-linkbutton\" data-options=\"iconCls:'icon-redo'\" onclick=\"saveMaintain(id,8)\">总部发货</a>\r\n");
      out.write("  <a id=\"save18\" class=\"easyui-linkbutton\" data-options=\"iconCls:'icon-redo'\" onclick=\"\">批量发货</a>\r\n");
      out.write("  \r\n");
      out.write(" <!--   <button id=\"save20\" class=\"easyui-linkbutton\" data-options=\"iconCls:'icon-redo'\"  disabled=\"disabled\" onclick=\"saveMaintain(id,$('#pdclfs').combobox('getValue'))\">品检判定</button>\r\n");
      out.write("  <button id=\"save07\" class=\"easyui-linkbutton\" data-options=\"iconCls:'icon-redo'\" disabled=\"disabled\" onclick=\"saveMaintain(id,7)\">维修完成</button>\r\n");
      out.write("  <button id=\"save08\" class=\"easyui-linkbutton\" data-options=\"iconCls:'icon-redo'\" disabled=\"disabled\" onclick=\"saveMaintain(id,8)\">总部发货</button>\r\n");
      out.write("  <button id=\"save18\" class=\"easyui-linkbutton\" data-options=\"iconCls:'icon-redo'\" disabled=\"disabled\" onclick=\"\">批量发货</button>\r\n");
      out.write("   -->\r\n");
      out.write("   </div>\r\n");
      ...
      out.write("\t\t    <tr></tr>\r\n");
      out.write("\t\t    <tr class=\"head\" ><td colspan=\"3\"><input id=\"guid\" type=\"hidden\" type=\"text\" value=\"");
out.print(request.getParameter("guid"));
      ...
      out.write("\t\t    \r\n");
      out.write("\t\t    <tr><th rowspan=\"2\">待修产品信息</th>\t<th>款号*</th><td><input id=\"kh\" onBlur=\"checkKh(value)\"></input></td><th>退回日期</th><td colspan=\"2\" ><input id=\"thrq\" disabled=\"disabled\" class=\"easyui-datebox\" style=\"width: 220px;\"></input></td></tr>\r\n");
      ...
      out.write("\t\t    \r\n");
      out.write("\t\t    \r\n");
      out.write("\t\t    <tr>\t\t\t\t\t\t\t<th>维修性质</th><td><select id=\"wxxz1\" style=\"width:200px;\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"0\">  </option><option value=\"1\">帮忙维修</option><option value=\"2\">质量维修</option></select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</td><th>问题点</th><td colspan=\"2\"><input id=\"wtd1\" style=\"width:200px;\" class=\"easyui-combogrid\"></input></td></tr>\r\n");
      out.write("\t\t    <tr>\t\t\t\t\t\t\t<th>起因</th><td><input id=\"qy1\" style=\"width:200px;\" class=\"easyui-combogrid\"></input></td><th>现象点</th><td colspan=\"2\"><input id=\"xxd1\" style=\"width:200px;\" class=\"easyui-combogrid\"></input></td></tr>\r\n");
      out.write("\t\t    <tr>\t\t\t\t\t\t\t<th colspan=\"5\">问题次因(选填)</th></tr>\r\n");
      out.write("\t\t    <tr>\t\t\t\t\t\t\t<th>维修性质</th><td><select id=\"wxxz2\" style=\"width:200px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"0\">  </option><option value=\"1\">帮忙维修</option><option value=\"2\">质量维修</option></select></td><th>问题点</th><td colspan=\"2\"><input id=\"wtd2\" style=\"width:200px;\" class=\"easyui-combogrid\"></input></td></tr>\r\n");
      out.write("\t\t    <tr>\t\t\t\t\t\t\t<th>起因</th><td><input id=\"qy2\" style=\"width:200px;\" class=\"easyui-combogrid\"></input></td><th>现象点</th><td colspan=\"2\"><input id=\"xxd2\" style=\"width:200px;\" class=\"easyui-combogrid\"></input></td></tr>\r\n");
      out.write("\t\t    <tr>\t\t\t\t\t\t\t<th colspan=\"5\">判定结果</th></tr>\r\n");
      out.write("\t\t    <tr>\t\t\t\t\t\t\t<th>判定处理方式*</th><td><select id=\"pdclfs\" style=\"width:200px;\" class=\"easyui-combobox\" name=\"state\" style=\"width:200px;\" data-options=\"required:true\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"0\">  </option><option value=\"1\">产品退仓</option><option value=\"2\">不能维修，退回店铺</option><option value=\"3\">可以维修</option></select></td><th>退仓处理结果</th><td colspan=\"2\"><input id=\"tccljg\" style=\"width:200px;\" disabled=\"disabled\"></input></td></tr>\r\n");
      out.write("\t\t    <tr>\t\t\t\t\t\t\t<th>责任部门</th><td><input id=\"zrbm\" style=\"width:200px;\"></input></td><th>退货单号</th><td colspan=\"2\"><input  type=\"text\"   id=\"thdh\" disabled=\"disabled\"></input></td></tr>\r\n");
      out.write("\t\t    <tr>\t\t\t\t\t\t\t<th>检测异议</th><td colspan=\"4\"><input id=\"jcyy\"></input></td></tr>\r\n");
      out.write("\t\t    <tr>\t\t\t\t\t\t\t<th>特修</th><td><select id=\"tx\" style=\"width:200px;\" class=\"easyui-combobox\"><option value=\"0\" selected=\"selected\">否</option><option value=\"1\">是</option></select></td><th>计划维修天数</th><td colspan=\"2\"><input id=\"jhwxts\" style=\"width:200px;\"></input></td></tr>\r\n");
      out.write("\t\t    <tr>\t\t\t\t\t\t\t<th>是否收费</th><td><select id=\"sfsf\" style=\"width:200px;\" class=\"easyui-combobox\"><option value=\"0\" selected=\"selected\">否</option><option value=\"1\">是</option></select></td><th>收费金额(元)</th><td colspan=\"2\"><input id=\"sfje\"></input></td></tr>\r\n");
      out.write("\t\t    <tr>\t\t\t\t\t\t\t<th>收费内容</th><td colspan=\"4\"><input id=\"sfnr\"></input></td></tr>\r\n");
      out.write("\t\t    <tr>\t\t\t\t\t\t\t<th>品检判定备注</th><td colspan=\"4\"><input id=\"pjpdbz\"></input></td></tr>\r\n");
