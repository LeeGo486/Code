...
<head>
 ...
 .d_over{background-color:#7D7DFF; }
		...
		<div class="easyui-accordion" data-options="fit:true,border:false">
			...
			<div title="成衣维修"  style="padding:10px;overflow:auto;height:20;width: 90">
				<s:iterator  value="#request.menuList" id="menu" >
					 <p   onclick="openMainWindow( '<s:property value="menuname"/>','<s:property value="actionUrl"/> ');"  class="d_over"
						...
						<img  src="<%=webContext %>/img/btnbg.jpg"  > <s:property value="menuname"/> 
					</p>
					</s:iterator>
			</div>
			<%} %>
