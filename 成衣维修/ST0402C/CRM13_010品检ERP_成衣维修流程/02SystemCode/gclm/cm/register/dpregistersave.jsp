...
<script type="text/javascript">
		...
		$.post(	'rest/getFilterdp/withCom',
				...
				//店铺对应维修仓信息
				     $.post(	'rest/getWxcdp/S2',
								{'pp':pp,'ldplx':ldplx,'com':com},function(wxc) {
									var wxcs = eval("(" + wxc + ")");
  ...
  <div  id="header">
    <a id="save00" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="saveMaintain(id,0)">登记</a>
	  <input type="text" readonly="readonly" value="登记" style="text-align:right;font-size: 17pt;font-family:'微软雅黑';" id="zt" width="100%" height="100%"/>
...
<table>
		    ...
		    <tr>							<th>是否收费</th><td><select id="sfsf" class="easyui-combobox" disabled="disabled" style="width:200px;" ><option value="0">否</option><option value="1">是</option></select></td><th>收费金额(元)</th><td colspan="2"><input id="sfje" type="text" disabled="disabled"></input></td></tr>
