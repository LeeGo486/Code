...
$(function(){
	...
	$('#dg').datagrid({
		...
		columns:[[
			...
			{field:'code',title:'编码',width:80,sortable:true,editor:'text'},
			{field:'content',title:'内容',width:80,sortable:true,editor:'text'},
			{field:'description',title:'描述',width:80,sortable:true,editor:'text'/*,
				editor:{type:'numberbox',options:{precision:0}}*/
			},
			{field:'sequence',title:'顺序',width:80,sortable:true,editor:'text'},
			{field:'parentCode',title:'上级编码',width:120,sortable:true,editor:'text'},
			{field:'scope',title:'类别',width:100,sortable:true,editor:'text'},
