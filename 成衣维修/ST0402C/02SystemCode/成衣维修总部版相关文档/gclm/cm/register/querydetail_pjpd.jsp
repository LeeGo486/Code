	...
	<div style="padding-top:40px">
	    ...
	    <table class="gridtable">
		    ...
		    <tr class="head"><td colspan="3"><input id="guid" type="hidden" value="<%out.print(request.getParameter("guid"));%>"></input></td><th><label >维修单号:</label></th><td colspan="2"><input id="wxdh" disabled="disabled"></input></td></tr>
		     ...
		     <tr><th rowspan="3">店铺信息</th>	<th>店铺编码</th><td><select id="dpbm"  style="width: 200px;border:1px solid #fffffb;" disabled="disabled"></select> </td><th>店铺名称</th><td><input id="dpmc" disabled="disabled" class="easyui-validatebox" type="text"  /></td><td><input ID="dplx" disabled="disabled" style="width: 30px"></input> </td></tr>
		    ...
		    <tr><th rowspan="2">待修产品信息</th>	<th>款号*</th><td><input id="kh" onBlur="checkKh(value)"></input></td><th>退回日期</th><td colspan="2" ><input id="thrq" disabled="disabled" class="easyui-datebox" style="width: 200px;"></input></td></tr>
		    ...
		    <tr>							<th>维修方式</th><td><select id="nx" style="width:200px;" class="easyui-combobox"><option value="0" selected="selected">内修</option><option value="1">外修</option></select></td><th>计划维修天数</th><td colspan="2"><input id="jhwxts" style="width:200px;"></input></td></tr>
		    <tr>							<th>是否收费</th><td><select id="sfsf" style="width:200px;" class="easyui-combobox"><option value="0" selected="selected">否</option><option value="1">是</option></select></td><th>收费金额(元)</th><td colspan="2"><input id="sfje"></input></td></tr>
		    <tr>							<th>收费内容</th><td colspan="4"><input id="sfnr"></input></td></tr>
		    <tr>							<th>品检判定备注</th><td colspan="4"><input id="pjpdbz"></input></td></tr>
