...
<style type="text/css">
 ...
 <!--  
		  <a id="save18" class="easyui-linkbutton" data-options="iconCls:'icon-redo'" onclick="">批量发货</a>
  -->
  <a id="save50" class="easyui-linkbutton" data-options="iconCls:'icon-redo',disabled:true" onclick="saveMaintain(id,5)">临时保持</a>
	...
	<div  id="a" style="padding-top:40px;">
	    ...
	    <table id="tab" class="gridtable">
		    ...
		    <tr class="head" ><td colspan="3"><input id="guid"  type="hidden" value="<%out.print(request.getParameter("guid"));%>"></input></td><th><label >维修单号:</label></th><td colspan="2"><input id="wxdh" disabled="disabled"></input></td></tr>
		     ...
		     <tr><th rowspan="3">店铺信息</th>	<th>店铺编码</th><td><input id="dpbm" type="text"  style="width: 200px;border:1px solid #fffffb;" disabled="disabled"></input> </td><th>店铺名称</th><td><input id="dpmc" disabled="disabled" class="easyui-validatebox" type="text" style="width: 170px" ></input></td><td><input ID="dplx" disabled="disabled" style="width: 30px"></input> </td></tr>
		     ...
		     <tr>		<th>顾客维修</th><td colspan="4"><input type="checkbox" disabled="disabled" id="isgkwx" name="isgkwx" value="1" style="width: 20px;" /> </td></tr>
		    ...
		    <tr><th rowspan="3">待修产品信息</th>	<th>款号*</th><td><input id="kh"  disabled="disabled" onBlur="checkKh(value)"></input></td><th>退回日期</th><td colspan="2" ><input id="thrq" class="easyui-datebox" style="width: 200px;"></input></td></tr>
		    ...
		    <tr><th rowspan="4">物流信息</th>	<th>运输公司</th><td><input id="ysgs" disabled="disabled" style="width: 200px;"></input></td><th>运单号</th><td colspan="2"><input id="ydh" disabled="disabled"></input></td></tr>
		    ...
		    <tr><th>备注信息</th> <td colspan="5"><textarea id="bzxx" disabled="disabled" style="height:30;width:100%"></textarea></td> </tr>
		    ...
		    <tr>							<th>维修方式</th><td><select id="nx" disabled="disabled" class="easyui-combobox" style="width:200px;"><option value="0" >内修</option><option value="1">外修</option></select></td><th>计划维修天数</th><td colspan="2"><input id="jhwxts" disabled="disabled" style="width:200px;"></input></td></tr>
		    <tr>							<th>是否收费</th><td><select id="sfsf" disabled="disabled" class="easyui-combobox" style="width:200px;"><option value="0" selected="selected">否</option><option value="1">是</option></select></td><th>收费金额(元)</th><td colspan="2" id="wxjefwtd"><input id="wxjefw" disabled="disabled" style="width:200px;"></input></td></tr>
	       ...
	       <br/>
	          ...
	          <div>
				...
				<!-- <td>特退审批人</td><td><input style="background-color: #C1CDC1;width: 120" readonly="readonly" id="ttspr"/></td><td>审批时间</td><td><input readonly="readonly" style="background-color: #C1CDC1;width: 120" id="spsj"/></td><td>维修确认人</td><td><input id="wxqrr" style="background-color: #C1CDC1;width: 120" readonly="readonly"/></td> -->
				</table>
	        </div>
