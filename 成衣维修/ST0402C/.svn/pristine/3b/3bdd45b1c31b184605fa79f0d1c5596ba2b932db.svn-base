...
<body onload="initForm()">
	...
	<html:form action="/customerPrint"
		styleId="customerPrintForm" method="post">
		...
		<tr>
			...
			<td align="right" width="40%">
				<!-- <font size="2px"> 维修单号&nbsp;<bean:write name="customerPrintForm" property="dh"/></font> -->
				<span id="dhspan" style="display: none;"><bean:write name="customerPrintForm" property="dh"/></span> 
				<div>
			...
			<table width="90%" class="table_thin" align="center">
				...
				<tr>
					...
					<td colspan="7"  width="18.5%" class="td_enabled">
						<bean:write name="customerPrintForm" property="PP"/>
					</td>
				</tr>
				<tr>
					...
					<td width="18.5%" class="td_enabled">
						<bean:write name="customerPrintForm" property="dpmc"/>
					</td>
					<td rowspan="4" width="10.5%" class="field_enabled">
						顾客信息
					</td>
				...
				<tr>
					...
					<td class="td_enabled">
						<bean:write name="customerPrintForm" property="DZXM"/>
					...
					<td class="td_enabled">
						<bean:write name="customerPrintForm" property="GKXM"/>
					</td>
					<td class="field_enabled">
						顾客电话
					</td>
					<td class="td_enabled">
						<bean:write name="customerPrintForm" property="GKLXDH"/>
					</td>
				...
				<tr>
					...
					<td class="td_enabled">
						<bean:write name="customerPrintForm" property="WXCBM"/>
					</td>
					<td class="field_enabled">
						VIP卡号
					</td>
					<td colspan="3" class="td_enabled">
						<bean:write name="customerPrintForm" property="VIPKH"/>
					</td>
				...
				<tr>
					...
					<td class="td_enabled">
						<bean:write name="customerPrintForm" property="SLDG"/>
					</td>
					<td class="field_enabled">
						付费维修
					</td>
		...
		<table width="90%" class="table_thin" align="center">
			<tbody>
				...
				<tr>
					<td class="td_enabled">
						<bean:write name="customerPrintForm" property="KH"/>
					</td>
					<td class="td_enabled">
						<bean:write name="customerPrintForm" property="YS"/>
					</td>
					<td class="td_enabled">
						<bean:write name="customerPrintForm" property="MS"/>
					</td>
					<td class="td_enabled">
						<bean:write name="customerPrintForm" property="SCSJ"/>
					</td>
					<td class="td_enabled">
						<bean:write name="customerPrintForm" property="WTMS"/>
					</td>
				</tr>
				<tr>
					...
					<td class="td_enabled">
						<bean:write name="customerPrintForm" property="YSGS"/>
					</td>
					<td class="field_enabled">
						物流单号
					</td>
					<td class="td_enabled">
						<bean:write name="customerPrintForm" property="YDH"/>
					</td>
				</tr>
				<tr>
					<td class="field_enabled">
					...
					<td colspan="3" class="td_enabled">
						<bean:write name="customerPrintForm" property="FHDZ"/>
