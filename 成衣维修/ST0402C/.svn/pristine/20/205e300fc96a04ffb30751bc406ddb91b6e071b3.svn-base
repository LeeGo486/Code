...
<meta http-equiv="Content-Type" content="text/html; charset= GBK  ">
 ...
 function checkzt(ztnew){
  ...
  <div id="header">
    <a id="save00" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="saveMaintain(id,0)">维修登记</a>
	<a id="save10" class="easyui-linkbutton" data-options="iconCls:'icon-redo'" onclick="saveMaintain(id,1)">发货到总部</a>
  ...
  <input type="text" readonly="readonly" style="text-align:right;font-size: 17pt;font-family:'微软雅黑';" id="zt" width="100%" height="100%"/>
	...
	<div  id="a" style="padding-top:40px;">
	    ...
	    <table id="tab" class="gridtable">
		    <tr></tr>
		    <tr class="head" ><td colspan="3"><input id="guid"  type="hidden" value="<%out.print(request.getParameter("guid"));%>"></input></td><th><label >维修单号:</label></th><td colspan="2"><input id="wxdh"  ></input></td></tr>
		     
		     <tr><th rowspan="3">店铺信息</th>	<th>店铺编码</th><td><select id="dpbm"   style="width: 200px;border:1px solid #fffffb;"  ></select> </td><th>店铺名称</th><td><input id="dpmc"   class="easyui-validatebox" type="text" /></td><td><input ID="dplx"   style="width: 30px"></input> </td></tr>
		     ...
		     <tr><th rowspan="2">维修接单信息</th><th>受理导购*</th><td><input id="sldg"   style="width: 200px;"></input></td><th>导购联系电话*</th><td colspan="2"><input id="dglxdh"  ></input></td></tr>
		     <tr>		<th>顾客维修</th><td colspan="4"><input type="checkbox"   id="isgkwx" name="isgkwx" value="1" onchange="isGkwx()" style="width: 20px;"/> </td></tr>
		     
		    <tr><th rowspan="3">顾客信息</th>	<th>VIP卡号</th><td><input id="vipkh"  ></input></td><th>顾客姓名*</th><td colspan="2"><input id="gkxm"   data-options="required:true"></input></td></tr>
		    ...
		    <tr>							<th>问题描述*</th><td colspan="4"><textarea id="wtms"   style="height:60px;width: 100%"></textarea></td></tr>
		    
		    <tr><th rowspan="4">物流信息</th>	<th>运输公司</th><td><input id="ysgs"   style="width: 200px;"></input></td><th>运单号</th><td colspan="2"><input id="ydh"  ></input></td></tr>
		    ...
		    <tr>							<th>判定处理方式*</th><td><select id="pdclfs"  disabled="disabled" class="easyui-combobox" name="state" style="width:200px;" data-options="required:true" >
												<option value="0">  </option><option value="1">产品退仓</option><option value="2">不能维修，退回店铺</option><option value="3">可以维修</option></select></td><th>退仓处理结果</th><td colspan="2"><input id="tccljg"  style="width:200px;"></input></td></tr>
