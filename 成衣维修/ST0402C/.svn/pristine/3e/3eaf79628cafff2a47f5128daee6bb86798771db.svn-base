...
<table>
 ...
 <tr>
	...
	<div align="center" style="padding-top: 20">
		...
		<td>登记时间</td><td><input id="dd1" name="dd1" class="easyui-datebox" style="width:135px;"  onkeydown="enter()"></input></td><td>- -</td><td><input id="dd2" name="dd2" class="easyui-datebox" style="width:135px;"  onkeydown="enter()"></input></td>
		</tr>
