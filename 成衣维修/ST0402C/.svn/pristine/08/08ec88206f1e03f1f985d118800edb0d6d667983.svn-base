...
<script type="text/javascript">
  ...
  <div  id="header">
    ...
    <!--  <a id="save00" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="saveMaintain(id,0)">登记保存</a> -->
 ...
 <a id="printkdd" class="easyui-linkbutton" data-options="iconCls:'icon-print'" onclick="kddPrint()">快递单打印</a>  
	...
	<div style="background:#fafafa;padding-top:40px">
	    ...
	    <table class="gridtable">
		    ...
		    <tr>								<th>供应商</th><td colspan="4"><select id="gys" name="gys" style="width: 200px;"></select> </td></tr>
		   ...
		   <tr>								<th>部位描述</th><td colspan="4"><textarea id="wxbw" style="height:50px;width: 600px"></textarea></td></tr>
		    ...
		    <tr>							<th>维修方式</th><td><select id="nx" class="easyui-combobox" disabled="disabled" style="width:200px;" ><option value="0" >内修</option><option value="1" >外修</option></select></td><th>计划维修天数</th><td colspan="2"><input id="jhwxts" disabled="disabled" style="width:200px;" class="easyui-combogrid"></input></td></tr>
		    <tr>							<th>是否收费</th><td><select id="sfsf" class="easyui-combobox" disabled="disabled" style="width:200px;"><option value="0"  >否</option><option value="1">是</option></select></td><th>收费金额(元)</th><td colspan="2"><input id="wxjefw" type="text" disabled="disabled"></input></td></tr>
		    <tr>							<th>收费内容</th><td colspan="4"><input id="sfnr" type="text" disabled="disabled" width="100%"></input></td></tr>
		    <tr>							<th>品检判定备注</th><td colspan="5"><input id="pjpdbz" disabled="disabled" width="100%"></input></td></tr>
