...
<body onload="initForm()">
	...
	<html:form action="/customerPrintSelf"
		...
		<tr>
			...
			<td align="center">
				<font size="5" style= "font-weight:bold ">成衣维修/修改单</font> 
			</td>
		...
		<!-- <table width="100%" border="0" bgcolor=#000000 cellpadding="0" cellspacing="1"> -->  
			<table width="90%" class="table_thin" align="center">
				...
				<tr>
					...
					<td class="td_enabled">
						<bean:write name="customerPrintSelfForm" property="DZLXDH"/>
					</td>
					<td class="field_enabled">
						VIP卡号
					</td>
			...
			<tbody>
				...
				<tr>
					...
					<td colspan="4" class="td_enabled">
						<bean:write name="customerPrintSelfForm" property="FHDZ"/>
		...
		<table width="90%" align="center">
		 <tr>
		 	<td align="left" colspan="2">
		 		<font color="red" size="2">备注：提货时必须凭此单，预计交货时间如果没有变化，我们将会第一时间通知你，敬请谅解！</font>
		 	</td>
		 </tr>		
		 <tr>
