...
<body onload="initForm()">
	...
	<ec:table  items="recordlist" var="record"  tableId="ecTable"
			...
			<ec:row recordKey="${record.GUID},${record.ZTCODE},${record.DH}" ondblclick="initOtherframes()" onclick="setParentPara()">
				...
				<ec:column title="维修费用" property="SFJE" sortable="true"  cell="number" format="0.00" style="text-align:right"  />
				...
				<ec:column title="总部发货时间" property="ZBFH_BZRQ"  sortable="true" cell="date" format="yyyy-MM-dd"/>
