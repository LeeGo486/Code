...
<body > 
	...
	<input type="button"  id="finish" disabled="disabled" name="finish" value="维修完成" onclick="finish();"/>
	 ...
	 <br>
	<font style="font-size:15;font-weight: 500;color: white;font-family:Microsoft YaHei,微软雅黑,Microsoft JhengHei,华文细黑,STHeiti,MingLiu">注：1、本模块管理店铺不通过总部(直接维修)的衣服记录；2、维修单有三种状态 任务接受 \完成； 3、任务接受后必须打印[成衣维修/修改单 ]给顾客，以便索取衣服！</font>
	<div id="gallery">
