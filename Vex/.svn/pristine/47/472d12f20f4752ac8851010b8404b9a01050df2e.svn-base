...
$(function () {
    ...
    $('#formselect #txtbr1_name').combogrid({
        panelWidth: 110,
        url: GetWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8') + "&pagerows=20000&XML=" + GetFormJson([], 'GETBRANDSEARCH'),
        idField: 'br1_name',
        textField: 'br1_name',
        mode: 'remote',
        columns: [[
    ...
    $('#formselect #txtpd1_season').combobox({
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson([], 'GET') + "&Where=CT1_Code='" + "SSON" + "'",
        panelHeight: 'auto',
        editable: false,
        valueField: 'id',
        textField: 'text'
    ...
    $('#formselect #txtpo1_pc1_contractcode').combogrid({
        panelWidth: 100,
        url: GetWSRRURL('ac31b57a-a197-4e08-8d4e-433b006af792') + "&XML=" + GetFormJson([], 'GETCONTRACTCOMBOGRID'),
    ...
    $('#formAddEdit #txtpo1_sourcepocode').combogrid({
        panelWidth: 120,
        url: GetWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8') + "&XML=" + GetFormJson([], 'GETALL'),
        idField: 'coid',
        textField: 'code',
        mode: 'remote',
        columns: [[
    ...
    //    }
    //});
    var url = GetWSRRURL('47a9a2ce-92d8-4bea-800b-fabf87dd7850') + "&XML=" + GetFormJson("", 'GET');//组成URL，供加载采购单主表信息
...
//function PrintDetailShow() {
//    var getHeadRow = $('#PO1_POHeadList').datagrid('getSelected');
//    if (getHeadRow == null) {
//        alert("请在采购单中选择一行数据");
//    }
//    else {
//        $('#po1_pocode').html(getHeadRow.po1_pocode);
//        $('#po1_potypename').html(getHeadRow.po1_potypename);
//        $('#br1_name').html(getHeadRow.br1_name);
//        $('#sp1_name').html(getHeadRow.sp1_name);
//        $('#po1_pznumber').html(getHeadRow.po1_pznumber);
//        $('#po1_ocurrencysums').html(getHeadRow.po1_ocurrencysums);
//        $('#po1_paymenttypename').html(getHeadRow.po1_paymenttypename);
//        $('#po1_lmuser').html(getHeadRow.po1_lmuser);
//        $('#po1_lmdt').html(getHeadRow.po1_lmdt);

//        PrintDetailGrid(m_url);
...
function onClickRow(RowIndex, RowData) {
    ...
    m_url = GetWSRRURL('47a9a2ce-92d8-4bea-800b-fabf87dd7850') + "&XML=" + GetFormJson("", 'GETPODETILFORPRINT') + "&WHERE=" + " PO2_POCode = '" + mPO1POCode + "'"; //用于打印、导出采购单明细
...
function Type(type) {
    ...
    if (type == "Add") {
        ...
        //初始化采购单类型下拉
        $('#formAddEdit #txtpo1_potypename').combobox({
            url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson([], 'GET') + "&Where=CT1_Code='" + "ITCL" + "'",
            valueField: 'id',
            textField: 'text',
            required: true,
            panelHeight: 'auto',
        ...
        $('#formAddEdit #txtpo1_paymenttypename').combobox({
            url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson([], 'GET') + "&Where=CT1_Code='" + "TEPY" + "'",
            panelHeight: 'auto',
            editable: false,
            required: true,
            valueField: 'text',
        ...
        $('#formAddEdit #txtpo1_paymentchannelname').combobox({
            url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson([], 'GET') + "&Where=CT1_Code='" + "PYTP" + "'",
            panelHeight: 'auto',
            editable: false,
            valueField: 'text',
            required: true,
        ...
        $('#formAddEdit #txtpo1_increaseratio').combobox({
            url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson([], 'GET') + "&Where=CT1_Code='" + "VTCD" + "'",
            panelHeight: 'auto',
            editable: false,
            valueField: 'text',
            textField: 'text',
        ...
        $('#formAddEdit #txtpo1_transportratio').combobox({
            url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson([], 'GET') + "&Where=CT1_Code='" + "FRHT" + "'",
            panelHeight: 'auto',
            editable: false,
            valueField: 'text',
            textField: 'text',
        ...
        $('#formAddEdit #txtpo1_tariffratio').combobox({
            url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson([], 'GET') + "&Where=CT1_Code='" + "TARI" + "'",
            panelHeight: 'auto',
            editable: false,
            valueField: 'text',
            textField: 'text',
    ...
    if (type == "Add") {
        ...
        var url1 = GetWSRRURL('47a9a2ce-92d8-4bea-800b-fabf87dd7850') + "&XML=" + GetFormJson(data, 'GETAPOList') + "&WHERE=" + "1!=1";
        //ClearGrid("#AP1_APOHeadList");
    }
    else if (type == "Edit") {
        var mAP1_PO1_PurchaseCode = $('#formAddEdit #txtpo1_pocode').val()
        ...
        var data = [];
        data[data.length] = { "name": "txtpurchasecode", "value": mAP1_PO1_PurchaseCode }
        var url1 = GetWSRRURL('47a9a2ce-92d8-4bea-800b-fabf87dd7850') + "&XML=" + GetFormJson(data, 'GETAPOList')
    }
...
function Add_Sourcepocode() {
    ...
    if (sourcepocode == "") {
        ...
        url = GetWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8') + "&XML=" + GetFormJson("", 'ALLDataALL') + "&WHERE=" + escape(url);
        ...
        onSubmit: function (e) {
            ...
            $.messager.confirm('提示框', '是否确认提交', function (r) {
                if (r) {
                    ...
                    data[data.length] = { "name": "txtpo1_potypename", "value": $('#formAddEdit #txtpo1_potypename').combobox('getText') }
                    data[data.length] = { "name": "txtpo1_potypecode", "value": $('#formAddEdit #txtpo1_potypecode').val() }
