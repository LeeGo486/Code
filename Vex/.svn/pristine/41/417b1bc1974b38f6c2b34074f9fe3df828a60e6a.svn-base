...
{
    /// <summary>
    ///PLM_MaterialDetail_EditByXML 的摘要说明
    /// </summary>
    public class PLM_MaterialDetail_EditByXML : LogicBase, ILogicGetData
    {
        public PLM_MaterialDetail_EditByXML()
        {
        ...
        public DataSet GetData()
        {
            ...
            try
            {
                ...
                DataSet ds = conn.GetDataSetBySP("SP_PLM_WHLOManage", strParam, strValue);
