...
/// 类名：FluxWMSD_MOVE_OutdepotWToDInterface
/// 类说明：调拨出库单发货导入DRP接口DRP	WMS->DRP	
/// 创建人：郭琦琦 
/// 创建日期：2015-03-27
/// 修改人：
/// 修改日期：
...
{
    public class FluxWMSD_MOVE_OutdepotWToDInterface : HZYLogicBase, ILogicGetData
    {
        #region 构造函数
        public FluxWMSD_MOVE_OutdepotWToDInterface()
        {
        ...
        private void Insert()
        {
            ...
            m_conn.InsertBYSQLBC("Get_FLUXWMS_D_MOVE_Outdepot", dtList);
