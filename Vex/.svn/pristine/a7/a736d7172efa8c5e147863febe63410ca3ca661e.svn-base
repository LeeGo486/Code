...
/// 类名：FluxWMSDifferentCOMTRWToDInterface
/// 类说明：跨公司调拨入库收货数据回传DRP	WMS->DRP	调拨收货单登账及差异生成
/// 创建人：郭琦琦 
/// 创建日期：2015-03-03
/// 修改人：
/// 修改日期：
...
{
    public class FluxWMSDifferentCOMTRWToDInterface : HZYLogicBase, ILogicGetData
    {
        #region 构造函数
        public FluxWMSDifferentCOMTRWToDInterface()
        {
        ...
        private void Insert()
        {
            ...
            m_conn.InsertBYSQLBC("Get_FLUXWMS_D_Msell", dtList);
