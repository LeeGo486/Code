...
/// 类名：FluxWMSWeiPHReturnWToDInterface
/// 类说明：唯品会退货入库收货数据回传DRP	WMS->DRP	退货收货单登账及差异生成
/// 创建人：郭琦琦 
/// 创建日期：2015-03-12
/// 修改人：
/// 修改日期：
...
{
    public class FluxWMSWeiPHReturnWToDInterface : HZYLogicBase, ILogicGetData
    {
        #region 构造函数
        public FluxWMSWeiPHReturnWToDInterface()
        {
        ...
        private void Insert()
        {
            ...
            m_conn.InsertBYSQLBC("Get_FLUXWMS_VIPSHOP_D_Outindent", dtList);
