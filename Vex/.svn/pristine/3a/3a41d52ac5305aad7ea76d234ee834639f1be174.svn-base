...
{
    /// <summary>
    ///MDM_System_User_ExceuteGetFromPLM 从PLM辅助系统中，抽取数据到MDM中
    /// </summary>
    public class MDM_System_User_ExceuteGetFromPLM : LogicBase, ILogicExecute
    {
        public MDM_System_User_ExceuteGetFromPLM()
        {
