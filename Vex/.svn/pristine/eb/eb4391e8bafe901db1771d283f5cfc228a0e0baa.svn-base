...
function gridDBClickRow(rowIndex, rowData) {
    ...
    if (rowData.hr3_type == m_taskTypes[0].value) { //加班申请
        ...
        if (m_UserInfo.actor == 'A') {
            curl = 'checkAttendanceAdd.html?' + 'v0=' + v0 + '&v1=' + rowData.hr3_rid
                 + '&v2=' + rowData.hr3_id + '&s=' + new Date().getTime();
        }
        else {
            curl = 'checkAttendanceApprove.html?' + 'v0=' + v0 + '&v1=' + rowData.hr3_rid
                 + '&v2=' + rowData.hr3_id + '&s=' + new Date().getTime();
        }
        ...
        curl = 'specialPayRecord.html?' + 'v0=' + v0 + '&v1=' + rowData.hr3_rid
             + '&v2=' + rowData.hr3_id + '&v3=task&s=' + new Date().getTime();
    }
