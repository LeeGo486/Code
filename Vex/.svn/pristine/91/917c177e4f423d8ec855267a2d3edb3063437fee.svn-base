...
//科目类别
var m_DLListid = peoa_GetBDFID(17); //大类编码
var m_DLList = [];  //大类数组
var m_XLList = [];  //小类数组
var m_DLrow ;  //大类编辑行
var m_XLrow;   //小类编辑行
...
$(function () {
    ...
    $(m_DatagridID).datagrid({
        ...
        columns: [[
			...
			{ field: 'ct1_code', title: '大类编码', width: 100, sortable: true, editor: 'text' },
    ...
    $(m_DatagridID1).datagrid({
        ...
        columns: [[
            ...
            { field: 'ct1_cono', title: 'ct1_cono', width: 100, hidden: true },
            { field: 'ct1_divi', title: 'ct1_divi', width: 100, hidden: true },
			{ field: 'ct1_code', title: '小类编码', width: 100, sortable: true, editor: 'text' },
			{ field: 'ct1_codename', title: '小类名称', width: 160, sortable: true, editor: 'text' },
			{ field: 'ct1_fieldvalues5', title: '科目说明', width: 200, sortable: true, editor: 'text' },
			{
