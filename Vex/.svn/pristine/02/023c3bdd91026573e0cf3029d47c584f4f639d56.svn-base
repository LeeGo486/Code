    ...
    $('#Pr1_PaymentrequisitList').datagrid(
        {
            ...
            onBeforeLoad: function (param) {
                ...
                data1[data1.length] = { "name": "txtDIVI", "value": "D01" };
                data1[data1.length] = { "name": "txtCONO", "value": "GL" };
                ...
                data1[data1.length] = { "name": "txt每页数量", "value": param.rows };
                data1[data1.length] = { "name": "txt返回页码", "value": param.page };
                ...
                $('#Pr1_PaymentrequisitList').datagrid('options').url = url;
            },
            columns: [[
...
function savePR1_PaymentRequisit(type) {
    ...
    if (type == "insert") {
        ...
        data[data.length] = { "name": "txtpr1_cono", "value": "GL" };
        data[data.length] = { "name": "txtpr1_divi", "value": "D01" };
...
function savePB1_PaymentBill(type) {
    ...
    if (type == "insert") {
        ...
        data[data.length] = { "name": "txtpb1_cono", "value": "GL" }
        data[data.length] = { "name": "txtpb1_divi", "value": "D01" }
