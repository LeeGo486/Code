...
$(function () {
    var url = GetWSRRURL('643a8280-09c8-4e52-aaff-1d27440b7d41') + "&XML=" + GetFormJson(m_data, 'SupplierInfoForPageList');
    InitGird(url);
...
function doSearch() {
    ...
    url = GetWSRRURL('643a8280-09c8-4e52-aaff-1d27440b7d41') + "&XML=" + GetFormJson(m_data, 'SupplierInfoForPageList');
    InitGird(url);
}
...
function winFormBuild(type) {
    ...
    if (type == "edit") {
        formHtml += "<div style=\"padding-left:5px;padding-top:20px;\">";
        formHtml += "供应商简称：<span style=\"color:#808080\">" + getData.sp1_name + "</span>";
        formHtml += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
        formHtml += "供应商名称：<span style=\"color:#808080\">" + getData.sp1_desp + "</span></div>";
        formHtml += "<div style=\"padding-left:5px;padding-top:20px;\">";
    };
...
function formInputINIT(type) {
    if (type == "new") {
        ...
        if (m_compName == "LX") {
            $("#company").combobox({
                url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8') + "&XML=" + GetFormJson(m_data, 'SupplierBasicInfo') + "&Where=CT1_Code ='COMP'",
                valueField: 'id',
                textField: 'text',
                panelHeight: 'auto',
                editable: false,
        ...
        $("#featurename").combobox({
            url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8') + "&XML=" + GetFormJson(m_data, 'SupplierBasicInfo') + "&Where=CT1_Code ='FEAT'",
            valueField: 'id',
            textField: 'text',
            panelHeight: 'auto',
            editable: false,
        ...
        //类别
        $("#typecode").combobox({
            url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8') + "&XML=" + GetFormJson(m_data, 'SupplierBasicInfo') + "&Where=CT1_Code ='CATE'",
            valueField: 'id',
            textField: 'text',
            panelHeight: 'auto',
            editable: false,
        ...
        //分类
        $("#regioncode").combobox({
            url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8') + "&XML=" + GetFormJson(m_data, 'SupplierBasicInfo') + "&Where=CT1_Code ='SORT'",
            valueField: 'id',
            textField: 'text',
            panelHeight: 'auto',
            editable: false,
    ...
    if (type == "edit") {
        $("#start").combobox({
            url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8') + "&XML=" + GetFormJson(m_data, 'SupplierBasicInfo') + "&Where=CT1_Code ='SATE'",
            valueField: 'id',
            textField: 'text',
            panelHeight: 'auto',
            editable: false,
