...
/// 类名：MDM_Entity_EditByBrandMarket 
/// 类说明：根据MDM品牌信息来编辑Entity
/// 创建人：马卫清
/// 创建日期：2013-07-11
/// 修改人：
/// 修改日期：
...
{
    /// <summary>
    ///MDM_Entity_EditByBrandMarket 根据MDM品牌信息来编辑Entity
    /// </summary>
    public class MDM_Entity_EditByBrandMarket : LogicBase, ILogicGetData
    {
        public MDM_Entity_EditByBrandMarket()
        {
        ...
        public DataSet GetData()
        {
            ...
            try
            {
                ...
                string strStoreEntityCode = "0008";
                string strMarketTableName = "Brand_For_FM";

                DataSet ds = Common.Common.GetDSByExcelXML(strXML);

                //if (ds.Tables["OPTYPE"].Rows[0][0].ToString() == "EDIT")
                //{
                //}
