...
$(function () {
    ...
    $('#formGoods #txtst1_br1_brandcode').combogrid({
        url: GetWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8') + "&XML=" + GetFormJson(m_data, 'GETBRAND') + "&Where=BR1_State='20'",
        panelWidth: 160,
    ...
    $('#formGoods #txtst1_suppliercode').combogrid({
        panelWidth: 200,
        url: GetWSRRURL('643a8280-09c8-4e52-aaff-1d27440b7d41') + "&XML=" + GetFormJson(m_data, 'SupplierInfo') + "&Where=SP1_State='20'",
    ...
    $('#formGoods #txtst1_years').combobox({
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "YEAR" + "' AND CT1_State='20'",
        panelHeight: 50,
        editable: false,
        valueField: 'id',
        textField: 'text',
    ...
    if (zt == 'GL') {
        ...
        $('#formGoods #txtst1_season').combobox({
            url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "SSON" + "' AND CT1_State='20'",
            panelHeight: '120',
            editable: false,
            valueField: 'id',
            textField: 'text',
    ...
    $('#formGoods #txtst1_standard').combobox({
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "STRD" + "' AND CT1_State='20'",
        panelHeight: 120,
        editable: false,
        valueField: 'id',
        textField: 'text'
    ...
    $('#formGoods #txtst1_safetechnology').combobox({
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "STCL" + "' AND CT1_State='20'",
        panelHeight: 120,
        editable: false,
        valueField: 'id',
        textField: 'text'
    ...
    $('#formGoods #txtst1_unit').combogrid({
        panelWidth: 100,
        url: GetWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8') + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "UNIT" + "' AND CT1_State='20'",
    ...
    $('#formGoods #txtst1_category').combobox({
        url: GetComboxALLColumnWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "ITCL" + "' AND CT1_State='20'",
        panelHeight: '120',
        editable: false,
        valueField: 'id',
        textField: 'text',
        ...
        onSelect: function (data) {
            ...
            $('#formGoods #txtst1_largeclass').combobox({
                url: GetComboxALLColumnWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8') + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "ITGR" + "' and CT1_FatherID='" + data.CT1_ID + "' AND CT1_State='20'",
                panelHeight: '120',
                editable: false,
                valueField: 'id',
                textField: 'text',
                ...
                onSelect: function (data) {
                    //加载小类combobox下拉
                    var data = $.ajax({
                        url: GetComboxALLColumnWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8') + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "ITGL" + "' and CT1_FatherID='" + data.CT1_ID + "' AND CT1_State='20'",
                        type: 'post',
                        async: false//同步,
                    });
    ...
    $('#formGoods #txtst2_color').combobox({
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "COLO" + "' AND CT1_State='20'",
        panelHeight: '120',
        editable: false,
        valueField: 'id',
        textField: 'text',
    ...
    $('#formGoods #txtst1_currency').combobox({
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "CUCD" + "' AND CT1_State='20'",
        panelHeight: '120',
        editable: false,
        valueField: 'id',
        textField: 'text',
    ...
    $('#formGoods #txtst2_sizegroup').combobox({
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "SDGP" + "' AND CT1_State='20'",
        panelHeight: 100,
        editable: false,
        valueField: 'id',
        textField: 'text',
    ...
    $('#formGoods #txtst1_provenance').combogrid({
        panelWidth: 100,
        url: GetWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8') + "&pagerows=20000&XML=" + GetFormJson(m_data, 'GET') + "&Where=CT1_Code='" + "COTY" + "' AND CT1_State='20'",
        idField: 'ct1_optionsvalues',
        textField: 'ct1_options',
        mode: 'remote',
        required: false,
    ...
    cols[0][cols[0].length] = { field: 'st1_ingredients', title: '成分', width: 40, search: true, sortable: true };
    if (zt == "LX") {//斓绣特有的
    ...
    var url = GetWSRRURL('0299c774-0dff-496b-b7dc-4fae25e96f9d') + "&XML=" + GetFormJson(m_data, 'GoodsInfoForPageList');
    initGird(url, cols);
...
function initGird_GoodsSelect() {
    ...
    //}
    url = GetWSRRURL('0299c774-0dff-496b-b7dc-4fae25e96f9d') + "&XML=" + GetFormJson(m_data, 'GoodsInfoForPageList') + "&WHERE=" + escape(url);
    initGird(url);
}
...
function btnAddSize() {
    ...
    data[data.length] = m_data[0];
    var url = GetWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8') + "&XML=" + GetFormJson(data, 'GETSKULIST');
    $('#tabSKU').datagrid({
        url: url,
        striped: true, //True 奇偶行使用不同背景色
        singleSelect: false,
