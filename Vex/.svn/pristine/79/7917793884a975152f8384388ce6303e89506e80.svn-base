 ...
 *  2013-05-27
 */
function dataUtil_getUrlParam(name) {
 ...
 *  2014-05-27
 */
function dataUtil_getCodename(list, code, codefield, namefield) {
    var codename = code;
 ...
 *  DLY 
 */
function dataUtil_random(n1, n2, n3) {
 ...
 *  DLY 
 */
function dataUtil_AtoB(v1, v2, v3) {
    if (v1 == v2) {
        return v3;
    } else {
        return v1;
