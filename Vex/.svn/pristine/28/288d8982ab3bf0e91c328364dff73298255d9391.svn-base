...
$(function () {
    ...
    $('#txtCom').combobox({
        ...
        url: GetComboxWSRRURL('4d173b24-6efd-419e-8efa-ce9e5138ad36') + "&MDMClass=0001&PropertyName=" + escape("公司中文简称") + "&Where=" + escape("公司中文简称") + " in" + escape("('嘉莹','泓雅','雅妍集','嘉澜','嘉雅','慧斓','斓居','维姬','新疆','雅斓','雅莹','拉萨格桑拉')"),
