...
var editIndex;
var m_RowData;
var m_ViewTableName = "V_L0013_FOR_OPENSHOP_DL";
...
$(function () {
    ...
    //txtCom
    $('#txtCom').combobox({
        url: GetComboxWSRRURL('4d173b24-6efd-419e-8efa-ce9e5138ad36') + "&MDMClass=0001&PropertyName=" + escape("公司中文简称") + "&Where=" + escape("公司中文简称") + " in " + escape("('贝爱','雅斓')"),
        required: true,
        panelHeight: 'auto',
        editable: false,
        valueField: 'id',
