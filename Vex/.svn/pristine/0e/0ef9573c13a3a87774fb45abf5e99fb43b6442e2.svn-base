...
/// 类名：MDM_System_User_ExceuteGetFromGPF22ForHZYCMTJL
/// 类说明：从GP的F22系统中，抽取用户数据到MDM中，HZYCMT卓莱雅（CMT活动任务管理）专用
/// 创建人：郭琦琦
/// 创建日期：2015-05-15
/// 修改人：
/// 修改日期：
...
{
    /// <summary>
    ///MDM_System_User_ExceuteGetFromGPF22ForHZYCMT 从GP的F22系统中，抽取用户数据到MDM中，HZYCMT（CMT活动任务管理）专用
    /// </summary>
    public class MDM_System_User_ExceuteGetFromGPF22ForHZYCMTJL : LogicBase, ILogicExecute
    {
        public MDM_System_User_ExceuteGetFromGPF22ForHZYCMTJL()
        {
