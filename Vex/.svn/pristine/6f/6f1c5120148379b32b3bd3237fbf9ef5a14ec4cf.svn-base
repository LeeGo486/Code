...
var msp1_regionname = [{ "id": "D", "text": "国内" }, { "id": "I", "text": "国外" }];//国内不能建
...
$(function () {
    ...
    var url = GetWSRRURL('d15d8c7d-4eb5-47c8-a2ba-fe3b95bb811b') + "&XML=" + GetFormJson([], 'SupplierInfoForPageList');
    InitGird(url);
})
//加载数据
...
function AddSupplier() {
    ...
    $('#txtsp1_state').combobox('setValue', "");//状态
    ...
    $('#txtsp1_name').attr("disabled", "");
    $('#txtsp1_desp').attr("disabled", "");
                ...
                if (r) {
                    ...
                    if (strsp1_suppliercode == "系统自动生成") {
                        if (sp1_regioncode == "D") {
                            ...
                            //data[data.length] = { "name": "txt供应商类型", "value": sp1_typecode };
                            //data[data.length] = { "name": "txt供应商分类", "value": sp1_regioncode };
                            //data[data.length] = { "name": "txt供应商特性", "value": sp1_featurecode };
                    ...
                    $.ajax({
                        url: GetWSRRURL('d15d8c7d-4eb5-47c8-a2ba-fe3b95bb811b'),
                        type: 'post',
                        async: true, //异步,
                        data: { "XML": XMLData },
...
function doSearch() {
    ...
    url = GetWSRRURL('d15d8c7d-4eb5-47c8-a2ba-fe3b95bb811b') + "&XML=" + GetFormJson([], 'SupplierInfoForPageList') + "&WHERE=" + escape(url);
    InitGird(url);
}
