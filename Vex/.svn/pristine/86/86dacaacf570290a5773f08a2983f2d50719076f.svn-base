...
/// 类名：sizeGroup
/// 类说明：对sizeGroup(索赔的增删改查)的CRUD,为Easyui专用
/// 创建人：刘洪
/// 创建日期：2014-11-11 
/// 修改人：俞佳伟
/// 修改日期：
    ...
    public class sizeGroup : HZYLogicBase, ILogicGetData
    {
        ...
        private void Get(string where)
        {
            ...
            string strSQL = @"
                    ...
                    WHERE CT1_CodeName = '尺码组' AND CT1_DIVI='" + m_hzyMessage.Env_SN + "'";
            strSQL += @"
                    --尺码
                    SELECT [CT1_ID] AS SizeID
                          ...
                          INTO #Temp2
                    FROM [M01_CONF].[CT0_CSYTAB]
                    WHERE CT1_CodeName = '尺码' AND CT1_DIVI='" + m_hzyMessage.Env_SN + "'";
        ...
        private void sizeList()
        {
            ...
            string strSQL = @"
                            SELECT [CT1_ID]
                                  ...
                                  ,[CT1_LmUser]
                            FROM [M01_CONF].[CT0_CSYTAB]
                            WHERE CT1_CodeName = '尺码' AND CT1_FatherID = '" + strFatherId + "' AND CT1_DIVI='" + m_hzyMessage.Env_SN + "'";
