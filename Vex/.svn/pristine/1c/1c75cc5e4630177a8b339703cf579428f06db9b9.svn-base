...
/// 类名：FluxWMSShopReturnWToDInterface
/// 类说明：门店退货入库收货数据回传DRP	WMS->DRP	退货收货单登账及差异生成
/// 创建人：郭琦琦 
/// 创建日期：2015-03-03
/// 修改人：
/// 修改日期：
...
{
    public class FluxWMSShopReturnWToDInterface : HZYLogicBase, ILogicGetData
    {
        #region 构造函数
        public FluxWMSShopReturnWToDInterface()
        {
        ...
        private void Insert()
        {
            ...
            m_conn.InsertBYSQLBC("Get_FLUXWMS_SHOP_D_Outindent", dtList);
