...
/// 类名：FluxWMSSTOCK_ADJUSTWToDInterface
/// 类说明：库存差异调整数据回传DRP	WMS->DRP
/// 创建人：郭琦琦 
/// 创建日期：2015-03-25
/// 修改人：
/// 修改日期：
...
{
    public class FluxWMSSTOCK_ADJUSTWToDInterface : HZYLogicBase, ILogicGetData
    {
        #region 构造函数
        public FluxWMSSTOCK_ADJUSTWToDInterface()
        {
        ...
        private void Insert()
        {
            ...
            m_conn.InsertBYSQLBC("Get_FLUXWMS_STOCK_ADJUST", dtList);
