        ...
        public class Brand : HZYLogicBase, ILogicGetData
        {
            ...
            public DataSet GetData()
            {
                try
                {
                    ...
                    if (ds.Tables["list"].Columns.Contains("BR1_DIVI"))
                    {
                        strZT = ds.Tables["List"].Rows[0]["BR1_DIVI"].ToString();    //获取事业体GL/LX
                    }
                    else
                    {
                        strZT = "LX";    //2015-01-04  等集团版上线时  改成 抛出未获取事业体异常
                    }
            ...
            private void Get(string pstrQ, string strEVN)
            {
                string strSQL = @"
                                SELECT  BR1_ID ,
                                  ...
                                  WHERE  1=1 AND 
                                  BR1_Desp LIKE '%" + pstrQ + "%' OR SP1_Name LIKE '%" + pstrQ + "%'  Order by BR1_BrandCode AND BR1_DIVI='" + strEVN + "' " + m_hzyPageInfo.Where;
            ...
            /// 品牌信息查询(有分页)
            /// </summary>
            private void BrandInfoForPageList(string strEVN)
            {
                string strSQL = @"
                              SELECT  BR1_ID ,
                                        BR1_CONO ,
                                ...
                                WHERE  1=1 AND BR1_DIVI='" + strEVN + "' " + m_hzyPageInfo.Where;
            ...
            /// 品牌新增修改操作
            /// </summary>
            private void EDIT(string strEVN)
            {
                ...
                if (strBR1_BrandCode == "系统自动生成")
                {
                    ...
                    //判断品牌简称或者全称存在就不给修改
                int nCount = m_conn.GetDataTableRowCount("SELECT * FROM [B01_MDM].[BR1_Brand] WHERE BR1_Name='" + strBR1_Name + "' AND BR1_DIVI='" + strEVN + "' or BR1_Desp ='" + strBR1_Desp + "'");
                    ...
                    ds.Tables["List"].Rows[0]["BR1_DIVI"] = strEVN;//帐套
