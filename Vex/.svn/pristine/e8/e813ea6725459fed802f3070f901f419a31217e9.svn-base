...
namespace HZY.COM.WS.GLWXSite
{
    public class CustomerOrder : HZYLogicBase, ILogicGetData
    {
        ...
        private Dbconn m_conn = new Dbconn("GLF22");//DLPOS
        ...
        private void AddCustomerOrder()
        {
            ...
            SendAM("AM", "DoubleLove", "郭琦琦", "信息部服务中心", contentAMdepotname, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));

            SendAM("AM", "DoubleLove", dt4.Rows[0]["CN_LOGIN"].ToString(), "信息部服务中心", contentAMdepotname, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
