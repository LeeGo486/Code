...
/// 类名：FluxWMSD_OutdepotWToDInterface
/// 类说明：次品返厂出库单发货导入接口DRP	WMS->DRP	
/// 创建人：郭琦琦 
/// 创建日期：2015-03-27
/// 修改人：
/// 修改日期：
...
{
    public class FluxWMSD_OutdepotWToDInterface : HZYLogicBase, ILogicGetData
    {
        #region 构造函数
        public FluxWMSD_OutdepotWToDInterface()
        {
        ...
        private void Insert()
        {
            ...
            m_conn.InsertBYSQLBC("Get_FLUXWMS_D_Outdepot", dtList);
