var m_columns = null;
var editIndex;
var m_ViewTableName = "V_L0013_FOR_Special_EDIT_DL";
...
function InitGird() {
    ...
    $dg.datagrid("hideColumn", "商务状态");
    $dg.datagrid("hideColumn", "店铺型态");
    ...
    col = $dg.datagrid('getColumnOption', '商务状态');
    col.editor = {
        type: 'combobox', options: { data: BusinessState, required: false, panelHeight: 'auto', editable: false, valueField: 'id', textField: 'text' }
    }
