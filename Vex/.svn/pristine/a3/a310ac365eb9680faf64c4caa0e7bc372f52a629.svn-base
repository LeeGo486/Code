...
public class Handler : IHttpHandler, IRequiresSessionState
{
    ...
    private HandlerCfg m_HzyCfg = new HandlerCfg("HZY_CMT", "HZY_CMT");
      
    public void ProcessRequest(HttpContext context)
    {
        //免登录设置，发布时需要删除
        //context.Session["SessionID"] = "1ba11598-5ee8-4c31-8079-7a9bcb520353"; //测试库
        //context.Session["UserName"] = "6988";
