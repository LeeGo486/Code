...
// 修改人：
// 修改日期：
// 修改内容：4003de2e-5005-4350-a6fe-45d998f13b56
...
function initGird(XMLData) {
    $('#mainTab_List').datagrid({
        url: GetWSRRURL('4003de2e-5005-4350-a6fe-45d998f13b56'),
        ...
        columns: [[
            ...
            { field: 'size1', title: '1', width: 25, align: 'right' },
            { field: 'size2', title: '2', width: 25, align: 'right' },
            { field: 'size3', title: '3', width: 25, align: 'right' },
            { field: 'size4', title: '4', width: 25, align: 'right' },
            { field: 'size5', title: '5', width: 25, align: 'right' },
            { field: 'size6', title: '6', width: 25, align: 'right' },
            { field: 'size7', title: '7', width: 25, align: 'right' },
            { field: 'size8', title: '8', width: 25, align: 'right' },
            { field: 'size9', title: '9', width: 25, align: 'right' },
            { field: 'sizef', title: 'F', width: 25, align: 'right' }
        ]],
...
function bgCreate() {
    $('#winNew_List').datagrid({
        ...
        columns: [[
            ...
            { field: 'size1', title: '1', width: 25, editor: 'numberbox' },
            { field: 'size2', title: '2', width: 25, editor: 'numberbox' },
            { field: 'size3', title: '3', width: 25, editor: 'numberbox' },
            { field: 'size4', title: '4', width: 25, editor: 'numberbox' },
            { field: 'size5', title: '5', width: 25, editor: 'numberbox' },
            { field: 'size6', title: '6', width: 25, editor: 'numberbox' },
            { field: 'size7', title: '7', width: 25, editor: 'numberbox' },
            { field: 'size8', title: '8', width: 25, editor: 'numberbox' },
            { field: 'size9', title: '9', width: 25, editor: 'text' },
            { field: 'sizef', title: 'F', width: 25, editor: 'text' },
...
function btnPrintSearch() {
    $('#fPrintSearch input[name!=txtRadio]').val("");
