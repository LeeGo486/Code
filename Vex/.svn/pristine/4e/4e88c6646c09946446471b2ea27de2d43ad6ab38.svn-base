...
namespace HZY.COM.WS.Hawk
{
    public class Supplier : HZYLogicBase, ILogicGetData
    {
        ...
        /// 供应商信息查询(无分页)
        /// </summary>
        private void Get(string pstrfilter, string strEVN)
        {
            ...
            string strSQL = @"
                            ...
                            WHERE  1=1 AND SP1_DIVI='" + strEVN + "' AND (SP1_Desp LIKE '%" + pstrfilter + "%' OR SP1_Name LIKE '%" + pstrfilter + "%') "+ m_hzyPageInfo.Where +" Order by SP1_SupplierCode ";  
        ...
        /// 供应商信息查询(有分页)
        /// </summary>
        private void SupplierInfoForPageList(string strDIVI)
        {
            string strSQL = @"
                            SELECT SP1_ID ,
                                SP1_CONO ,
                                ...
                                SP1_UptNo  
                        FROM [B01_MDM].[SP1_Supplier]
                        WHERE  1=1 AND SP1_DIVI='" + strDIVI + "' AND SP1_State<>'99' " + m_hzyPageInfo.Where;
        ...
        /// 供应商新增修改操作
        /// </summary>
        private void EDIT(string strDIVI)
        {
            ...
            int nCountYN = m_conn.GetDataTableRowCount("SELECT * FROM [B01_MDM].[SP1_Supplier] WHERE SP1_SupplierCode='" + strSP1_SupplierCode + "' AND SP1_DIVI='" + strDIVI + "'");
            ...
            if (nCountYN == 0)
            {
                ...
                //判断供应商简称或者全称存在就不给修改
                int nCount = m_conn.GetDataTableRowCount("SELECT * FROM [B01_MDM].[SP1_Supplier] WHERE sp1_name='" + strSp1_Name + "' or SP1_Desp ='" + strSp1_Desp + "' AND SP1_DIVI='" + strDIVI + "'");
                ...
                ds.Tables["list"].Rows[0]["SP1_DIVI"] = strDIVI;
            ...
            else
            {
                ...
                ds.Tables["List"].Rows[0]["SP1_LmDt"] = timeNow;
                ds.Tables["List"].Rows[0]["SP1_LmUser"] = hzyMessage.User_Name_CN;
                bResult = m_conn.Update("[B01_MDM].[SP1_Supplier]", ds.Tables["list"], "sp1_suppliercode='" + strSP1_SupplierCode + "' AND SP1_DIVI='" + strDIVI + "'");
            }
