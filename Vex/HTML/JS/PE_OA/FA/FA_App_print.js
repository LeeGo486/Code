...
function setValues() { 
    ...
    if (basedata_getUrlParam("v1") != undefined  && basedata_getUrlParam("v1") != '') {
         m_Type = basedata_getUrlParam("v1"); 
    }
            ...
            if (data && data.rows) {
                ...
                for (var i = 0; i < cdata.length; i++) {
                    if (i < 10) {
                        ...
                        $('#spantd' + i + '6').text(dataUtil_formatNum1(cdata[i].number));
  ...
  */
  ...
  //预算外打印提醒
  if (billInfo.fa1_budgettype == '1' && m_Type != 'query') {
      alert('预算外固定资产报销需附有“审批人”签字的纸质单！');
  }
