...
// 修改人：
// 修改日期：
// 修改内容：6539426e-4509-40a1-add8-3fc6b1712aa3
...
function initGird(XMLData) {
    $('#mainTab_List').datagrid({
        url: GetWSRRURL('6539426e-4509-40a1-add8-3fc6b1712aa3'),
        ...
        onExpandRow: function (index, row) {
            ...
            XMLData = GetFormJson(data, 'GetOnExpandRow');
            ddv.datagrid({
                url: GetWSRRURL('6539426e-4509-40a1-add8-3fc6b1712aa3'),
                queryParams: { "XML": XMLData },
                fitColumns: true,
...
function btnWinSearch(psytleCode) {
    ...
    $.post(GetWSRRURL('6539426e-4509-40a1-add8-3fc6b1712aa3') + "&XML=" + XMLData + "&MultiTable=true", function (data) {
        ...
        for (i = 0; i < sizeNum; i++) {
            if (i < sizeNum - 1)
                sizeCol += "{ field: 'size" + size.rows[i].st3_size + "', title: '" + size.rows[i].st3_size + "', width: 30, editor: 'numberbox' },";
