...
$(document).ready(function () {
    ...
    //获取事业体
    zt = $.cookie("compName");
    m_data[m_data.length] = { "name": "txtCT1_DIVI", "value": zt };
...
function search() {
    ...
    var XMLData = "<ROOT><OPTYPE>Search</OPTYPE><LIST><ROWS><Group>" + sizeGroup + "</Group><Size>" + size + "</Size><ov>" + ov + "</ov><CT1_DIVI>" + zt + "</CT1_DIVI></ROWS></LIST></ROOT>";
...
function editSize() {
    ...
    var XMLData = "<ROOT><OPTYPE>sizeList</OPTYPE><LIST><ROWS><CT1_DIVI>" + zt + "</CT1_DIVI><fatherid>" + data.groupid + "</fatherid></ROWS></LIST></ROOT>";
...
function saveSize(type) {
    ...
    if (type == "new") {
        for (i = 0; i < sizeData.length; i++) {
            ...
            XMLData += "<CT1_ID></CT1_ID><CT1_CONO>HYFG</CT1_CONO><CT1_Code>SIDE</CT1_Code><CT1_CodeName>尺码</CT1_CodeName>";
...
function saveGroup(type) {
    ...
    if (type == "new") {
        XMLData += "<LIST><ROWS><CT1_ID>" + $CT1_ID + "</CT1_ID><CT1_CONO>HYFG</CT1_CONO>";
        XMLData += "<CT1_DIVI>" + zt + "</CT1_DIVI>";
