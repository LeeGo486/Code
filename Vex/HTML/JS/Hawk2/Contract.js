...
ac31b57a-a197-4e08-8d4e-433b006af792
*/
...
$(document).ready(function () {
    ...
    $('#cmbPC1_PaymentType').combobox({
        required: true,
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&XML=" + GetFormJson([], 'GET') + "&Where=CT1_Code='" + "TEPY" + "'",
        type: 'post',
        editable: false,
        valueField: 'id',
        textField: 'text',
    ...
    $('#cmbPC1_Currency').combobox({
        required: true,
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&XML=" + GetFormJson([], 'GET') + "&Where=CT1_Code='" + "CUCD" + "'",
        type: 'post',
        editable: false,
        valueField: 'id',
        textField: 'text',
    ...
    $('#cmbPC1_PaymentChannel').combobox({
        required: true,
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&XML=" + GetFormJson([], 'Get') + "&Where=CT1_Code='" + "PYTP" + "'",
        type: 'post',
        editable: false,
        valueField: 'id',
        textField: 'text',
    ...
    $("#txtPC1_POTypeCode").combobox({
        required: true,
        url: GetComboxWSRRURL('597aac46-2fc7-43e7-81a6-cddf9ba869b8', "", "CT1_OptionsValues", "CT1_Options") + "&XML=" + GetFormJson([], 'Get') + "&Where=CT1_Code='" + "ITCL" + "'",
        type: 'post',
        editable: false,
        valueField: 'id',
        textField: 'text',
...
function contractWindow(type) {
    ...
    if (type == 'new') {
        ...
        $("#cmbPC1_PaymentType").combobox('enable');
        $("#cmbPC1_Currency").combobox('enable');
        $("#cmbPC1_PaymentChannel").combobox('enable');
        ...
        if (selected_Row != null) {
            if (checkStatus("1")) {
                ...
                $('#txtPC1_ContractComment').val(selected_Row.pc1_contractcomment)
                .attr("disabled", false);
    ...
    if ($('#formWindow').form('validate')) {
        if (checkDate("Contract")) {
            ...
            if (contractCode == "系统生成") {
                ...
                data[data.length] = { "name": "txtpc1_DIVI", "value": "LX" };
