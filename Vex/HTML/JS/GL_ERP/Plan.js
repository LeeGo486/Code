...
修改人：刘洪
修改日期：2014-06-11
修改内容：bb01d783-d921-4fa9-8c91-0e5a8a5b6522
...
$(document).ready(function () {
    ...
    //初始化主界面数据
    mainGird(GetWSRRURL('bb01d783-d921-4fa9-8c91-0e5a8a5b6522'), GetGetJson([], 'GetCOHead'));
});
...
function client() {
    GVARIABLE.cmb.data = $.ajax({
        url: GetComboxALLColumnWSRRURL('bb01d783-d921-4fa9-8c91-0e5a8a5b6522') + "&pagerows=20000&XML=" + GetFormJson([], 'cmbGetCUS'),
        type: 'post',
        async: false//同步,
    });
...
function btnPlanDetail() {
    ...
    $('#detailData').datagrid({
        url: GetWSRRURL('bb01d783-d921-4fa9-8c91-0e5a8a5b6522'),
        queryParams: { "XML": XMLData },
        singleSelect: true,
        async: false, //同步,
        sortName: 'coseq',
...
function btnMainSearch() {
    ...
    if (data[0].value == "" && data[1].value == "" && data[2].value == "" && data[3].value == "") {
        ...
        mainGird(GetWSRRURL('bb01d783-d921-4fa9-8c91-0e5a8a5b6522'), XMLData);
    }
...
function btnSearch() {
    ...
    initGird(GetWSRRURL('bb01d783-d921-4fa9-8c91-0e5a8a5b6522'), XMLData);
}
