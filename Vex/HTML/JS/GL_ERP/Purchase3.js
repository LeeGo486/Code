...
$(function () {
    ...
    var url = GetWSRRURL('23b49572-cb68-4799-b5ab-fcc6a5feb0cc') + "&XML=" + GetFormJson("", 'GET');
...
function Type(type) {
    ...
    if (type == "Add") {
        var url1 = GetWSRRURL('23b49572-cb68-4799-b5ab-fcc6a5feb0cc') + "&XML=" + GetFormJson("", 'GETAPOList') + "&WHERE=" + "1!=1";
    }
    else if (type == "Edit") {
        var mAP1_PO1_PurchaseCode = $('#formAddEdit #txtpo1_pocode').val()
        var url1 = GetWSRRURL('23b49572-cb68-4799-b5ab-fcc6a5feb0cc') + "&XML=" + GetFormJson("", 'GETAPOList') + "&WHERE=" + " AP1_PO1_PurchaseCode = '" + mAP1_PO1_PurchaseCode + "'";
    }
