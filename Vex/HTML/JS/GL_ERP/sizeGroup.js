...
/// 创建人：刘洪
/// 创建日期：2014-11-08
/// WSID:69815f4f-1e7e-4dfb-ba33-709213405ee4
...
function initDg(xml) {
    $('#tab_list').datagrid({
        url: GetWSRRURL('69815f4f-1e7e-4dfb-ba33-709213405ee4'),
        queryParams: { "XML": xml },
        //title: '尺码列表',
        width: '70%',
        heigth: '100%',
...
function editSize() {
    ...
    sizedg(GetWSRRURL('69815f4f-1e7e-4dfb-ba33-709213405ee4'), { "XML": XMLData });
...
function saveSize(type) {
    ...
    if (type == "new") {
        for (i = 0; i < sizeData.length; i++) {
            ...
            XMLData += "<CT1_ID></CT1_ID><CT1_CONO>GL</CT1_CONO><CT1_DIVI>D01</CT1_DIVI><CT1_Code>SIDE</CT1_Code><CT1_CodeName>尺码</CT1_CodeName>";
...
function saveGroup(type) {
    ...
    if (type == "new") {
        XMLData += "<LIST><ROWS><CT1_ID>" + $CT1_ID + "</CT1_ID><CT1_CONO>GL</CT1_CONO><CT1_DIVI>D01</CT1_DIVI>";
...
//提交
function submit(xml) {
    var url = GetWSRRURL('69815f4f-1e7e-4dfb-ba33-709213405ee4');
