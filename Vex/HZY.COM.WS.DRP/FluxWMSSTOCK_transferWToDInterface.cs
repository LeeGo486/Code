...
/// 类名：FluxWMSSTOCK_transferWToDInterface
/// 类说明：库存转移回传DRP	WMS->DRP
/// 创建人：郭琦琦 
/// 创建日期：2015-03-25
/// 修改人：
/// 修改日期：
...
{
    public class FluxWMSSTOCK_transferWToDInterface : HZYLogicBase, ILogicGetData
    {
        #region 构造函数
        public FluxWMSSTOCK_transferWToDInterface()
        {
        ...
        private void Insert()
        {
            ...
            m_conn.InsertBYSQLBC("Get_FLUXWMS_STOCK_transfer", dtList);
