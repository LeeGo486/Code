...
/// 类名：FluxWMSD_IndepotWToDInterface
/// 类说明：成品入库单收货回传接口DRP	WMS->DRP	
/// 创建人：郭琦琦 
/// 创建日期：2015-03-27
/// 修改人：
/// 修改日期：
...
{
    public class FluxWMSD_IndepotWToDInterface : HZYLogicBase, ILogicGetData
    {
        #region 构造函数
        public FluxWMSD_IndepotWToDInterface()
        {
        ...
        private void Insert()
        {
            ...
            m_conn.InsertBYSQLBC("Get_FLUXWMS_D_Indepot", dtList);
