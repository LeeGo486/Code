...
/// 类名：FluxWMSORDER_OUTDEPOTWToDInterface
/// 类说明：电商退货入库单收货回传接口	WMS->DRP	
/// 创建人：郭琦琦 
/// 创建日期：2015-04-01
/// 修改人：
/// 修改日期：
...
{
    public class FluxWMSORDER_OUTDEPOTWToDInterface : HZYLogicBase, ILogicGetData
    {
        #region 构造函数
        public FluxWMSORDER_OUTDEPOTWToDInterface()
        {
        ...
        private void Insert()
        {
            ...
            m_conn.InsertBYSQLBC("Get_FLUXWMSORDER_OUTDEPOT", dtList);
