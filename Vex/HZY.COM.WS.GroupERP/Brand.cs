    ...
    public class Brand : HZYLogicBase, ILogicGetData
    {
        ...
        private void Get(string pstrQ)
        {
            string strSQL = @"
                                SELECT  BR1_ID ,
                                  ...
                                  WHERE  1=1 AND 
                                  BR1_Desp LIKE '%" + pstrQ + "%' OR SP1_Name LIKE '%" + pstrQ + "%'  Order by BR1_BrandCode AND BR1_DIVI='" + m_hzyMessage.Env_SN + "' " + m_hzyPageInfo.Where;
        ...
        private void BrandInfoForPageList()
        {
            string strSQL = @"
                              SELECT  BR1_ID ,
                                ...
                                WHERE  1=1 AND BR1_DIVI='" + m_hzyMessage.Env_SN + "' " + m_hzyPageInfo.Where;
        ...
        private void EDIT()
        {
            ...
            if (strBR1_BrandCode == "系统自动生成")
            {
                ...
                //判断品牌简称或者全称存在就不给修改
                int nCount = m_conn.GetDataTableRowCount("SELECT * FROM [B01_MDM].[BR1_Brand] WHERE BR1_Name='" + strBR1_Name + "' AND BR1_DIVI='" + m_hzyMessage.Env_SN + "' AND BR1_Desp ='" + strBR1_Desp + "'");
                ...
                if (ds.Tables["list"].Columns.Contains("BR1_DIVI") == false)
                {
                    ds.Tables["list"].Columns.Add("BR1_DIVI");  //2015-01-05 等集团版上线时 删掉此if
                }
                ...
                ds.Tables["List"].Rows[0]["BR1_DIVI"] = m_hzyMessage.Env_SN;//帐套
                ds.Tables["List"].Rows[0]["BR1_CONO"] = "HYFG";
                ds.Tables["List"].Rows[0]["BR1_RgDt"] = timeNow;
                ds.Tables["List"].Rows[0]["BR1_RgUser"] = hzyMessage.User_Name;
                ds.Tables["List"].Rows[0]["BR1_LmDt"] = timeNow;
                ds.Tables["List"].Rows[0]["BR1_LmUser"] = hzyMessage.User_Name;
            ...
            else
            {
                ...
                ds.Tables["list"].Columns.Remove("br1_name");
                ds.Tables["list"].Columns.Remove("br1_desp");
                ds.Tables["list"].Columns.Add("BR1_LmDt");
                ds.Tables["list"].Columns.Add("BR1_LmUser");
                ds.Tables["List"].Rows[0]["BR1_LmDt"] = timeNow;
                ds.Tables["List"].Rows[0]["BR1_LmUser"] = hzyMessage.User_Name;
                string strWhere = "BR1_BrandCode='" + ds.Tables["list"].Rows[0]["br1_brandcode"].ToString() + "' AND BR1_DIVI='" + ds.Tables["list"].Rows[0]["BR1_DIVI"].ToString() + "'";
                //ArrayList alist = new ArrayList();
                //alist.Add("BR1_BrandCode");
                //alist.Add("BR1_DIVI");
                bResult = m_conn.Update("[B01_MDM].[BR1_Brand]", ds.Tables["list"], strWhere);
            }
