...
{
    public class DRP_ShopTargetMaintain_EditByXML : LogicBase, ILogicGetData
    {
        public DRP_ShopTargetMaintain_EditByXML()
        {
              ...
              //  OracleDataAdapter oda = new OracleDataAdapter("select * from dim_shop", conn);
                ...
                //读取ROWS到/ROWS 中的参数
                {
                  ...
                  //  strSQL = @" Select * from 
                   //             dim_shop    
                    //             ";
                    strSQL = @" Select dim_shop.COSTCENTER,
                                      Dim_Shop.Shopname,
                                      dim_saleplan.YEARs||'-'||dim_saleplan.MONTHs AS YEARS,
                                      dim_saleplan.SALEPLAN    
                                      From Dim_Shop,Dim_Saleplan
                                      where dim_shop.shopid=dim_saleplan.shopid 
                                 " + strWHERE;
                   ...
                   // return ds; 
                 //   ds_Return = conn. new SqlDataAdapter(sql, conn);
                }
                return ds_Return; 
