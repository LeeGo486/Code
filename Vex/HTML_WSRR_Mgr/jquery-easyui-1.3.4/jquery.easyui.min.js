...
(function ($) {
    function _6f(_70) {
        ...
        //马卫清 2014-03-25添加   easyui的linkbutton自定义开发功能改进--支持加载时默认隐藏  
        //初始化方法：option{hidden:true}
        if (_71.hidden) {
            t.hide();
        }
        //马卫清 2014-03-25添加   easyui的linkbutton自定义开发功能改进--支持加载时默认隐藏
...
(function ($) {
    function _80(_81) {
        ...
        //马卫清 添加 增加EXCEL导出的功能 2014-05-08
        if (_83.exportExcel) {
            $("<td><div class=\"pagination-btn-separator\"></div><a id='parginationExcelExportDiv'></a></td>").appendTo(tr);

            bb.exportExcel = _85("exportExcel");
            //_83.maxCountForTooltip = 1000;

            //if (_83.total > _83.maxCountForTooltip) {
            //    bb.exportExcel.tooltip({
            //        showEvent: 'click',
            //        content: function () {
            //            return _83.total;
            //        }
            ...
            //$(this).pagination().find("a.l-btn").each(function () {
            //    if ($(this).find('span.icon-excel').length > 0) {
            //        $(this).tooltip({
            //            content: function () {
            //                return "pagepagepagepagepage";
            //            }
            //        });
            //        //$(this).click();
            //    }
    ...
    $.fn.pagination.defaults = {
        ...
        total: 1, pageSize: 10, pageNumber: 1, pageList: [10, 20, 30, 50], loading: false, buttons: null, showPageList: true, showRefresh: true, exportExcel: true, onSelectPage: function (_9f, _a0) {
            //马卫清 添加 增加EXCEL导出的功能 2014-05-08

        }, onBeforeRefresh: function (_a1, _a2) {
        }, onRefresh: function (_a3, _a4) {
        }, onChangePageSize: function (_a5) {
        }, beforePageText: "第 ", afterPageText: " 页，共 {pages} 页", displayMsg: "当前第 {from} 到 {to} 行，共 {total} 行", nav: {
            first: {
            ...
            , exportExcel: {
                iconCls: "icon-excel", handler: function () {
                    var _ac = $(this).pagination("options");
                    if (_ac.total > _ac.maxCountForTooltip) {
                    }
                    else {
                        EasyUI_DataGrid_ExcelExport(_ac.mwqExcelTestDG, $(this));
                    }
                }
            }
            //马卫清 添加 增加EXCEL导出的功能 2014-05-08
...
(function ($) {
    ...
    function _233(_234) {
        ...
        //马卫清 将高度变高 20140918
        _235.window.find("div.panel-title").addClass("messager-title");
        //马卫清 将高度变高 20140918
...
(function ($) {
    ...
    function _264(_265, _266, _267) {
        ...
        win.window({
            title: _265, noheader: (_265 ? false : true), width: 320, height: "auto", modal: true, collapsible: false, minimizable: false, maximizable: false, resizable: false, onClose: function () {
                setTimeout(function () {
                    win.window("destroy");
                }, 100);
            }
        ...
        //马卫清 修改 20140918 将高度变高
        win.window("window").addClass("messager-window").find("div.panel-title").addClass("messager-title");
        win.window("window").addClass("messager-window");

        //马卫清 修改 20140918 将高度变高
        //win.window("window").find("div .panel-title").addClass("messager-title");

        win.children("div.messager-button").children("a:first").focus();

        //马卫清 修改 20140923 在提示框中，按空格等于按回车
        win.children("div.messager-button").children("a:first").keydown(function (event) {
    ...
    $.messager = {
        show: function (_269) {
            ...
            return win;
        }, confirm: function (_26d, msg, fn, defaultButton) {
            ...
            //马卫清 2013-10-26添加   easyui的datagrid自定义开发功能改进--支持列标题直接查询  
            if (!defaultButton || defaultButton == "Cancel") {
                win.children("div.messager-button").children("a:last").focus();

            }
            //马卫清 2013-10-26结束添加   easyui的datagrid自定义开发功能改进--确认框默认设置为取消  
...
(function ($) {
    ...
    $.fn.validatebox.defaults = {
        required: false, validType: null, delay: 200, missingMessage: "必填项.", invalidMessage: null, tipPosition: "right", deltaX: 0, novalidate: false, tipOptions: {
...
(function ($) {
    ...
    $.fn.calendar.defaults = {
        width: 180, height: 180, fit: false, border: true, firstDay: 0, weeks: ["日", "一", "二", "三", "四", "五", "六"], months: ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"], year: new Date().getFullYear(), month: new Date().getMonth() + 1, current: new Date(), onSelect: function (date) {
        }
    };
})(jQuery);
(function ($) {
...
(function ($) {
                ...
                for (var j = 0; j < cols.length; j++) {
                    ...
                    if (col.checkbox) {
                        ...
                        if (col.field) {
                            ...
                            //马卫清 将DataGrid的标题修改成为居中 2014-05-07

                            //修改前
                            cell.css("text-align", (col.halign || col.align || ""));

                            //cell.css("text-align", (col.halign || "center"));
                            //结束 马卫清 将DataGrid的标题修改成为居中 2014-05-07
    ...
    function _500(_501) {
        ...
        _505.unbind(".datagrid").bind("click.datagrid", function (e) {
            ...
            if (e.pageX < p2 && e.pageX > p1) {
                ...
                //马卫清 2012-12-21添加   easyui的datagrid自定义开发功能改进--支持列标题直接查询 

                if ((!col.sortable && !col.search) || _502.resizing) {
                    return;
                }

                var td2 = $(this);
                if ($("input", td2).length > 0) {
                    return;
                }

                if (!e.ctrlKey && col.sortable) {
                    var _508 = [];
                    var _509 = [];
                    if (opts.sortName) {
                ...
                else if (e.ctrlKey && col.search) {
                    td2.attr("grid", opts.id);
                    td2.attr("field", col.field);
                    if (col.searchfield) {
                        td2.attr("field", col.searchfield);
                    }
                    td2.attr("title", col.title);
                    _99_1_1(this)
                }
            ...
            if (cond) {
                ...
                //马卫清 2012-12-21添加   easyui的datagrid自定义开发功能改进--支持列标题直接查询 
                if (!col.search || col.resizable == false) {
                    return;
                }
                var td2 = $(this);
                td2.attr("grid", opts.id);
                ...
                //                    return;
                //                }
                //马卫清 2012-12-21添加结束   easyui的datagrid自定义开发功能改进--支持列标题直接查询 
    ...
    function _544(_545, data) {
        ...
        if (_54a.length) {
            ...
            if (_54b.total != data.total) {
                ...
                //马卫清 添加 增加EXCEL导出的功能 2014-05-08
                _54b.maxCountForTooltip = 1000;

                if (_54b.total > _54b.maxCountForTooltip) {

                    _54a.pagination().find("a.l-btn").each(function () {
                        if ($(this).find('span.icon-excel').length > 0) {

                            var str = '<div style="height:90px;width:230px;padding:10px;text-align:center;overflow:hidden;border:none">本次导出的数据共有' + _54b.total + '行数据，</br>所花时间可能会比较久。确认导出吗？<p><p>';
                            str += '<a href="#" id="btnDataGridExcelExportTooltip" iconcls="icon-ok" data-options="plain:true" class="easyui-linkbutton">确认</a>';
                            str += '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" id="btnDataGridExcelExportTooltipCancel" iconcls="icon-undo" data-options="plain:true" class="easyui-linkbutton">取消</a></div>';
                            $(this).tooltip({
                                content: $('<div></div>'),
                                position: "top",
                                showEvent: 'click',
                                onUpdate: function (content) {
                                    ...
                                    $(content.find("a")[0]).unbind("click").bind("click", function () {
                                        EasyUI_DataGrid_ExcelExport(_54b.mwqExcelTestDG, _54a);
                                    });

                                    $(content.find("a")[1]).unbind("click").bind("click", function () {
                                        t.tooltip('hide');
                                    });
                                },
                                onShow: function () {
                            ...
                            //EasyUI_DataGrid_ExcelExport(_ac.mwqExcelTestDG);
                        }
                    });
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "正在处理中，请稍等 ...", rownumbers: false, singleSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollbarSize: 18, rowStyler: function (_695, _696) {
            ...
            //edit by juge 2013-09-11 马卫清 maweiqing mwq
            $.ajax({
                type: opts.method, url: opts.url, data: _697, dataType: "json", success: function (data) {
                    try {
                        _698(data);
                    } catch (ex) { if (data) $.messager.alert("出错了", data.Error, 'error'); }
                }, error: function () {
