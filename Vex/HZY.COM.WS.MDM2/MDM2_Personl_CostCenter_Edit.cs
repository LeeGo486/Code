...
/// 类名：MDM2_Personl_CostCenter_Edit
/// 类说明：编辑人和成本中心信息
/// 创建人：郭琦琦 
/// 创建日期：2014-08-26
/// 修改人：
...
namespace HZY.COM.WS.MDM2
{
    ...
    /// 编辑人和成本中心信息
    /// </summary>
    public class MDM2_Personl_CostCenter_Edit : LogicBase, ILogicGetData
    {
        public MDM2_Personl_CostCenter_Edit()
        {
        ...
        public DataSet GetData()
        {
            ...
            try
            {
                ...
                string strMDM_Class = "0023";

                conn.LockTableList.Add("MDM_0023_B");
                conn.LockTableList.Add("MDM_0023_E");
