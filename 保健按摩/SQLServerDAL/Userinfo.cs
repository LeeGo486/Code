...
namespace EPReper.SQLServerDAL
{
    ...
    public partial class Userinfo : IUserinfo
    {
        ...
        public DataTable GetInfo(string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ");
            strSql.Append("TN_SYS_EM_USER.CN_ID,TN_SYS_EM_USER.CN_LOGIN,TN_SYS_EM_USER.CN_NOTE,TN_SYS_EM_USER_PROP.CN_DEPTINFO,TN_SYS_EM_USER_PROP.CN_HANDSET,TN_SYS_EM_USER_PROP.CN_O_PHONE ");
