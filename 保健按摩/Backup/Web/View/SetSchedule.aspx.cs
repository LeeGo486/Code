...
namespace Web.View
{
    public partial class SetSchedule : System.Web.UI.Page
    {
        ...
        {
            this.Label1.Text = getWeekUpOfDate(DateTime.Now, DayOfWeek.Tuesday, 0).ToShortDateString();
           // this.Label2.Text = getWeekUpOfDate(DateTime.Now, DayOfWeek.Tuesday, 0).ToShortDateString();
            this.Label3.Text = getWeekUpOfDate(DateTime.Now, DayOfWeek.Thursday, 0).ToShortDateString();
           // this.Label4.Text = getWeekUpOfDate(DateTime.Now, DayOfWeek.Thursday, 0).ToShortDateString();
            this.Label5.Text = getWeekUpOfDate(DateTime.Now, DayOfWeek.Saturday, 0).ToShortDateString();
