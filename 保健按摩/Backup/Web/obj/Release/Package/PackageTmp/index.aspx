...
<body>
    <center>
        ...
        <div class="header">
            <div class="menu">
                <div class="nav">
                    <a href="index.aspx" title="首页" class="on">首&nbsp; 页</a><a href="../manager/ReperInfo/ReperInfo.aspx"
                        style="margin-left: 10px" title="我要报修">报&nbsp; 修</a><a href="../manager/ReperInfo/ReperInfo.aspx?type=select"
                            style="margin-left: 10px" title="我要查询">查&nbsp; 询</a><span id="admins" runat="server"
                                visible="false"><a href="../manager/ReperClass/ReperClass_List.aspx" style="margin-left: 10px"
                                    title="我是管理员">管理员</a></span>
                </div>
            </div>
        </div>
        <table class="table" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
                    ...
                    <table width="100%">
                        <tr>
                            <td align="left" width="40%">
                                <font style="font-size: 20px; font-family: 黑体;">我已报修的任务</font>
                            </td>
                            <td width="40%">
            ...
            <tr>
                <td align="left">
                    <asp:Button ID="Button1" runat="server" Text="我要报修" Font-Size="14px" OnClick="bx"
                        Style="width: 100px; height: 40px; font-family: 黑体;" class="btn5_mouseout" onmouseover="this.className='btn5_mouseover'"
                        onmouseout="this.className='btn5_mouseout'" onmousedown="this.className='btn5_mousedown'"
                        onmouseup="this.className='btn5_mouseup'" title="我要报修" />
                </td>
            </tr>
            <tr>
                <td>
                    <div id="repairInfo" runat="server" visible="false">
                        <table width="100%">
                            <tr>
                                <td align="left" width="40%">
                                    <font style="font-size: 20px; font-family: 黑体;">我负责维修的任务</font>
                                </td>
                                <td width="50%">
