                ...
                <div class="nav">
                    <a href="../../index.aspx" title="首页">首 页</a><a href="../ReperInfo/ReperInfo.aspx" style="margin-left:10px"
                        title="我要报修">报 修</a><a href="../ReperInfo/ReperInfo.aspx?type=select" style="margin-left:10px" title="我要查询">查
                            询</a><a href="../ReperClass/ReperClass_List.aspx" title="我是管理员" style="margin-left:10px" class="on">管理员</a>
                </div>
            </div>
        </div>
...
onmousedown="this.className='btn3_mousedown'"
  ...
  title="报修" />--%>
                    ...
                    <table border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF" style="background: #F8FDFF"
                        ...
                        <tr class="TR_BG_list">
                            <td colspan="2">
                                <asp:Button ID="Save" runat="server" Width="100px" Height="40px" Font-Size="14px" Text="保   存" OnClick="Save_Click" class="btn3_mouseout"
                                    onmouseover="this.className='btn3_mouseover'" onmouseout="this.className='btn3_mouseout'"
                                    onmousedown="this.className='btn3_mousedown'" onmouseup="this.className='btn3_mouseup'"
                                    title="保存" OnClientClick="picadds()" />
                            </td>
                        </tr>
                    </table>
                </td>
