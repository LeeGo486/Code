...
{
    public partial class SafeSugList : System.Web.UI.Page
    {
        ...
        private void InfoBind()
        {
            ...
            {
                condition = condition + " sugcontent like '%" + this.TextBoxSearch.Text.Trim().ToString() + "%'";
            }
        ...
        protected void btnDelete_Clik(object sender, CommandEventArgs e)
        {
            ...
            CommonDao<SafeSuggestion> newmgr = new CommonDao<SafeSuggestion>();
            SafeSuggestion sf = newmgr.FindById(fid);
