<%@ Page Title="" Language="C#" MasterPageFile="~/EPSafe/EPSafe.Master" AutoEventWireup="true"
    CodeBehind="SafeRewRes.aspx.cs" Inherits="EPReper.Web.EPSafe.SafeRewRes" %>
        ...
        <div style="float: left; width: 840px;">
            <div style="width: 240px; padding-left: 5px;">
                <div class="NewsTab3" style="width: 808px;" id="lableType" runat="server">
                    <span style="color: #0087ce;">安全奖惩排名</span>
                </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <div style="border: 1px solid #C0C0C0; padding: 5px; width: 822px; margin: auto;
                                float: left;">
                                <div id="NewsC">
                                    <asp:Repeater ID="RepeaterRewRes" runat="server">
                                        <HeaderTemplate>
                                            <table class="Tmain1">
                                                <tr>
                                                    <th style="width: 50px;">
                                        ...
                                        <FooterTemplate>
                                            ...
                                            <asp:Label ID="lblEmpty" Text="无记录..." runat="server" Visible='<%# RepeaterRewRes.Items.Count==0 %>'></asp:Label>
                                        </FooterTemplate>
                                    </asp:Repeater>
                                </div>
