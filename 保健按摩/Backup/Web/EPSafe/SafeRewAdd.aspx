<%@ Page Title="" Language="C#" MasterPageFile="~/EPSafe/EPSafe.Master" AutoEventWireup="true" CodeBehind="SafeRewAdd.aspx.cs" Inherits="EPReper.Web.EPSafe.SafeRewAdd" %>
                            ...
                            <tr>
                               <td style="width: 810px;">
                                    <div id="newstype" runat="server" style="width: 810px; text-align: right; float: right;">
                                        <a href="RewAdd.aspx" title="添加安全奖励" style="font-size:larger"><strong>添加安全奖励 </strong> </a>
                                    </div>
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <asp:Repeater ID="RepeaterPubGG" runat="server">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <%--    <td style="width: 50px;">
                                                ...
                                                <td>
                                                    <%# Eval("Rewards").ToString() %>
                                                </td>
                                             <%--   <td>
                                                    <%# Eval("Totals").ToString() %>
                                                </td>--%>
                                                <td>
                                                    ...
                                                    &nbsp; &nbsp; &nbsp; <a href="RewAdd.aspx?fid=<%# Eval("fid").ToString() %>">修改 </a>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <FooterTemplate>
