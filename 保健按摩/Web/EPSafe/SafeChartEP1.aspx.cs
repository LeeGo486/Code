...
{
    public partial class SafeChartEP1 : System.Web.UI.Page
    {
        ...
        private void GetFirstChart()
        {
            ...
            this.Chart2.Series[0].PostBackValue = "#AXISLABEL";
            this.Chart2.Series[0].ToolTip = "单击查看全部隐患";

            this.Chart2.Series[1].PostBackValue = "999" + "#AXISLABEL";
            this.Chart2.Series[1].ToolTip = "单击查看已处理隐患";
