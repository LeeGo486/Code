...
{
    public partial class SafeResAdd : System.Web.UI.Page
    {
        ...
        private void InfoBind()
        {
            ...
            {
                condition = condition + " PitContents like '%" + this.TextBoxSearch.Text.Trim().ToString() + "%'";
            }
        ...
        protected void btnDelete_Clik(object sender, CommandEventArgs e)
        {
            ...
            CommonDao<SafePitFalls> newmgr = new CommonDao<SafePitFalls>();
            SafePitFalls sf = newmgr.FindById(fid);
