<%@ Page Title="" Language="C#" MasterPageFile="~/EPSafe/EPSafe.Master" AutoEventWireup="true" CodeBehind="SafeAdmin.aspx.cs" Inherits="EPReper.Web.EPSafe.SafeAdmin" %>
                            ...
                            <tr>
                                <td style="width: 810px;">
                                    <div id="newstype" runat="server" style="width: 810px; text-align: right; float: right;">
                                        <a href="NewsAdd.aspx?Infotype=安全新闻&type=安全新闻" title="添加新闻" style="font-size:larger"><strong>添加安全新闻</strong></a>
                                    </div>
                                </td>
                            </tr>
                        </table>
                                        ...
                                        <ItemTemplate>
                                            <tr id="<%# Eval("fid").ToString() %>" ondblclick="openmessage('<%# Eval("fid").ToString()%>')">
                                                ...
                                                <td>
                                                    ...
                                                    &nbsp; &nbsp; &nbsp;
                                                    <a href="NewsAdd.aspx?fid=<%# Eval("fid").ToString() %>" title="<%# Eval("newstitle").ToString() %>" >
                                                      修改
                                                    </a>
                                                </td>
                                            </tr>
