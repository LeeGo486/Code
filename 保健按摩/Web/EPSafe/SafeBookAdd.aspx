<%@ Page Title="安全书籍推荐" Language="C#" MasterPageFile="~/EPSafe/EPSafe.Master" AutoEventWireup="true" CodeBehind="SafeBookAdd.aspx.cs" Inherits="EPReper.Web.EPSafe.SafeBookAdd" %>
                            ...
                            <tr>
                              <td style="width: 810px;">
                                    <div id="newstype" runat="server" style="width: 810px; text-align: right; float: right;">
                                        <a href="BookAdd.aspx" title="添加安全书籍" style="font-size:larger"><strong>添加安全书籍 </strong></a>
                                    </div>
                                </td>
                            </tr>
                        </table>
                                        ...
                                        <ItemTemplate>
                                            <tr id="<%# Eval("fid").ToString() %>" ondblclick="openmessage('<%# Eval("fid").ToString()%>')">
                                                <td style="width: 500px;">
                                                    <a href="BookDetails.aspx?fid=<%# Eval("fid").ToString() %>" title="<%# Eval("booktitle").ToString() %>"  target="_blank">
                                                        <%# Eval("booktitle").ToString().Length > 20 ? Eval("booktitle").ToString().Substring(0, 20) + "......" : Eval("booktitle")%>
                                                    </a>
                                                </td>
                                                <td>
