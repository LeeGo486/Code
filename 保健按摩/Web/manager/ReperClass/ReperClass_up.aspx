            ...
            <div class="menu">
                <div class="nav">
                    <a href="../../index.aspx" title="首页">首 页</a><a href="../ReperInfo/ReperInfo.aspx"
                        title="我要报修" style="margin-left: 10px" class="on">报 修</a><a href="../ReperInfo/ReperInfo.aspx?type=select"
                            style="margin-left: 10px" title="我要查询">查 询</a><span id="admins" runat="server" visible="true"><a
