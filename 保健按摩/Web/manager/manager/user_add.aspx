<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_add.aspx.cs" Inherits="EPReper.Web.manager.manager.user_add" %>
                    ...
                    <table border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF" style="background: #F8FDFF"
                        ...
                        <tr class="TR_BG_list">
                            ...
                            <td width="10%" align="left">
                                <hw:DropDownCheckList ID="username" runat="server" DataTextField="login" RepeatColumns="6"
                                    DisplayTextWidth="80" DropImageSrc="../../Images/expand.gif" TextWhenNoneChecked="--请选择--"
                                    DisplayTextList="Labels" ClientCodeLocation="../../Scripts/DropDownCheckList.js">
