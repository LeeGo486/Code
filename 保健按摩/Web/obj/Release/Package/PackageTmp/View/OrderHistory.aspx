<%@ Page Title="" Language="C#" MasterPageFile="~/View/Health.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="OrderHistory.aspx.cs" Inherits="EPReper.Web.View.OrderHistory" %>
        ...
        <div style="height: 70px;">
            ...
            <div style="height: 60px; float: right; width: 780px; margin: auto; background-image: url(../Images/heathtitle.png);">
                <div style="padding-left: 20px; float: left; height: 60px; line-height: 60px; overflow: hidden;">
                    <span style="color: #3366CC"><strong style="color: #787CC8">预约保健服务历史查询</strong></span>
                </div>
            </div>
        </div>
        <div>
            <div style="width: 160px; float: left; text-align: center;">
                <ul class="ulclass1">
                    ...
                    <li id="admins1" runat="server" visible="false" class="liselect"><a style="color: White;" href="OrderHistory.aspx">历史记录</a></li>
