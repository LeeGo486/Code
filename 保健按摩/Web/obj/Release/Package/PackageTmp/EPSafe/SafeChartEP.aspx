<%@ Page Title="" Language="C#" MasterPageFile="~/EPSafe/EPSafe.Master" AutoEventWireup="true" CodeBehind="SafeChartEP.aspx.cs" Inherits="EPReper.Web.EPSafe.SafeChartEP" %>
        ...
        <ContentTemplate>
            <div style="float: left; width: 960px;">
                ...
                <div style="margin: auto; float: left; width: 960px;">
                    <asp:Chart ID="Chart1" runat="server" Height="320px" Width="960px" BorderlineColor="#C0C0C0" BorderlineDashStyle="Solid" OnClick="ImgeMap_Click">
                        <Titles>
