<%@ Page Title="" Language="C#" MasterPageFile="~/EPSafe/EPSafe.Master" AutoEventWireup="true" CodeBehind="SafeZhuan.aspx.cs" Inherits="EPReper.Web.EPSafe.SafeZhuan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function CheckNull() {
            var v_TextBoxName = document.getElementById("<%= TextBoxName.ClientID%>").value;
                        ...
                        <div style="padding-left: 10px;">
                            <asp:GridView ID="GridViewEmployee" DataKeyNames="fid" HeaderStyle-HorizontalAligna="Center" AutoGenerateColumns="false" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" OnRowDeleting="GridViewEmployee_RowDeleting" OnRowEditing="GridViewEmployee_RowEditing" OnRowUpdating="GridViewEmployee_RowUpdating" OnRowCancelingEdit="GridViewEmployee_RowCancelingEdit" AllowSorting="True" Width="520px">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="zhuanname" HeaderText="热点专题名称" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="380">
