<%@ Page Title="" Language="C#" MasterPageFile="~/EPSafe/EPSafe.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="NewsAdd.aspx.cs" Inherits="EPReper.Web.EPSafe.NewsAdd" %>
                ...
                <div>
                    <table style="width: 700px;">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Txtctitle" runat="server" Width="400px" AutoCompleteType="Disabled"></asp:TextBox>
                            </td>
                            <td style="width: 100px;">
                                所属专题
                            </td>
                             <td>
                                <asp:DropDownList ID="DropDownListZhuanTi" runat="server"  Width="140px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
