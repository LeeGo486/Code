                ...
                <div class="nav">
                    <a href="../../index.aspx" title="首页">首 页</a><a href="ReperInfo.aspx" title="我要报修"
                        style="margin-left: 10px">报 修</a><a href="ReperInfo.aspx?type=select" title="我要查询"
                            style="margin-left: 10px">查 询</a><a title="详细" style="margin-left: 10px" class="on">详细</a>
                </div>
            </div>
        </div>
            ...
            <tr>
                <td>
                    <table width="100%">
                        <tr>
                            <td align="left" width="80%">
                                <font style="font-weight: bolder; font-size: 18px; font-family: 微软雅黑;">维修任务详细</font>
                            </td>
                    ...
                    <table width="100%" bgcolor="#FFFFFF" style="background: #E6F9F9" class="table" border="0"
                        ...
                        <tr class="TR_BG">
                            <td align="right" width="15%" style="font-weight: bolder; font-family: 微软雅黑; font-size: 14px;">
                                维修类别：
                            </td>
                        ...
                        <tr class="TR_BG">
                            ...
                            <td align="left" width="85%" class="TR_BG_list">
                                <asp:Button ID="Save" Width="100px" Height="40px" Font-Size="14px" runat="server"
                                    Text="接受申请" Visible="false" OnClick="Save_Click" class="btn3_mouseout" onmouseover="this.className='btn3_mouseover'"
