            ...
            <div class="menu">
                <div class="nav">
                    <a href="../../index.aspx" title="首页">首 页</a> <span id="baoxiu" runat="server"><a
                        href="ReperInfo.aspx" title="我要报修" style="margin-left: 10px" class="on">报 修</a><a
                            href="ReperInfo.aspx?type=select" title="我要查询" style="margin-left: 10px">查 询</a></span>
                    <span id="chaxun" runat="server" visible="false"><a href="ReperInfo.aspx" title="我要报修"
                        style="margin-left: 10px">报 修</a><a href="ReperInfo.aspx?type=select" title="我要查询"
                            class="on" style="margin-left: 10px">查 询</a></span><span id="admins" runat="server"
                                visible="false"><a href="../ReperClass/ReperClass_List.aspx" title="我是管理员" style="margin-left: 10px">管理员</a><a
                                    href="../ReperInfo/SelectRI.aspx" style="margin-left: 10px" title="数据统计">数据统计</a></span>
                </div>
            </div>
        </div>
            ...
            <tr>
                <td>
                    <table width="100%">
                        <tr>
                            <td align="left" width="40%" id="da" runat="server">
                                <font style="font-size: 20px; font-family: 微软雅黑; color: Black;">维修任务申请 </font>
                            </td>
                    ...
                    <table width="100%" bgcolor="#FFFFFF" style="background: #E4F3FC" class="table" border="0"
                        ...
                        <tr class="TR_BG">
                            <td width="8%" align="left" style="font-size: 20px; font-family: 微软雅黑;">
                                维修项目
                            </td>
                            <td style="padding-left: 30px; font-size: 20px; font-family: 微软雅黑;" align="left"
                                width="92%">
                                维修类别
                            </td>
                        </tr>
