                ...
                <div class="nav">
                    <a href="../../index.aspx" title="首页">首 页</a><a href="ReperInfo.aspx" style="margin-left: 10px"
                        title="我要报修">报 修</a><a href="ReperInfo.aspx?type=select" style="margin-left: 10px"
                            title="我要查询" class="on">查 询</a><span id="admins" runat="server" visible="false"><a
                                href="../ReperClass/ReperClass_List.aspx" style="margin-left: 10px" title="我是管理员">管理员</a><a
                    ...
                    <table width="100%">
                        <tr>
                            <td align="left" width="80%" colspan="2">
                                <font style="font-size: 20px; font-weight: bolder; font-family: 微软雅黑;">维修排名</font>
                            </td>
