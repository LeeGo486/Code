...
namespace EPReper.Web.View
{
    public partial class OrderHistory : System.Web.UI.Page
    {
        ...
        protected void BtnSaveToExcel(object sender, EventArgs e)
        {
            ...
            string SqlString="SELECT USERNAME as 用户 ,USERTEL as 电话号码,USERDEPT as 部门"
                         +" ,USERDOCTOR as 医师 ,USERDATE as 星期 ,USERTIME as 时间段 ,USERSTATE as 状态"
                         + " ,CONVERT(varchar(100), STARTTIME, 23)  as 日期 FROM [EPHealth].[dbo].[HealthUserOrder] where 1=1 ";
            string condition = "";
            ...
            CreateExcel(ds1, "HealthOrder" + DateTime.Now.Date.ToShortDateString() + ".xls");
