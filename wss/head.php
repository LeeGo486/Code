...
<?php exit;} ?>
  ...
  <div class="topbar" id="headerlink" >
	...
	<a href="index.php" class="
	  ...
	  <a href="default_report.php" class="
	  <?php if($pagename == "default_report.php"){
	  echo "nav_select";} ?>
	  "><?php echo $multilingual_head_report; ?></a>
    </div>
...
var blinkTitle = function (option) {
    ...
    if (option) {
        ...
        newTitle = '<?php echo $multilingual_newmessage1;?> HWA';
        title = '<?php echo $multilingual_newmessage2;?> HWA';
        interval = 600;
    }
...
step++;
if (step==3) {step=1};
if (step==1) {document.title='<?php echo $multilingual_newmessage1;?> HWA'};
if (step==2) {document.title='<?php echo $multilingual_newmessage2;?> HWA'};
