...
function report_list(){
	...
	$sql_Query ="call ReportAll($user_id)";
	$result = mysql_query($sql_Query,$tankdb) or die(mysql_error());
	$row = mysql_num_rows($result);
	$report_list_array = mysql_fetch_array($result);
	return $report_list_array;
}
