...
$multilingual_error_logintext = "<strong>错误:</strong> 请核对用户名或密码，重新登陆。";
...
$multilingual_error_captchatext = "验证错误:难道你是机器人？";
// *** 面包屑
...
$multilingual_userlogin_captcha = "验证";
...
$multilingual_default_taskstatusf = "未完成";
...
$multilingual_default_sorrytipup = "没有符合条件的任务.";
...
$multilingual_default_day_start = "开始时间";
$multilingual_default_day_end = "结束时间";
...
$multilingual_tasklog_liveday = "距完工日期";
$multilingual_tasklog_day = "天(含节假日)";
$multilingual_tasklog_changeuser = "转让任务";
$multilingual_tasklog_changeto = "任务转让给";
...
$multilingual_taskf_year = "不限年";
$multilingual_taskf_month = "不限月";
$multilingual_taskf_day = "不限日期";
...
$multilingual_taskadd_nosub = "没有子任务";
...
$multilingual_user_filter_selall = "选择全部";

$multilingual_default_task_cctome_title = "抄送给我的任务";

$multilingual_default_task_users = "联系人";
$multilingual_default_task_lastusers = "常用联系人";
$multilingual_tasklog_changeuser_tips = "任务转让后，您将不能再对该任务进行转让或填写日志";

$multilingual_default_task_copy = "复制";
$multilingual_default_task_copyto = "复制到";
...
$multilingual_project_file_filetitle = "请填写文档标题";
...
$multilingual_project_file_title = "标题";
...
$multilingual_user_selectrole = "不限角色";
...
$multilingual_user_view_nolog = "没有符合条件的工作日志.";
...
$multilingual_user_chart_title = "工时分布";
$multilingual_user_level = "用户权限";

$multilingual_report_all = "整体需求情况";
$multilingual_report_single = "明细需求情况";
$multilingual_report_day = "每日汇报情况";
$multilingual_report_single_title = "需求名称";
$multilingual_report_pm_title = "PM";

$multilingual_user_about = "关于用户";
$multilingual_user_abouttext = "<p>您可以根据需要为您团队的每一个成员创建不同权限的用户帐号，用户被创建后，可以使用“帐号”与“密码”登录系统。</p>
<br />
<p>角色为禁用的用户，将被禁止登录系统，适用于已经离开团队的成员；</p><br/>
<p>当您需要删除一个用户时，请谨慎操作，用户一旦被删除，与其相关的所有数据将无法查询，为了保证数据的完整性，我们强烈建议将其角色改为“禁用”，而非直接删除用户。</p>
<br />
<p>角色为管理员的用户，可以创建、修改、以及删除任意的用户（包括管理员），建议谨慎的授予管理员权限。</p>
<br />
...
$multilingual_announcement_list_showoff = "下线公告";
...
$multilingual_announcement_list_online = "在线公告";
...
$multilingual_upload_done = "已经成功上传，点击“确定”可将该附件添加至页面中。";
...
$multilingual_message_nomsg = "您没有新消息";
$multilingual_message_newmsg1 = "您有 ";
...
<a href = 'http://mp.weixin.qq.com/mp/appmsg/show?__biz=MjM5NDQ0NzU1Mw==&appmsgid=200076061&itemidx=1&sign=45586428463a4fefadb45f595c7dca89#wechat_redirect' target ='_blank'>详见WSS mobile使用说明</a>
<br /><a href='http://weixin.qq.com' target ='_blank'>没有微信的用户，请先安装微信</a>
";
