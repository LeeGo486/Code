...
?></td>
  ...
  <tr>
    ...
    <td><?php 
	if($row_Recordset_sumsublog['sum_sublog'] == null){  //增加判断是否有子任务，如果有子任务则取子任务的值
  ...
  <tr>
    ...
    <td><?php 
	if($row_Recordset_sumplan['sum_plan_hour'] == null){  //增加判断是否有子任务，如果有子任务则取子任务的值	 
  ...
  <tr>
    <td class="info_task_title"><?php if($row_Recordset_task['csa_plan_hour'] <> null){ ?>
        <?php 
	  if ($plan_hour==null) {
	  $over_hour=$plan_subhour - $sum_subhour;  
	  }else {
