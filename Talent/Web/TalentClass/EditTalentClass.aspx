...
<div class="pageContent">
	...
	<form method="post" action="ajaxWebServices.ashx" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone);">
		...
		<div class="pageFormContent" layoutH="58">
            <div class="unit">
				<label>序号：</label>
				<input type="text" class=" textInput" readonly="readonly"  name="TC_No" id="TC_No" runat="server" />
			</div>
            <div class="unit">
				<label>人才类别：</label>
				<input type="text" class=" textInput required"  name="TC_Class" id="TC_Class" runat="server" />
			</div>
			<div class="unit">
				<label>标注颜色：</label>
				<div class="colorPicker_controlset"><input id="TC_Color" type="text" name="TC_Color" value="#ffffff" runat="server" class="required"  /></div>
			</div>
		</div>
