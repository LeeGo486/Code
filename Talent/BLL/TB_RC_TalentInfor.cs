		...
		public List<Talent.Model.TB_RC_TalentInfor> DataTableToList(DataTable dt)
		{
			...
			if (rowsCount > 0)
			{
				...
				for (int n = 0; n < rowsCount; n++)
				{
                    ...
                    //if (dt.Rows[n]["TI_OtherCBName"] != null && dt.Rows[n]["TI_OtherCBName"].ToString() != "")
                    //{
                        model.TI_OtherCBName = dt.Rows[n]["TI_OtherCBName"].ToString();
                    //}
                    ...
                    if (dt.Rows[n]["TI_OtherRecommendPost"] != null && dt.Rows[n]["TI_OtherRecommendPost"].ToString() != "")
                    {
                    model.TI_OtherRecommendPost = dt.Rows[n]["TI_OtherRecommendPost"].ToString();
                    }
                    ...
                    if (dt.Rows[n]["TI_Email"] != null && dt.Rows[n]["TI_Email"].ToString() != "")
                    {
                        model.TI_Email = dt.Rows[n]["TI_Email"].ToString();
                    }
                    if (dt.Rows[n]["TI_Reason"] != null && dt.Rows[n]["TI_Reason"].ToString() != "")
                    {
                        model.TI_Reason = dt.Rows[n]["TI_Reason"].ToString();
                    }
                    if (dt.Rows[n]["TI_Interviewer"] != null && dt.Rows[n]["TI_Interviewer"].ToString() != "")
                    {
                        model.TI_Interviewer = dt.Rows[n]["TI_Interviewer"].ToString();
                    }
					modelList.Add(model);
				}
			}
