<%@ page language="C#" autoeventwireup="true" inherits="buyproductuser_BP_UserBackList, App_Web_bp_userbacklist.aspx.4969a439" %>
...
<body  topmargin="10" leftmargin="10">
   ...
   <!--head end-->
    ...
    <tr>
            ...
            <Columns>
                  ...
                  <asp:TemplateField HeaderText="图片">
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="BP_UserWriteNoSureEidter.aspx?MaterSubid=<%#Eval("MaterSubid") %>"  title="<%#Eval("MaterID") %>的供应商管理" >进入修改</a>
                        </ItemTemplate>
                    </asp:TemplateField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server"  SelectMethod="CG_GetPublishMaterByUserBackList" TypeName="ddl_cgnew"  >
