<%@ page language="C#" autoeventwireup="true" inherits="buyproductuser_BP_UserMasterList, App_Web_bp_usermasterlist.aspx.4969a439" %>
         ...
         <TABLE class="tbTitle" cellSpacing="0" cellPadding="0" border="0">
			<TR>
				<TD class="tdTitle1" colSpan="1" rowSpan="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;当前功能：
					<span id="rm_MainPanel_lFunctionName">采购列表</span>&nbsp;&nbsp;&nbsp;
   ...
   <!--head end-->
    ...
    <tr>
        <td colspan=2>
            ...
            <Columns>
                  ...
                  <asp:TemplateField HeaderText="图片">
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="BP_UserWriteMoneys.aspx?MaterSubid=<%#Eval("MaterSubid") %>"  title="<%#Eval("MaterID") %>的供应商管理" >报价</a>
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <EmptyDataTemplate>
                <table id="ctl00_ctplhder_GridViewf" border="1" cellpadding="3" cellspacing="0" rules="cols" width="100%" >
                     <tr  Class="dgHeader" >
                         <th scope="col">货物号</th>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server"  SelectMethod="CG_GetPublishMaterByUserdata" TypeName="ddl_cgnew"  >
