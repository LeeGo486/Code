<%@ page language="C#" autoeventwireup="true" inherits="buyproductuser_BP_UserTrackDetailHave, App_Web_bp_usertrackdetailhave.aspx.4969a439" %>
...
<asp:BoundField DataField="Writedate" HeaderText="完成时间" SortExpression="Writedate" HtmlEncode="false" DataFormatString="{0:d}" ReadOnly="true"  />
 ...
 <tr>
   ...
   <tr>
   <td align="left">
       <asp:Label ID="LblSubmit" runat="server" Text="发送跟进留言"></asp:Label></td>
   </tr>
    <tr>
   <td style="width: 100%">
                           <!----contant submit------------------>
                            ...
                            <tr>
                            <td align="center">    <asp:Button ID="BtnSubmit2" runat="Server"  Text="提交"   CssClass="btn"  Width="100px" OnClick="BtnSubmit_Click" /> </td>
                            </tr>
                            <tr>
                            <td align="center">
