<%@ page language="C#" autoeventwireup="true" inherits="buyproductuser_BP_UserPublishHistory, App_Web_bp_userpublishhistory.aspx.4969a439" %>
...
<body  topmargin="10" leftmargin="10">
         ...
         <TABLE class="tbTitle" cellSpacing="0" cellPadding="0" border="0">
			<TR>
				<TD class="tdTitle1" colSpan="1" rowSpan="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;当前功能：
					<span id="rm_MainPanel_lFunctionName">历史采购列表</span>&nbsp;&nbsp;&nbsp;
   ...
   <!--head end-->
    ...
    <tr>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server"  SelectMethod="CG_GetPublishMaterByUserandHistory" TypeName="ddl_cgnew" OldValuesParameterFormatString="original_{0}"  >
