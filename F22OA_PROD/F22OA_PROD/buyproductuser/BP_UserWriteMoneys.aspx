<%@ page language="C#" autoeventwireup="true" maintainscrollpositiononpostback="true" inherits="buyproductuser_BP_UserWriteMoneys, App_Web_bp_userwritemoneys.aspx.4969a439" %>
...
<body  topmargin="100" leftmargin="100">
   ...
   <!--head end-->
    ...
    <td align="left">
        ...
        <asp:HiddenField ID="HFMaterType" runat="server" />
    </td>
    </tr>
     <tr>
    <td align="left">
