<%@ page language="C#" autoeventwireup="true" inherits="buyproductuser_BP_UserTrack, App_Web_bp_usertrack.aspx.4969a439" %>
...
<body  topmargin="10" leftmargin="10">
    ...
    <!--head end-->
        ...
        <td>
               ...
               <asp:ListItem Text="已结案" Value="over"></asp:ListItem>
               <asp:ListItem Text="全部" Value="all"></asp:ListItem>
               <asp:ListItem Text="跟进中" Value="no"></asp:ListItem>
    ...
    <td align="left">
      <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
           ...
           <asp:ObjectDataSource ID="ObjectDataSource1" runat="server"  SelectMethod="CG_GetTrackSupplyer" TypeName="ddl_cgnew" >
            <SelectParameters>
