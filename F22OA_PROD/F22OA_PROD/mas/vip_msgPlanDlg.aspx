<%@ page language="C#" autoeventwireup="true" inherits="vip_msgPlanDlg, App_Web_vip_msgplandlg.aspx.e229d74e" %>
    ...
    <tr>
      <td> 
          ...
          <asp:GridView ID="gv" runat="server" AllowPaging="True" AllowSorting="True" DataKeyNames="msgplanid"
              ...
              onrowcreated="gv_RowCreated"   onpageindexchanging="gv_PageIndexChanging" 
                  onrowdatabound="gv_RowDataBound">
              <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
              <Columns>                  
                      <asp:TemplateField HeaderText="主题" SortExpression="title">
                      <ItemTemplate>
                      <a id="aid" runat="server"><%# Eval("title").ToString().Length > 10 ? Eval("title").ToString().Substring(0, 10) + "..." : Eval("title")%> </a>
                      </ItemTemplate>
                  </asp:TemplateField>
