<%@ page language="C#" autoeventwireup="true" inherits="vip_msgPlan_upd, App_Web_vip_msgplan_upd.aspx.e229d74e" %>
...
<body style="margin-left:5px; margin-right:5px;">
   ...
   <table  width="98%">
    <tr>   
        <td align="right">
       <span style="white-space:nowrap;"> <asp:Button ID="BtnSave" Width="100px" runat="server" Text="保 存" CssClass="btn" OnClick="BtnSave_onclick" />
        &nbsp;       
    ...
    <td align="left">
        ...
        <td >
          ...
          <asp:DropDownList ID="drpType" runat="server"  Width="120" Enabled="false"></asp:DropDownList></td>
        </tr>  
         <tr>
        <td class="ltd" style="height: 20px" > 自动运行:</td>
        <td >
       
          <asp:DropDownList ID="drpAuto" runat="server" Width="120"><asp:ListItem Text="否" Value="0"></asp:ListItem><asp:ListItem Text="是" Value="1"></asp:ListItem></asp:DropDownList>
           </td>
        </tr>                           
       <tr>
        ...
        <td >
         ...
         <div style="margin-top:10px;">   编号：<asp:TextBox ID="txtNo" runat="server" Width="20px" MaxLength="3" Text="1" ReadOnly="true" ></asp:TextBox>
