...
case "2063" 'POS正常退货
  ...
  session("PkSName")="outindent" '短名
  session("PkName")="outindentid" '主键名
  session("tablename")="d_outindentpro" '表名
  session("tablesub")="d_outindentprosub" '子表名
  session("SPName")="f22_lr"& session("PkSName") &"sub" '用到的存储过程名
  session("d_type")=1 'backrate正常标识
  session("nums")="nums"
