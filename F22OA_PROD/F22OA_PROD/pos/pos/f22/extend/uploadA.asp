...
<form method="post" action="upload2A.asp" enctype="multipart/form-data" name="form2" onSubmit="initAd();">
  <input type=file name="sf_upfile" size="15" class=text>
  <input type="hidden" name="fname" value="<%request.Form("fname")%>" class="text">
