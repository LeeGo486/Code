...
<table width="100%" height="46" border="0" cellspacing="0" class="f14">
  <tr valign="middle" class="tcontent"> 
    <td height="30" bordercolor="#C6AEA5" background="img/smbg_b.gif" class="bk">业务操作 &gt;&gt; 订货 </td>
  </tr>
    ...
    <td width="300" height="350" valign="top"> 
      <table width="300" height="88" border="0">
		...
		<tr>
		  ...
		  <td height="22" align="center" background="img/smbg.gif" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)" onClick="" class="mout"> 看图订货</td>
          </a>
	    </tr>
		<tr>
          <td height="41" id="t1">&nbsp;</td><a href="javascript:opensel(2)">
		  <td height="22" align="center" background="img/smbg.gif" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)" onClick="" class="mout"> 看图订货（单色码）</td>
          </a>
	    </tr>
        <tr>
          <td height="41" id="t1">&nbsp;</td><a href="2061_retailstockDH.asp">
		  <td height="22" align="center" background="img/smbg.gif" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)" onClick="" class="mout"> 看图订货（列表显示）</td>
          </a>
	    </tr>
		<tr>
          <td height="41" id="t1">&nbsp;</td><a href="search_frame.asp?formid=2061&action=search&pagename=<%=server.URLEncode("查询订货单")%>">
		  <td height="22" align="center" background="img/smbg.gif" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)" onClick="" class="mout"> 查询订货单</td>
          </a>
	    </tr>
		<tr>
          <td height="41" id="t1">&nbsp;</td><a href="2060_indent_track.asp">
		  <td height="22" align="center" background="img/smbg.gif" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)" onClick="" class="mout"> 查询订配发</td></a>
	    </tr>
      </table>
    </td>
