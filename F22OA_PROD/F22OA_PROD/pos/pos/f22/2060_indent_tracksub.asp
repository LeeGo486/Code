...
<input type="text" name="key" id="key" style="width:100px;" class="box" value="<%=key%>">
  <input name="button" type="submit" class="btn" id="button" value="查 询" onClick="document.all.form1.typ.value=1;document.all.form1.target='';document.all.form1.submit();">
...
<table border="1">
<tr>
<td colspan="9" align="center" height="50"><strong><%=request("id")&" 订配发差详细"%></strong></td>
</tr>
</table>
...
sql=" select a.indentid,a.styleid,a.colorid,a.sizeid,a.nums,a.phnums,"&_
	...
	t.CommandType = 1
	  ...
	  t.SetField "nums","订货数","40",1
	  t.SetField "phnums","配货数","40",1
	  t.SetField "fhnums","发货数","40",1
	  t.SetField "dpx","订配差","40",1
	  t.SetField "dfx","订发差","40",1
	t.CommandText=sql
	t.show
	set t=nothing
set cn=nothing
