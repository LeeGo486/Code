...
<table width="100%" height="46" border="0" cellspacing="0" class="f14">
  <tr valign="middle" class="tcontent"> 
    <td height="30" bordercolor="#C6AEA5" background="img/smbg_b.gif" class="bk">业务操作 &gt;&gt; 收货 </td>
  </tr>
  ...
  <tr> 
    <td width="300" height="350" valign="top"> 
      <table width="300" height="45" border="0">
		<tr> 
          <td width="40" height="41" id="t1">&nbsp;</td><a href="search_frame.asp?action=search&pagename=<%=server.URLEncode("收货确认")%>">
    ...
    <td width="280" valign="top">
      ...
      <table width="280" height="344" border="0" cellpadding="0" cellspacing="0" bordercolor="#C6AEA5">
        ...
        <tr>
          ...
          <td valign="top"><div id="content" class="gnsm">确认收仓库的发货单</div></td>
