    ...
    <td width="300" height="350" valign="top"> 
      <table width="300" height="131" border="0">
        <tr>
          ...
          <a href="2163_outindent_create.asp?action=create">
          <td height="22" align="center" background="img/smbg.gif" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)" onClick="" class="mout">制作退货申请单</td>
          </a> </tr>
		<tr> 
          <td width="40" height="41" id="t1">&nbsp;</td><a href="2163_outindent_create.asp?action=create&bar=1">
          <td height="22" align="center" background="img/smbg.gif" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)" onClick="" class="mout"> 条码退货申请单</td>
          </a>        </tr>
		<tr>
