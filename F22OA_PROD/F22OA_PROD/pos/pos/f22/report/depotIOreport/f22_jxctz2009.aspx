<%@ page language="C#" autoeventwireup="true" inherits="pos_pos_f22_report_depotIOreport_f22_jxctz2009, App_Web_f22_jxctz2009.aspx.6f48706f" %>
<html>
<head runat="server">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td width="20%" style="text-align:center;">
                        <input id="btn_chkStyle" type="button" value="选择款式" /></td>
                    <td width="50%" style="text-align:center;">选择日期：
                        <input id="txt_bdate" type="text"  runat="server" class="txtSty" onfocus="javascript:setday(this);" readonly="readonly"/> 到
                        <input id="txt_edate" type="text"  runat="server" class="txtSty" onfocus="javascript:setday(this);" readonly="readonly"/></td>
                    <td width="15%" style="text-align:center;">
                        <asp:Button ID="btn_search" runat="server" Text="查询" 
                            onclick="btn_search_Click" /></td>
                    <td width="15%" style="text-align:center;">
                        <asp:Button ID="btn_exl" runat="server" Text="导出Excel" 
                            onclick="btn_exl_Click" /></td>
                </tr>
            </table>
        </div>
