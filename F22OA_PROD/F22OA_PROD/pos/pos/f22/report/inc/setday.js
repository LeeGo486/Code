...
document.writeln('<iframe   id=meizzDateLayer   Author=wayx   frameborder=0   style="position:   absolute;   width:   160;   height:   211;   z-index:   9998;   display:   none"></iframe>');
strFrame='<style>';
...
strFrame+='<table   border=1   cellspacing=0   cellpadding=0   width=142   height=160   bordercolor=#77BBFF   bgcolor=#99ccff   Author="wayx">';
...
strFrame+='             <tr   align=center   Author="wayx"><td   width=16   align=center   bgcolor=#99ccff   style="font-size:12px;cursor:   hand;color:   #ffffff"   ';
...
strFrame+='   BORDERCOLORLIGHT=#99ccff   BORDERCOLORDARK=#FFFFFF   width=140   height=20   Author="wayx"   style="cursor:'   +   (bMoveable   ?   'move':'default')   +   '">';
...
strFrame+='         <table   border=1   cellspacing=2   cellpadding=0   BORDERCOLORLIGHT=#99ccff   BORDERCOLORDARK=#FFFFFF   bgcolor=#fff8ec   width=140   height=120   Author="wayx">';
...
if(d.getFullYear()==r[1]   &&   d.getMonth()==r[2]   &&   d.getDay()==r[3]){
outDate=d; //保存外部传入的日期
}
else   outDate="";
...
(mm==1?12:mm-1)   ==   new   Date().getMonth()+1   &&   meizzWDay[i]   ==   new   Date().getDay())   ?
  "#FFD700":"#e0e0e0";
else
{
da.style.backgroundColor   =((mm==1?yy-1:yy)==outDate.getFullYear()   &&   (mm==1?12:mm-1)==   outDate.getMonth()   +   1   &&   
meizzWDay[i]==outDate.getDay())?   "#00ffff"   :
(((mm==1?yy-1:yy)   ==   new   Date().getFullYear()   &&   (mm==1?12:mm-1)   ==   new   Date().getMonth()+1   &&   
meizzWDay[i]   ==   new   Date().getDay())   ?   "#FFD700":"#e0e0e0");
//将选中的日期显示为凹下去
if((mm==1?yy-1:yy)==outDate.getFullYear()   &&   (mm==1?12:mm-1)==   outDate.getMonth()   +   1   &&   
meizzWDay[i]==outDate.getDay())
{
...
(mm==12?1:mm+1)   ==   new   Date().getMonth()+1   &&   meizzWDay[i]   ==   new   Date().getDay())   ?
  "#FFD700":"#e0e0e0";
else
{
...
if(!outDate)
da.style.backgroundColor   =   (yy   ==   new   Date().getFullYear()   &&   mm   ==   new   Date().getMonth()+1   &&   meizzWDay[i]   ==   new   Date().getDay())?
"#FFD700":"#e0e0e0";
else
{
da.style.backgroundColor   =(yy==outDate.getFullYear()   &&   mm==   outDate.getMonth()   +   1   &&   meizzWDay[i]==outDate.getDay())?
"#00ffff":((yy   ==   new   Date().getFullYear()   &&   mm   ==   new   Date().getMonth()+1   &&   meizzWDay[i]   ==   new   Date().getDay())?
"#FFD700":"#e0e0e0");
//将选中的日期显示为凹下去
if(yy==outDate.getFullYear()   &&   mm==   outDate.getMonth()   +   1   &&   meizzWDay[i]==outDate.getDay())
{
da.borderColorLight="#FFFFFF";
da.borderColorDark="#99ccff";
}
