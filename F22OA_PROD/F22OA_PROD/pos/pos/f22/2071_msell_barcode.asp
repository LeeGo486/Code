  ...
  <tr>
    <td><form action="2071_msell_barcode_save.asp" method="get" name="form1" target="is" onSubmit="return chkform();">
	  ...
	  <input type="submit" value=" 确 定 "><input name="show" type="hidden" id="show"><input name="id" type="hidden" id="id" value="<%=id%>">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <!--<input type="button" value="提交" onClick="chksure('chksure');">-->
    </form>
    </td>
    <td><input name="bu1" type=button value="显示明细" onclick="javascript:document.form1.show.value='M';document.all.is.src='2071_msell_barcode_sub.asp?id=<%=id%>&show=M';">   
	    <input name="bu2" type=button value="显示总数" onclick="javascript:document.form1.show.value='Z';document.all.is.src='2071_msell_barcode_sub.asp?id=<%=id%>&show=Z';">
