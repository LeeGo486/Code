    ...
    <td width="300" height="350" valign="top"> 
      <table width="300" border="0">
        ...
        <tr>
          ...
          <a href="f22cz_outindentsq.asp?action=create">
		  <!--<a href="2065_outindnet_barcode_chk.asp?action=create">-->
          <td width="236" height="22" align="center" background="img/smbg.gif" class="mout" onClick="" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)">参照回复单发货</td>
          </a> </tr>
		<tr>
