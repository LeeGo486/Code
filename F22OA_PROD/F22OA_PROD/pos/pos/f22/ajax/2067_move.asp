...
{ var str,obj,typ,nums;
  ...
  obj = chkclothing('2067_move_save.asp?date()',str);
  if(obj=='true')
  {
     PlayScanSound();
	 ...
	 getjson('GetDataJson.asp?date()','act=d_moveset&id='+$("#id").val());
  }else if (obj=='no')
  {
     alert("此货品不在通知单内！");
     $("#key").focus();
...
rs.source = "select setchk_sure,indentid from d_move where moveid="&qts(id)
rs.open
if not rs.eof then
	if rs(0)>0 then
...
<table width="100%" border="1" class="f14" bordercolordark="#FFEFEF">
  <thead>
    <tr align="center">
		<td>款 号</td><td>款式名称</td><td>颜 色</td><td>尺 码</td><td>数 量</td><td>单 价</td><td>单款备注</td>
	</tr>
	<tr bgcolor="#C6E7FF" align="center">
		<td>合 计</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td id="z_nums"></td><td id="z_xprice"></td>
		<td>&nbsp;</td>
		</tr>
	<tr align=center id="sub_template">
		<td id="sub_clothingid"></td><td id="sub_sname"></td><td id="sub_colorid"></td><td id="sub_sizeid"></td><td id="sub_nums"></td><td id="sub_xprice"></td><td id="sub_comment"></td>
	</tr>
  </thead>
