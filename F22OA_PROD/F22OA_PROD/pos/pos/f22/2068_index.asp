...
<table width="100%" height="46" border="0" cellspacing="0" class="f14">
  <tr valign="middle" class="tcontent"> 
    <td height="30" bordercolor="#C6AEA5" background="img/smbg_b.gif" class="bk">业务操作 &gt;&gt; 调拔收货 </td>
  </tr>
    ...
    <td width="300" height="350" valign="top"> 
      <table width="300" height="41" border="0">
        <tr>
          ...
          <a href="search_frame.asp?action=create&pagename=<%=server.URLEncode("调拔收货确认")%>">
          <td width="236" height="22" align="center" background="img/smbg.gif" class="mout" onClick="" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)">调拔收货确认</td>
          </a> </tr>
      </table>
    </td>
    <td width="280" valign="top">
      ...
      <table width="280" height="344" border="0" cellpadding="0" cellspacing="0" bordercolor="#C6AEA5">
        ...
        <tr>
          ...
          <td valign="top"><div id="content" class="gnsm">确认收同区店铺的调货单</div></td>
