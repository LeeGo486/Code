...
<title><%=inventoryid%>单的差异明细</title>
<base target="_blank">
</head>
<style media="print">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="noprint">
  <tr height="50" align="center"> 
    <td><input type="button" name="Submit" value="关闭此窗口" style="BACKGROUND-COLOR: #FFFFFF; BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-RIGHT: 1px solid; BORDER-TOP: 1px solid; FONT-SIZE: 9pt" onClick="javascript:window.close();">
      </td>
    <td><input type="button" name="print" value="打印此单" style="BACKGROUND-COLOR: #FFFFFF; BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-RIGHT: 1px solid; BORDER-TOP: 1px solid; FONT-SIZE: 9pt" onClick="javascript:print()">
      </td>
	  <form name="form1" method="get" action="2066_inventory_cy_mx_export.asp">
	<td><input type="button" name="Submit1" value="导出Excel" style="BACKGROUND-COLOR: #FFFFFF; BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-RIGHT: 1px solid; BORDER-TOP: 1px solid; FONT-SIZE: 9pt" onClick="document.all.form1.submit();">
      </td>
