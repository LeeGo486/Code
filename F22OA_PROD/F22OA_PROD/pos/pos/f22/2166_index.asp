...
<table width="100%" height="46" border="0" cellspacing="0" class="f14">
  <tr valign="middle" class="tcontent"> 
    <td height="30" bordercolor="#C6AEA5" background="img/smbg_b.gif" class="bk">业务操作 &gt;&gt; 盘点差异 </td>
  </tr>
    ...
    <td width="300" valign="top"> 
      <table width="300" border="0">
        <tr>
          ...
          <a href="2166_inventory_create.asp?action=create">
          <td height="22" align="center" background="img/smbg.gif" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)" onClick="" class="mout">录入盘点差异 - 手工</td>
          </a> </tr>
		<tr>
          <td height="41" id="t1">&nbsp;</td>
          <a href="2166_inventory_create.asp?action=create&bar=1">
          <td height="22" align="center" background="img/smbg.gif" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)" onClick="" class="mout">录入盘点差异 - 条码</td>
          </a> </tr>
		<tr> 
          <td width="40" height="41" id="t1">&nbsp;</td><a href="search_frame.asp?pagename=<%=server.URLEncode("查询盘点差异单")%>">
          <td width="236" height="22" align="center" background="img/smbg.gif" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)" onClick="" class="mout">查询盘点差异单</td>
          </a>        </tr>
      </table>
    </td>
