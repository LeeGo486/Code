...
<SCRIPT language="JavaScript">
	...
	function gtDoDblClick(t){
		...
		showModalDialog('2060_indent_tracksub.asp?id='+id,'e','dialogWidth:700px;dialogHeight:400px;center: yes;help:no;resizable:yes;status:no');
	}
</SCRIPT>
<style>
body{margin:0}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="bar">
  <tr>
    <td align="center" style="height:30px;" colspan="14">查　询　订　配　发</td>
  </tr>
</table>
<% if cint(typ)<>2 then %>
