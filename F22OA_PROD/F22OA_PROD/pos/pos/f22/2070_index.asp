...
<table width="100%" height="46" border="0" cellspacing="0" class="f14">
  <tr valign="middle" class="tcontent"> 
    <td height="30" bordercolor="#C6AEA5" background="img/smbg_b.gif" class="bk">业务操作 &gt;&gt; 跨区调货 </td>
  </tr>
  ...
  <tr> 
    <td width="300" height="350" valign="top"> 
      <table width="300" height="45" border="0">
		<tr> 
          <td width="40" height="41" id="t1">&nbsp;</td><a href="2070_movenotice_seach.asp">
		...
		<tr> 
          <td width="40" height="41" id="t1">&nbsp;</td><a href="2071_index.asp?act=addsg">
          <td width="236" height="22" align="center" background="img/smbg.gif" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)" onClick="" class="mout">
		    直接跨区调货－手工</td>
          </a></tr> 
		<tr> 
          <td width="40" height="41" id="t1">&nbsp;</td><a href="2071_index.asp?act=addtm">
          <td width="236" height="22" align="center" background="img/smbg.gif" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)" onClick="" class="mout">
		    直接跨区调货－条码</td>
          </a></tr>   
		<tr>
		  <td width="40" height="41" id="t1">&nbsp;</td><a href="2071_index.asp?act=seach&pagename=<%=server.URLEncode("查询跨区调货发货单")%>">
          <td width="236" height="22" align="center" background="img/smbg.gif" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)" onClick="" class="mout">
		    查询跨区调货发货单</td>
          </a>        </tr>
