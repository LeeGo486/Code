...
<table width="100%" height="46" border="0" cellspacing="0" class="f14">
  <tr valign="middle" class="tcontent"> 
    <td height="30" bordercolor="#C6AEA5" background="img/smbg_b.gif" class="bk">业务操作 &gt;&gt; 盘点 </td>
  </tr>
...
<table width="100%" height=350 border="0">
  ...
  <tr> 
    <td width="300" height="350" valign="top"> 
      <table width="300" height="82" border="0">
        <tr>
          <td height="41" id="t1">&nbsp;</td>
          <a href="2066_inventory_create.asp?action=create">
          <td height="22" align="center" background="img/smbg.gif" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)" onClick="" class="mout">新建盘点单－手工</td>
          </a> </tr>
		<tr>
          <td height="41" id="t1">&nbsp;</td>
          <a href="2066_inventory_create.asp?action=create&bar=1">
          <td height="22" align="center" background="img/smbg.gif" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)" onClick="" class="mout">新建盘点单－条码</td>
          </a> </tr>  
		<tr> 
          <td width="40" height="41" id="t1">&nbsp;</td>
          <a href="search_frame.asp?pagename=<%=server.URLEncode("查询盘点单")%>">
          <td width="236" height="22" align="center" background="img/smbg.gif" onMouseOver="show(this,document.all.t1,1,1)" onMouseOut="show(this,document.all.t1,1,2)" onClick="" class="mout">查询盘点单</td>
          </a>        </tr>
      </table>
    </td>
