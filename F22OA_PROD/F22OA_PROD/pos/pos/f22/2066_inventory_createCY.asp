...
<form name="form1" method="post" action="" onSubmit="return checkform();">
  ...
  <table width="480"  border="0" align="center" class="tcontent">
    ...
    <tr>
      <td align="right">&nbsp;</td>
      <td><input name="stype" type="radio" value="0">
      全局盘点
    ...
    <tr>
      <td align="right">&nbsp;</td>
      <td><input name="bar" type="checkbox" id="bar" value="1">
        条码扫描</td>
    </tr>
  </table>
...
sub save
  ...
  if ds.eof then
	...
	if bar="1" then
	  'response.Write("window.location.href='2066_inventory_barcode.asp?id="&inventoryid&"';")
	else
