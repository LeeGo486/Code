    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="1" class="f12 Fbox">
        ...
        <tr>
            ...
            <td>
                ...
                <input  type="checkbox" id="isReceipt" name="isReceipt"  <% if isReceipt="True" then response.write("checked") end if   %>  /><label for="isReceipt">是否经常开发票</label> 
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
              <select name="Scarf" id="Scarf" >
                <option value="是" <% if Scarf="是" then response.write("selected") end if   %> >是</option>
                <option value="否" <% if Scarf="否" then response.write("selected") end if   %>>否</option>
              </select>
               </td>
       </tr>
