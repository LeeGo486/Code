...
*                            *	
******************************/
gtTables = new GtTables();						// ????(document)????gridTable
function GtTables(){
...
//************************************Color*************************************
GtTable.OVERCOLOR = "#E8E8E8";
GtTable.SELECTCOLOR = "#6273AE";//"#BEC5DE";
...
_p._gtChangeRowStyle = function(obj, type){
	if(type == "OVER"){
		...
		*/
		...
		//obj.cells[0].style.backgroundColor = GtTable.SELECTCOLOR;
	}
}
//***********************************************************************************************************8
_p.setRowInterCrossStyle= function(row){
	...
	if(rn%2 == 0)
		row.style.backgroundColor = GtTable.ODDCOLOR;//GtTable.EVENCOLOR;
	else
		row.style.backgroundColor = GtTable.ODDCOLOR;*/
		row.style.backgroundColor = GtTable.ODDCOLOR;
	try{
	ge=row.getElementsByTagName("input")[0];
	if(ge.value=="1")
		row.style.backgroundColor = "#A6CAF0";
	else if(ge.value=="2")
...
_p.repaintRow = function(index){
	...
	if(row == null){
		...
		row.repaint();
		//row.style.backgroundcolor = "#FF00FF";
}
...
//alert(this._id);
try{
	var ge=this._line.getElementsByTagName("input")[0];
	if(ge.value=="1")
		this._line.style.backgroundColor = "#A6CAF0";
	else if(ge.value=="2")
	    this._line.style.backgroundColor = "#C0C0C0";
	}catch(ex){}
	/*
...
_p.repaintColumnWidth = function(){
	...
	for(var i=0; i<tw.length; i++){
		...
		this._line.style.backgroudcolor = "#FF00FF";
	}
}
