...
<table width="100%"  border="0" cellpadding="3" cellspacing="1" class="f12 Fbox">
    <tr>
      ...
      <td width="79" align="right">购买单号：</td>
      <td width="217">
    ...
    <tr <%if session("cf_VipSet_gjxx")=false then response.write "style='display:none;'"%>>
      <td align="right">接受价位：</td>
      <td>
      <input name="vipmin" type="text" id="vipmin" size="10" maxlength="30" value="<%=vipmin%>" class="2028"> 至
    ...
    <tr>
      ...
      <input type="checkbox" value="1" name="getmag" id="getmag" /><label for="getmag">同意接收资料</label>      </td>
    </tr>
	<tr>
	...
	<tr>
	  <td align="right">VIP卡号</td><td><%=vipcode%></td>
	  <td colspan="2">总积分: <%=zcentum%>&nbsp;&nbsp;&nbsp;总储值: <%=zsums%></td>
	</tr>
	</table>
<%if id="" then%>
    <table width="100%"  border="0" cellpadding="3" cellspacing="1" class="f12 Fbox">
