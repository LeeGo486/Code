...
strFrame+='<td   style="font-size:12px;color:#FFFFFF"   Author=meizz>五</td><td   style="font-size:12px;color:#FFFFFF"   Author=meizz>六</td><td   style="font-size:12px;color:#FFFFFF"   Author=meizz>日</td></tr>';
...
var   th   =   tt;
var   ttop     =   -110;//tt.offsetTop;           //TT控件的定位点高
