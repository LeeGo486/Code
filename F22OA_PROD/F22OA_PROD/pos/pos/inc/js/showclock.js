...
function fBuildCal(iYear, iMonth) {
  ...
  var iDaysInMonth=new Date(iYear, iMonth, 0).getDay();
  var iOffsetLast=new Date(iYear, iMonth-1, 0).getDay()-iDayOfFirst+1;
  var iDate = 1;
  var iNext = 1;
...
write("<table border='0' bgcolor='#9CCF8B'>");
write("<TR>");
...
write("<DIV style='background-color:#4A7733'><table width='100%' border='0'>");
fDrawCal(giYear, giMonth, 20, '12');
write("</table></DIV>");
write("</td>");
write("</TR><TR><TD align='center'>");
write("<TABLE width='100%'><TR><TD align='center'>");
write("<B style='cursor:hand' onclick='fSetDate(0,0,0)' onMouseOver='this.style.color=gcToggle' onMouseOut='this.style.color=0'><font size=2>");
//write("清空");
write("</font></B>");
