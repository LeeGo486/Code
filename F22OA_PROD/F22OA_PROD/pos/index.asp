...
<br>
<br>
<br><form name="form1" method=post action="index_login.asp" onsubmit="return check(this)"><center>
      ...
      <tr>
        <td width="350" align="center"><table width="350" height="120" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="185"><select name="dbname" onChange="document.form1.passzt.focus();" style="width:150px">
                  <%while not rs.eof%>
