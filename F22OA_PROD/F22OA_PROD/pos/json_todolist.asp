...
sub posinfo
   ...
   'response.write("<tr height=20><td colspan=2 align=center>本店销售目标状况</td></tr>")
   'response.write("<tr><td colspan=2></td></tr>")
   if session("cf_posinfo_day") then
   response.write("<tr><td>今天原目标</td><td><font  color=red>￥ "&dayymb&"</td></tr>")
   response.write("<tr><td>今天实际目标</td><td><font  color=red>￥ "&daysmb&"</td></tr>")
   response.write("<tr><td>今天总销额</td><td><font  color=red>￥ "&dayretail&"</td></tr>")
   response.write("<tr><td>今天达标率</td><td><font  color=red>"&daybl&" %</td></tr>")
   end if
   if session("cf_posinfo_month")  then
   response.write("<tr><td colspan=2><hr size=1></td></tr>")
   response.write("<tr><td>本月原目标</td><td><font  color=red>￥ "&monthymb&"</td></tr>")
   
   if session("cf_posinfo_monthreal") then
      response.write("<tr><td>本月实际目标</td><td><font  color=red>￥ "&monthsmb&"</td></tr>")
   end if   
   
   response.write("<tr><td>本月总销额</td><td><font  color=red>￥ "&monthretail&"</td></tr>")
   
   if session("cf_posinfo_monthbl") then
      response.write("<tr><td>本月达标率</td><td><font  color=red>"&monthbl&" %</td></tr>") 
   end if 
   response.write("<tr><td>本月完成率</td><td><font  color=red>"&monthwcl&" %</td></tr>") 
   end if
   if session("cf_posinfo_year") then
   response.write("<tr><td colspan=2><hr size=1></td></tr>")
   response.write("<tr><td>今年目标</td><td><font  color=red>￥ "&zm&"</td></tr>")
   response.write("<tr><td>今年总销额</td><td><font  color=red>￥ "&zretail&"</td></tr>")
   response.write("<tr><td>今年总达标率</td><td><font  color=red>"&zbl&" %</td></tr>")
   end if
...
sub posinfo1
   ...
   response.write("<table width=100% border=0 style=""font-size:12px;margin:5px 0 5px 5px ;width:96%"">")
   if session("cf_posinfo_day") then
   response.write("<tr><td>今天目标</td><td><font  color=red>￥ "&dayymb&"</td></tr>")
   response.write("<tr><td>今天总销额</td><td><font  color=red>￥ "&dayretail&"</td></tr>")
   response.write("<tr><td>今天达标率</td><td><font  color=red>"&daybl&" %</td></tr>")
   end if
   if session("cf_posinfo_month")  then
   response.write("<tr><td colspan=2><hr size=1></td></tr>")
   response.write("<tr><td>本月目标</td><td><font  color=red>￥ "&monthymb&"</td></tr>")
   response.write("<tr><td>本月总销额</td><td><font  color=red>￥ "&monthretail&"</td></tr>")
   response.write("<tr><td>本月达标率</td><td><font  color=red>"&monthbl&" %</td></tr>") 
   end if
   if session("cf_posinfo_year") then
