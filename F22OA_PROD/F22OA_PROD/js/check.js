...
function LoadWindow(url,w,h)
{
  ...
  var rtw=window.showModalDialog(url,self,"edge:sunken;scroll:auto;status:0;help:0;resizable:1;dialogWidth:"+w+"px;dialogHeight:"+h+"px;dialogTop:"+loc_y+"px;dialogLeft:"+loc_x+"px");
}
//弹出窗口
