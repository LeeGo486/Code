...
<tr><td colspan=4 width="196" bgcolor="#C0C0C0"><input type="button" value="  =  " onClick="compute(this.form)"><input type="button" value=<%=ResourceManager.GetString("insertcalculator")%> onClick='insertCount(computetoedit(this.form));' LANGUAGE=javascript><input onclick="parent.popMenu2.hide();" type="button" value='<%=ResourceManager.GetString("close")%>' />
</table>
</form>
</body>
</html>