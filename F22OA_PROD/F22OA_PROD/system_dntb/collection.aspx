...
function resizeLoad()
{
load.style.top = parseInt((document.documentElement.clientHeight-load.offsetHeight)/2+document.documentElement.scrollTop);
load.style.left = parseInt((document.documentElement.clientWidth-load.offsetWidth)/2+document.documentElement.scrollLeft);
}
if(is_ie)
{
