<%@ page language="C#" autoeventwireup="true" inherits="buyproduct_manager_publish_BP_PublishAdd, App_Web_bp_publishadd.aspx.874e4ad9" %>
...
GB_myShow = function(caption, url, /* optional */ height, width, callback_fn) {
    ...
    return win.show(url);
       ...
       <script language="javascript" type="text/javascript">
        ...
        { 
        		var id=	window.document.getElementById("TxtPublishCode2").value;
		        if (id=="" || id==undefined)
		        {
...
<body  topmargin="10" leftmargin="10">
    ...
    <!--head-->   <uc1:uc_pagehead id="Uc_pagehead1" runat="server" />
   ...
   <table  width="98%" class="menu">
    ...
    <div >
      ...
      <asp:Button ID="BtnGo" Width="100px" runat="server" Text="未审申请" CssClass="btn" CausesValidation="false"   OnClientClick="window.location.href='BP_PublishUnChkUser.aspx'; return false;"   />
    ...
    <td align="left">
        ...
        <td >
            发布编号:</td>
              <td align="left" >
                  <asp:TextBox ID="TxtPublishCode" runat="server" MaxLength="100" Width="200px" CssClass="tbox"></asp:TextBox><asp:RequiredFieldValidator
        ...
        <td >
            ...
            <td>
             ...
             <td>    申请日期:</td>
             <td> <igsch:WebDateChooser ID="WebDateChooserCrdate" runat="server" Value="" Width="200">
    ...
    <td >
            ...
            <Columns>
                    ...
                    <asp:BoundField DataField="Matergetdate" HeaderText="到货日期" SortExpression="Matergetdate" DataFormatString="{0:d}" HtmlEncode="false"  />
                      ...
                      <asp:TemplateField HeaderText="供应商数">
                        <ItemTemplate>
                            <a href="BP_PublishSuperList.aspx?pid=<%#Eval("PublishCode") %>&mid=<%#Eval("MaterID") %>"  rel="gb_pageset[search_sites]" title="<%#Eval("MaterID") %>的供应商管理" ><img src="../../../icon/go3.gif" border="0" /> <%#Eval("Supernum") %></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                        <!--  <a href="BP_PublishSuperList.aspx?pid=<%#Eval("PublishCode") %>&mid=<%#Eval("MaterID") %>"  rel="gb_pageset[search_sites1]" title="<%#Eval("MaterID") %>的供应商管理" ><%#Eval("Supernum") %></a> -->
