<%@ page language="C#" autoeventwireup="true" inherits="buyproduct_manager_publish_BP_PublishEditMater, App_Web_bp_publisheditmater.aspx.874e4ad9" %>
   ...
   <table  width="98%">
    ...
    <td align="left">
        ...
        <td >
            物料编号:</td>
              <td align="left" >
                   <asp:TextBox ID="TxtMaterNo" runat="server" CssClass="tbox" MaxLength="100" Width="200px" Enabled="False"></asp:TextBox><asp:RequiredFieldValidator
        ...
        <td >
            规 &nbsp; &nbsp;格:</td>
        <td >
            <asp:TextBox ID="TxtModelName" runat="server" MaxLength="50" Width="200" CssClass="tbox"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="TxtModelName"></asp:RequiredFieldValidator></td>
     <td >
        ...
        <td>
          ...
          <td >
            <asp:TextBox ID="TxtModelCode" runat="server" MaxLength="50" Width="200" CssClass="tbox"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="*" ControlToValidate="TxtModelCode"></asp:RequiredFieldValidator></td>
        </tr>
     <tr>
        <td >
            颜 &nbsp; &nbsp;色:</td>
        <td >
            <asp:TextBox ID="TxtColorName" runat="server" MaxLength="50" Width="200" CssClass="tbox"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="*" ControlToValidate="TxtColorName"></asp:RequiredFieldValidator></td>
     <td >
     ...
     <td >
        ...
        <td >
            到货时间:</td>
        <td >
            &nbsp;<igsch:WebDateChooser ID="WebDateChooserMatergetdate" runat="server" Value="" Width="200">
            </igsch:WebDateChooser>
            </td>
     <td >
     ...
     <td style="height: 16px" >
        ...
        <td style="height: 16px">
          ...
          <td style="height: 16px"  >
          <input id="File1" runat="server" class="tbinput" name="File" style="width: 200px"
           onchange="changepic(this.value)"  type="file" />
              </td>
        </tr>
           <tr>
        <td >
     ...
     <td >
        ...
        <td>
          ...
          <td valign="top" >
            ...
            <asp:Image  ID="ImgNew" ImageUrl="../../../images/nophoto.gif" runat="server"  Height="150" Width="150" />
