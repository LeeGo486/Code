<%@ page language="C#" autoeventwireup="true" inherits="buyproduct_manager_chkprice_BP_ChkMsgNewlist, App_Web_bp_chkmsgnewlist.aspx.68adc8a" %>
     ...
     <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                  ...
                  <asp:TemplateField HeaderText="是否已阅" SortExpression="toread" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden">
                   ...
                   <asp:TemplateField HeaderText="历史交谈" SortExpression="SupplyNo">
                        <ItemTemplate>
                             <a href="BP_ChkMsgList.aspx?SupMoneyID=<%# Eval("SupMoneyID") %>" onclick="return GB_show('历史交谈', this.href)" title='' >  <img src="../../../icon/go3.gif" border="0" />查看</a>
                        </ItemTemplate>
                    </asp:TemplateField>
            </Columns>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server"  SelectMethod="CG_GetMsgNewList" TypeName="ddl_cgnew" OldValuesParameterFormatString="original_{0}" >
            <SelectParameters>
