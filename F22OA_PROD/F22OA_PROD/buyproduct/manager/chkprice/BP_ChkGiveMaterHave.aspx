<%@ page language="C#" autoeventwireup="true" inherits="buyproduct_manager_chkprice_BP_ChkGiveMaterHave, App_Web_bp_chkgivematerhave.aspx.68adc8a" %>
...
<body  topmargin="10" leftmargin="10">
         ...
         <TABLE class="tbTitle" cellSpacing="0" cellPadding="0" border="0">
			<TR>
				<TD class="tdTitle1" colSpan="1" rowSpan="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;当前功能：
					<span id="rm_MainPanel_lFunctionName">分配物料明细</span>&nbsp;&nbsp;&nbsp;
    ...
    <div class="menu">
          ...
          <asp:Button ID="BtnGo" Width="100px" runat="server" Text="返回" CssClass="btn"   OnClientClick="window.location.href='BP_ChkHistory.aspx'; return false;"   />
     </div>  
        </td> 
    </tr>
    </table>
            ...
            <Columns>
                    ...
                    <asp:BoundField DataField="PublishID" HeaderText="PublishID" ReadOnly="True" SortExpression="PublishID" Visible="False" />
                      <asp:TemplateField HeaderText="供应商" SortExpression="SupplyNo">
                        <ItemTemplate>
                            <a href="../basic/BP_BSSupplyerDetail.aspx?LoginID=<%# Eval("SupplyerID") %>&SupplyNo=" rel="gb_pageset[search_sites]" title='供应商明细' ><%#HFMaterID.Value.ToString()  %></a>
                        </ItemTemplate>
                    </asp:TemplateField>
