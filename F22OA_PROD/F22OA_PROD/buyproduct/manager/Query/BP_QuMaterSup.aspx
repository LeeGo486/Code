<%@ page language="C#" autoeventwireup="true" inherits="buyproduct_manager_Query_BP_QuMaterSup, App_Web_bp_qumatersup.aspx.40adaeda" %>
...
<uc1:uc_pagehead id="Uc_pagehead1" runat="server" />
        ...
        <tr>
            <td colspan="5">
                ...
                &nbsp;<asp:RadioButton ID="RBtnCode" runat="server" Text="供应商编号" GroupName="aa" Checked="true" />
            <asp:RadioButton ID="RBtnName" runat="server" Text="公司名称" GroupName="aa" /></td>
    ...
    <td align="left">
      <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            AutoGenerateColumns="False" CellPadding="3" DataKeyNames="SupmaterID"  PageSize="20"   CssClass="tbGrid"
            ...
            <Columns>
                    <asp:BoundField DataField="PublishID" HeaderText="PublishID" ReadOnly="True" SortExpression="PublishID" Visible="False" />
                     ...
                     <asp:TemplateField HeaderText="合同编号" SortExpression="SignCode">
                        <ItemTemplate>
                            <a href="../publish/BP_PublishChkDetailHave.aspx?hid=<%#Eval("SignCode") %>"  rel="gb_pageset[search_sites3]"  >  <img src="../../../icon/go3.gif" border="0" /><%#Eval("SignCode")%></a>
                        </ItemTemplate>
                    </asp:TemplateField>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server"  SelectMethod="CG_GetSignMaterBySup" TypeName="ddl_cgnew" >
           <SelectParameters>
