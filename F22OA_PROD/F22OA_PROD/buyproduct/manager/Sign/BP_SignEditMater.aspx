<%@ page language="C#" autoeventwireup="true" inherits="buyproduct_manager_Sign_BP_SignEditMater, App_Web_bp_signeditmater.aspx.9fbedc62" %>
    ...
    <td align="left">
     ...
     <td >
        ...
        <td >
            单 &nbsp; &nbsp; 价:</td>
        <td >
            <asp:TextBox ID="TxtPrice" runat="server" MaxLength="50" Width="200" CssClass="tbox"></asp:TextBox><asp:RequiredFieldValidator
                ID="RequiredFieldValidator2" runat="server" ControlToValidate="TxtPrice"
                ErrorMessage="*"></asp:RequiredFieldValidator>
     ...
     <td >
        ...
        <td>
          ...
          <td >
            <asp:TextBox ID="TxtTax" runat="server" MaxLength="50" Width="200" CssClass="tbox"></asp:TextBox>
              <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TxtTax"
                  Display="Dynamic" ErrorMessage="*数字类型" ValidationExpression="(^-?\d\d*\.\d*$)|(^-?\d\d*$)|(^-?\.\d\d*$)"></asp:RegularExpressionValidator></td>
        </tr>
           <tr>
        <td >
