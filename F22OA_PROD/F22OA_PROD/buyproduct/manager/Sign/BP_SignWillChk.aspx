<%@ page language="C#" autoeventwireup="true" inherits="buyproduct_manager_Sign_BP_SignWillChk, App_Web_bp_signwillchk.aspx.9fbedc62" %>
     ...
     <uc1:uc_pagehead id="Uc_pagehead1" runat="server" />
      ...
      <td>
          ...
          <asp:ListItem Value="1" Text="已审"></asp:ListItem>
            ...
            <asp:CheckBox ID="CheckBoxAll" runat="server" Text="所有待审" /></td>
             ...
             <asp:TemplateField HeaderText="选择" >
                   ...
                   <asp:BoundField DataField="SignDate" HeaderText="签定日期" SortExpression="SignDate" DataFormatString="{0:d}" HtmlEncode="False" />  
                    ...
                    <asp:TemplateField HeaderText="编辑">
                        ...
                        <a href="BP_SignChkDetail.aspx?hid=<%# Eval("SignCode")%>">进入审核</a>  
                        </ItemTemplate>
                    </asp:TemplateField>
            </Columns>
