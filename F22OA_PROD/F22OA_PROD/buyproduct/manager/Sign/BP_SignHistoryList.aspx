<%@ page language="C#" autoeventwireup="true" inherits="buyproduct_manager_Sign_BP_SignHistoryList, App_Web_bp_signhistorylist.aspx.9fbedc62" %>
     ...
     <TABLE class="tbTitle" cellSpacing="0" cellPadding="0" border="0">
			<TR>
				<TD class="tdTitle1" colSpan="1" rowSpan="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;当前功能：
					<span id="rm_MainPanel_lFunctionName">待跟进的采购</span>&nbsp;&nbsp;&nbsp;
      ...
      <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
              ...
              <asp:TemplateField HeaderText="合同编号" SortExpression="SignCode">
                        <ItemTemplate>
                            <a href="BP_SignPrint.aspx?hid=<%# Eval("SignCode") %>" rel="gb_pageset[search_sites3]"  >  <img src="../../../icon/go3.gif" border="0" /><%# Eval("SignCode")%></a>
                        </ItemTemplate>
                    </asp:TemplateField>
                   ...
                   <asp:BoundField DataField="SignDate" HeaderText="签定日期" SortExpression="SignDate" DataFormatString="{0:d}" HtmlEncode="False" />  
                    ...
                    <asp:TemplateField HeaderText="编辑">
                        ...
                        <a href="BP_SignAdd.aspx?hid=<%# Eval("SignCode")%>">编辑</a>  
                        </ItemTemplate>
                    </asp:TemplateField>
            </Columns>
           ...
           <asp:ObjectDataSource ID="ObjectDataSource1" runat="server"  SelectMethod="CG_GetSignUnchkUser" TypeName="ddl_cgnew" OldValuesParameterFormatString="original_{0}" >
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="HFCrUser" Name="CrUser" PropertyName="Value" Type="string" />
                <asp:ControlParameter ControlID="HFState" Name="Type" PropertyName="Value" Type="int16" />
            </SelectParameters>
