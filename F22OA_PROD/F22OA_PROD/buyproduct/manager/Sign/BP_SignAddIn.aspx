<%@ page language="C#" autoeventwireup="true" inherits="buyproduct_manager_Sign_BP_SignAddIn, App_Web_bp_signaddin.aspx.9fbedc62" %>
...
<body  topmargin="10" leftmargin="10">
   ...
   <table  width="98%" class="menu">
    ...
    <div >
      ...
      <asp:Button ID="BtnGo" Width="100px" runat="server" Text="返 回" CssClass="btn" CausesValidation="false"   OnClientClick="window.location.href='BP_SignWillList.aspx'; return false;"   />
      <asp:Button ID="BtnSave" Width="100px" runat="server" Text="保 存" CssClass="btn" OnClick="btnSave_Click"  OnClientClick="post()" />
      <a  href="BP_SignPrint.aspx?hid=<%=TxtSignCode.Text %>" class="btn" target="_blank"> <asp:Button ID="Btn" Width="100px" runat="server" Text="打印预览" CssClass="btn" OnClientClick="gop()"   /></a>
     </div>  
        </td> 
    </tr>
    </table>
    ...
    <td align="left">
     ...
     <td style="height: 16px" >
        ...
        <td valign="top" colspan="4" >
                <P id="MyFile">
                            <input id="File1" runat="server" class="tbox" name="File" style="width: 450px" 
                                type="file" />&nbsp;</P>
               </td>
        </tr>
        <tr>
   ...
   <tr>
    ...
    <td >
            ...
            ForeColor="#333333" GridLines="None" ShowFooter="true" RowStyle-HorizontalAlign="Center" Width="100%" OnRowDataBound="GridViewMater_RowDataBound">
