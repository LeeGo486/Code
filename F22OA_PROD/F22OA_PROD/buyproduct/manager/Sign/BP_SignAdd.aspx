<%@ page language="C#" autoeventwireup="true" maintainscrollpositiononpostback="true" inherits="buyproduct_manager_Sign_BP_SignAdd, App_Web_bp_signadd.aspx.9fbedc62" %>
   ...
   <table  width="98%" class="menu">
    ...
    <div >
      ...
      <asp:Button ID="BtnSave" Width="100px" runat="server" Text="保 存" CssClass="btn" OnClick="btnSave_Click"  OnClientClick="post()" />
       <asp:Button ID="Btn" Width="100px" runat="server" Text="打印预览" CssClass="btn" OnClientClick="gop()"   />
     </div>  
        </td> 
    </tr>
    </table>
    ...
    <asp:GridView ID="GridView1" runat="server" AllowSorting="True"
            ...
            <Columns>
                 ...
                 <asp:TemplateField HeaderText="文件名称" SortExpression="Signfilename">
                    <ItemTemplate>
                   <a href="../../../<%# Eval("fileUrl")%>" target="_blank"><img src="../../../icon/go3.gif" border="0" /><%# EidtSupter(Eval("SupmaterID").ToString()) %></a>
                    </ItemTemplate>
                </asp:TemplateField>
