<%@ page language="C#" autoeventwireup="true" inherits="buyproduct_manager_Sign_BP_SignAddMater, App_Web_bp_signaddmater.aspx.9fbedc62" %>
...
<body  topmargin="100" leftmargin="100">
   ...
   <table  width="98%">
    ...
    <td align="center">
     ...
     <tr>
    <td >
    <asp:Label ID="Label2" runat="server" Text="说明：物料的通用名称，规格，颜色是显示给供应商识别的"  ></asp:Label>
        </td>
    </tr>
    <tr>
    <td align="left">
