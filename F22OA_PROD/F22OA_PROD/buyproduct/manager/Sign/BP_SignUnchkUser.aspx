<%@ page language="C#" autoeventwireup="true" inherits="buyproduct_manager_Sign_BP_SignUnchkUser, App_Web_bp_signunchkuser.aspx.9fbedc62" %>
...
<body  topmargin="10" leftmargin="10">
     ...
     <TABLE class="tbTitle" cellSpacing="0" cellPadding="0" border="0">
			<TR>
				<TD class="tdTitle1" colSpan="1" rowSpan="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;当前功能：
					<span id="rm_MainPanel_lFunctionName">合同列表</span>&nbsp;&nbsp;&nbsp;
    ...
    <asp:TemplateField HeaderText="合同编号" SortExpression="SignCode">
           ...
           <asp:ObjectDataSource ID="ObjectDataSource1" runat="server"  SelectMethod="CG_GetSignUnchkUser" TypeName="ddl_cgnew"   >
            <SelectParameters>
