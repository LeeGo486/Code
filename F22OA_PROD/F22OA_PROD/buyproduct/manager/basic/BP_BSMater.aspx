<%@ page language="C#" autoeventwireup="true" inherits="buyproduct_manager_basic_BP_BSMater, App_Web_bp_bsmater.aspx.11713791" %>
   ...
   <asp:Label ID="Label1" runat="server" Text="编号名称:"></asp:Label>
    ...
    <td>
      ...
      <asp:Button ID="BtnSearch" Width="100px" runat="server" Text="查  询" CssClass="btn"  OnClick="BtnSearch_Click"     />
               ...
               <asp:Button ID="BtnAdd" Width="100px" runat="server" Text="新增物料" CssClass="btn"  CausesValidation="false"   OnClientClick="window.location.href='BP_BSMaterAdd.aspx'; return false;"    />
      </td>
    </tr>
    </table>
    <!--menu----->
          ...
          <table width="100%">
                             ...
                             <ContentTemplate>
                                    ...
                                    <asp:Panel ID="Panel1" runat="server"  Height="500px" Width="700px" ScrollBars="auto">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" Width="100%" font-Size="10pt" 
                                            AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" PageSize="15" DataKeyNames="flid" cellpadding="3" CssClass="tbGrid" CellSpacing="1" 
                        ...
                        <ItemTemplate><asp:CheckBox runat="server" ID="ckbDel"  /></ItemTemplate>
                                 ...
                                 &nbsp; &nbsp; &nbsp;
                                        ...
                                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="CG_GetMyMaterByTypeAll"
                                            TypeName="ddl_cgnew">
                                            <SelectParameters>
