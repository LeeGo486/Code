<%@ page language="C#" autoeventwireup="true" inherits="buyproduct_manager_basic_BP_BSNewEdit, App_Web_bp_bsnewedit.aspx.11713791" %>
...
<body  topmargin="10" leftmargin="10">
   ...
   <table  width="98%" class="menu">
    ...
    <div >
      ...
      <asp:Button ID="BtnGo" Width="100px" runat="server" Text="返 回" CssClass="btn"   OnClientClick="window.location.href='BP_BSNewList.aspx'; return false;"   />
    ...
    <td>
        发布人:</td>
    <td><asp:TextBox ID="TxtUUser" runat="server" MaxLength="50" Width="400px" CssClass="tbox"></asp:TextBox><asp:RequiredFieldValidator
