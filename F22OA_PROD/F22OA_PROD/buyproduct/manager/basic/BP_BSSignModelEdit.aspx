<%@ page language="C#" autoeventwireup="true" maintainscrollpositiononpostback="true" inherits="buyproduct_manager_basic_BP_BSSignModelEdit, App_Web_bp_bssignmodeledit.aspx.11713791" %>
...
<body  topmargin="10" leftmargin="10">
         ...
         <TABLE class="tbTitle" cellSpacing="0" cellPadding="0" border="0">
			<TR>
				<TD class="tdTitle1" colSpan="1" rowSpan="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;当前功能：
					<span id="rm_MainPanel_lFunctionName">采购合同模板添加</span>&nbsp;&nbsp;&nbsp;
   ...
   <table  width="98%" class="menu">
    ...
    <div >
      ...
      <asp:Button ID="BtnGo" Width="100px" runat="server" Text="返 回" CssClass="btn"   OnClientClick="window.location.href='BP_BSSignModel.aspx'; return false;"   />
    ...
    <td>
        模板编号:</td>
    <td><asp:TextBox ID="TxtModelNo" runat="server" MaxLength="100" Width="200px" CssClass="tbox"></asp:TextBox><asp:RequiredFieldValidator
                      ID="RequiredFieldValidator2" runat="server" ControlToValidate="TxtModelNo"
                      ErrorMessage="*"></asp:RequiredFieldValidator></td>
    <td></td>
    <td>
        模板名称:</td>
    <td><asp:TextBox ID="TxtModelName" runat="server" MaxLength="100" Width="200px" CssClass="tbox"></asp:TextBox><asp:RequiredFieldValidator
                      ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtModelName"
                      ErrorMessage="*"></asp:RequiredFieldValidator></td>
    </tr>
    <tr>
    <td>
