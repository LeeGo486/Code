<%@ page language="C#" autoeventwireup="true" inherits="buyproduct_manager_basic_BP_BSSuptyperThr, App_Web_bp_bssuptyperthr.aspx.11713791" %>
...
<body  topmargin="10" leftmargin="10">
         ...
         <TABLE class="tbTitle" cellSpacing="0" cellPadding="0" border="0">
			<TR>
				<TD class="tdTitle1" colSpan="1" rowSpan="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;当前功能：
					<span id="rm_MainPanel_lFunctionName">物料小类管理</span>&nbsp;&nbsp;&nbsp;
   ...
   <table  width="98%" class="menu">
    ...
    <div >
      ...
      <asp:Button ID="BtnSave" Width="100px" runat="server" Text="查看物料大类" CssClass="btn"   OnClick="BtnSave_Click"  />
     </div>  
        </td> 
    </tr>
    </table>
    ...
    <div  class="BContent">
        ...
        <br />
        <asp:HiddenField ID="HFPidfrist" runat="server" />
        &nbsp;
        &nbsp;&nbsp;
