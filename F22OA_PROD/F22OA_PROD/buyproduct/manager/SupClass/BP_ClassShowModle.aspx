<%@ page language="C#" autoeventwireup="true" inherits="buyproduct_manager_SupClass_BP_ClassShowModle, App_Web_bp_classshowmodle.aspx.b80b976e" %>
       ...
       <tr>
                                    ...
                                    <asp:Label ID="LblTitle" runat="server" Width="510px" ForeColor="Red"></asp:Label>&nbsp;
                                        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" Width="100%"  CssClass="tbGrid" CellSpacing="1" 
                                            AutoGenerateColumns="False" DataKeyNames="TyperID"  CellPadding="4"  
                                            BorderWidth="1px" GridLines="None" ForeColor="#333333"  HorizontalAlign="Center"  OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataSourceID="ObjectDataSource1">
                                            <Columns>
                ...
                <asp:TemplateField SortExpression="TyperNo" HeaderText="级别代码" HeaderStyle-Width="100px">
                <ItemTemplate>
                 <asp:Label ID="LblTyperNo" runat="server" Text='<%# Bind("TyperNo") %>'></asp:Label>         
                </ItemTemplate>
                </asp:TemplateField>

                <asp:TemplateField SortExpression="TyperName" HeaderText="级别名称">
                <ItemTemplate>
                     <asp:Label ID="LblTyperName" runat="server" Text='<%# Bind("TyperName") %>'></asp:Label>
                </ItemTemplate>
                </asp:TemplateField>
                
                <asp:TemplateField SortExpression="TtyperScore" HeaderText="级别分数">
                <HeaderStyle Width="90px">
                </HeaderStyle>
                <ItemTemplate>
                      <asp:Label ID="LblTtyperScore" runat="server" Text='<%# Bind("TtyperScore") %>'></asp:Label>  
                </ItemTemplate>
                </asp:TemplateField>
                
                <asp:TemplateField SortExpression="Commet" HeaderText="备注">
                <ItemTemplate>
                                    <asp:Label ID="LblCommet" runat="server" Text='<%# Bind("Commet") %>'></asp:Label>
           ...
           <asp:ObjectDataSource id="ObjectDataSource1" runat="server" TypeName="ddl_cgnew" SelectMethod="CG_GetClassSupply" >
