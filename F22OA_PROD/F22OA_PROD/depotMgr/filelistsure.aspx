<%@ page language="C#" autoeventwireup="true" inherits="depotMgr_filelistsure, App_Web_filelistsure.aspx.9ee944ed" %>
...
<%--项模板--%>
        ...
        <div style="width:10%;">
             <asp:LinkButton ID="config3" runat="server" CommandName="update"
               OnClientClick="return confirm('是否审核通过该文档?')">审核</asp:LinkButton>
             <asp:LinkButton ID="config2" runat="server" CommandName="delete" 
                 OnClientClick="return confirm('是否移除该文档?')">移除</asp:LinkButton>
        </div>
