<%@ page language="C#" masterpagefile="~/cashcard/main/sys/SysMaster.master" autoeventwireup="true" inherits="web_rolesaspx, App_Web_web_rolesaspx.aspx.9597e00c" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ctplhder" Runat="Server">
    <uc1:web_TreeFram ID="Web_TreeFram1" runat="server" />
</asp:Content>
