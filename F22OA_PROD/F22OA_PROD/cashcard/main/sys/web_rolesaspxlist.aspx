<%@ page language="C#" autoeventwireup="true" inherits="sys_web_rolesaspxlist, App_Web_web_rolesaspxlist.aspx.9597e00c" %>
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White"></BorderDetails>
        ...
        <asp:ObjectDataSource ID="ds_aspx" runat="server" OnSelecting="ds_aspx_Selecting" SelectMethod="selectNoUserSel" TypeName="app_userroles" OldValuesParameterFormatString="original_{0}">
            <SelectParameters>
                <asp:Parameter Name="rolesid" Type="Int32" />
                <asp:Parameter Name="userid" Type="String" />
                <asp:Parameter Name="touserid" Type="String" />
            </SelectParameters>
