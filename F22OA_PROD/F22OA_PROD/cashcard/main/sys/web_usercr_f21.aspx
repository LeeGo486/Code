<%@ page language="C#" autoeventwireup="true" inherits="web_usercr_f21, App_Web_web_usercr_f21.aspx.9597e00c" %>
...
　　            }
        ...
        function save_add(userid,username)
		{
                ...
                var url="web_usercrxml.aspx?SaveType=1&userid=" +userid+"&username="+escape(username)+"&mid="+merid.innerHTML+"&dptid="+dptid.innerHTML+"&dtype="+dtpye.innerHTML;
...
<body style="text-align: center">
    <form id="from1" runat="server">
        ...
        <table style="width: 312px; height: 27px;">
                        <tr>
                            <td style="width: 120px">
                                编号</td>
                            <td style="width: 58px">
                                <input id="Text_userid" style="width: 64px" type="text" onkeydown="javascript:return TBchanged(this)" maxlength="4" /></td>
                            <td style="width: 200px">
                                姓名</td>
                            <td style="width: 100px">
                                <input id="Text_username" style="width: 91px" type="text" onkeydown="javascript:return TBchanged(this)" maxlength="10" /></td>
                            <td style="width: 100px">
            <asp:LinkButton ID="lnkAdd" runat="server" Width="46px">添加</asp:LinkButton></td>
                        </tr>
                    </table>
        &nbsp;<br />
