<%@ page language="C#" autoeventwireup="true" inherits="car_userEdit1Detailhis, App_Web_useredit1detailhis.aspx.f3086b61" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>修改历史客户信息</title>
...
<body>
    ...
    <div>
        <table width=100%>
                    ...
                    <asp:FormView ID="FormView1" runat="server" DataKeyNames="proposerid" DataSourceID="ObjectDataSource1" Width=100%>
                        ...
                        <ItemTemplate>
                         <table border=1 width=100% align=center cellpadding=0 cellspacing=0 bordercolor="#cccccc"  bordercolordark="#ffffff">
                                <tr height=40><td colspan=2 align=center><font color=red size=3>维护申请人档案</font></td></tr>
                                <tr height=20>
            ...
            <tr>
                <td >
                    ...
                    &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:HyperLink ID=hylReturn runat=server NavigateUrl='userEdit1his.aspx?aspxid=CA1081&aspxname=维护历史申请人档案' Text="返回"></asp:HyperLink>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:carcn %>"
            SelectCommand="SELECT * FROM [j_proposer_history]"></asp:SqlDataSource>
            
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetUpdateProposerhis"
            TypeName="jcard">
            <SelectParameters>
