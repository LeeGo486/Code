<%@ page language="C#" autoeventwireup="true" inherits="car_userQuery1Detailhis1, App_Web_userquery1detailhis1.aspx.f3086b61" %>
        ...
        <table width=100%>
                    ...
                    <asp:FormView ID="FormView1" runat="server" DataKeyNames="proposerid" DataSourceID="ObjectDataSource1" Width=100%>
                        ...
                        <ItemTemplate>
                         <table border=1 width=100% align=center cellpadding=0 cellspacing=0 bordercolor="#cccccc"  bordercolordark="#ffffff" >
                                <tr height=40><td colspan=2 align=center><font color=red size=3>查看申请人档案</font></td></tr>
                                <tr height=20>
            ...
            <tr>
                <td  align=center>
                    ...
                    <asp:HyperLink ID=hylReturn runat=server NavigateUrl='userquery1his.aspx?aspxid=CA1091&aspxname=查询历史申请人档案' Text="返回"></asp:HyperLink>
