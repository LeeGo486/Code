<%@ page language="C#" autoeventwireup="true" masterpagefile="~/cashcard/main/car/carmaster.master" inherits="user_queryaddmoney, App_Web_user_queryaddmoney.aspx.f3086b61" %>
...
<asp:CompareValidator id="CompareValidator1" runat="server" Font-Size="9pt" Font-Names="宋体" Display="Dynamic" Operator="GreaterThanEqual" Type="Date" ControlToCompare="WebDateChooser1" SetFocusOnError="True" ErrorMessage="日期填写不正确" ControlToValidate="WebDateChooser2"></asp:CompareValidator></TD><TD style="WIDTH: 405px">&nbsp;<asp:Label id="lbldepot" runat="server" Font-Size="9pt" Font-Names="宋体" Width="36px" Text="姓名："></asp:Label> <asp:TextBox id="txtName" runat="server" Font-Size="9pt" Font-Names="宋体" Width="98px" BorderStyle="None"></asp:TextBox>&nbsp;&nbsp;
    &nbsp;<asp:Button id="btnNext" onclick="btnNext_Click" runat="server" Font-Size="9pt" Font-Names="宋体" Width="60px" Text="查询" Height="24px"></asp:Button> <asp:Button id="BtnPrint" runat="server" Font-Size="9pt" Font-Names="宋体" Width="60px" Text="打印" Height="24px" OnClick="BtnPrint_Click"></asp:Button> </TD></TR></TBODY></TABLE></FIELDSET> </TD></TR></TBODY></TABLE>　　　　　　　 
<%--</contenttemplate>
    </asp:UpdatePanel>--%>
        </td>
    </tr>
    <tr>
    <td>
    <asp:Label ID="Label3" runat="server">一次打印最多只能选五张卡</asp:Label>
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
<asp:ObjectDataSource id="ObjectDataSource1" runat="server" TypeName="dlogging" SelectMethod="selectDateBegEndName">
            <SelectParameters>
