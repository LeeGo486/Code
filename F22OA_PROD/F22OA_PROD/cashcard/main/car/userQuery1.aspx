<%@ page language="C#" masterpagefile="carmaster.master" autoeventwireup="true" inherits="userQuery1, App_Web_userquery1.aspx.f3086b61" title="Untitled Page" %>
...
<table>
   ...
   <contenttemplate>--%>
<BR />
<TABLE  cellSpacing=0 cellPadding=0 width=740 align=left border=0><TBODY><TR>
<TD colSpan=2>
    <fieldset >
        <legend>查询条件</legend>
        ...
        <asp:Button id="Button1" runat="server" Width="68px" Text="打印"></asp:Button>
...
<asp:GridView id="GridView1" DataKeyNames="proposerid" runat="server" Width="100%" PageSize="15" AllowSorting="True" AllowPaging="True" GridLines="None" ForeColor="#333333" CellPadding="4" AutoGenerateColumns="False"  OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
...
<asp:BoundField DataField="cardnum" HeaderText="卡数"></asp:BoundField>
<asp:TemplateField HeaderText="卡明细">
    <ItemTemplate>
        <asp:HyperLink  runat="server" Text='卡明细' NavigateUrl='<%# "userQuery1Detail.aspx?ProposerID=" + DataBinder.Eval(Container, "DataItem.proposerid") %> ' ID="Hyperlink2">
    </asp:HyperLink>
    </ItemTemplate>
</asp:TemplateField>
...
<asp:ObjectDataSource  id="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" TypeName="jproposer" SelectMethod="queryselect"><SelectParameters>
...
<asp:ObjectDataSource  id="ObjectDataSource2" runat="server" OldValuesParameterFormatString="original_{0}"  TypeName="jproposer" SelectMethod="queryselectcommon"><SelectParameters>
<asp:Parameter Type="String" Name="username" DefaultValue="-"></asp:Parameter>
<asp:Parameter Type="String" Name="userid" DefaultValue="--"></asp:Parameter>
</SelectParameters>
</asp:ObjectDataSource>
