<%@ page language="C#" autoeventwireup="true" inherits="Project_client_mng_state_edit, App_Web_mng_state_edit.aspx.fc906236" %>
...
<body>
    ...
    <table cellSpacing="1" cellPadding="1" width="99%" bgColor="#666666">
				...
				<tr>
					<td bgColor="#ffffff">
						<INPUT class="button" id="btadd" accessKey="a" type="button" value="新建(A)" onclick="OpenWin('mng_state_add.aspx',305,150);">
						<FONT face="宋体">查找内容:
				...
				<tr>
					<td bgColor="#ffffff" class="header"><FONT face="宋体">客户状态设置</FONT></td>
				</tr>
				<tr>
					<td bgColor="#ffffff">
						<asp:datagrid id="dgmng" runat="server" Width="100%" AutoGenerateColumns="False" ForeColor="#696969" OnItemCommand="dg_ItemCommand">
							...
							<Columns>
								<asp:TemplateColumn HeaderText="选择">
									...
									<ItemTemplate>
										<asp:CheckBox ID="ckbox" Runat="server" tooltip='<%# DataBinder.Eval(Container, "DataItem.stateid") %>'>
										</asp:CheckBox>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="编号">
									...
									<ItemTemplate>
										<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.stateid") %>' ID="Label1">
										</asp:Label>
									</ItemTemplate>
									<EditItemTemplate>
										<asp:TextBox runat="server" CssClass="tbox" MaxLength=8 ID=tbitemid Width=55px Text='<%# DataBinder.Eval(Container, "DataItem.stateid") %>'>
										</asp:TextBox>
									</EditItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="状态名称">
									<ItemTemplate>
										<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.state") %>' ID="Label2">
										</asp:Label>
									</ItemTemplate>
									<EditItemTemplate>
										<asp:TextBox runat="server" CssClass="tbox" MaxLength=40 Width=120px ID=tbitem Text='<%# DataBinder.Eval(Container, "DataItem.state") %>'>
										</asp:TextBox>
									</EditItemTemplate>
								</asp:TemplateColumn>
