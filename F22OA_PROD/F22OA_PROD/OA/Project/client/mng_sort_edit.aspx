<%@ page language="C#" autoeventwireup="true" inherits="Project_client_mng_sort_edit, App_Web_mng_sort_edit.aspx.fc906236" %>
...
<body>
    ...
    <table cellSpacing="1" cellPadding="1" width="99%" bgColor="#666666">
				...
				<tr>
					<td bgColor="#ffffff">
						<INPUT class="button" id="btadd" accessKey="a" type="button" value="新建(A)" onclick="OpenWin('mng_sort_add.aspx',305,150);">
						<FONT face="宋体">查找内容:
				...
				<tr>
					<td bgColor="#ffffff" class="header"><FONT face="宋体">客户类别设置</FONT></td>
				</tr>
				<tr>
					<td bgColor="#ffffff">
						<asp:datagrid id="dgmng" runat="server" Width="100%" AutoGenerateColumns="False" ForeColor="#696969" OnItemCommand="dg_ItemCommand">
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="编号">
									...
									<ItemTemplate>
										<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.sortid") %>' ID="Label1">
										</asp:Label>
									</ItemTemplate>
									<EditItemTemplate>
								...
								<asp:TemplateColumn HeaderText="类别名称">
									<ItemTemplate>
										<asp:Label runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.sortname") %>' ID="Label2">
										</asp:Label>
									</ItemTemplate>
									<EditItemTemplate>
										<asp:TextBox runat="server" CssClass="tbox" MaxLength=40 Width=120px ID=tbitem Text='<%# DataBinder.Eval(Container, "DataItem.sortname") %>'>
										</asp:TextBox>
									</EditItemTemplate>
								</asp:TemplateColumn>
