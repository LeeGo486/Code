<%@ page language="C#" autoeventwireup="true" inherits="Project_client_mng_way_add, App_Web_mng_way_add.aspx.fc906236" %>
...
<body topmargin="1" leftmargin="1">
    ...
    <table width="300" border="0" cellpadding="1" cellspacing="1" bgcolor="#999999">
				<tr>
					<td colspan="2" class="header">新建客户行业:</td>
				</tr>
				<tr>
					<td width="440" bgcolor="#ffffff" class="tdright" style="WIDTH: 440px">行业编号(A):</td>
					<td width="287" bgcolor="#ffffff">
						<asp:TextBox id="tbcode" nullable="n" cname="行业编号" strnum="y" accessKey="a" runat="server" MaxLength="8"
				...
				<tr>
					<td colspan="2" bgcolor="#ffffff" class="footer">&nbsp;
						...
						<INPUT class="btn" type="button" onclick="CloseWindow('添加所属行业');" value="关闭(Z)" accessKey="z"></td>
				</tr>
			</table>
    </div>
    </form>
