<%@ page language="C#" autoeventwireup="true" inherits="Project_Module_sway, App_Web_sway.aspx.d7a0d114" %>
...
<head runat="server">
		...
		<script Language="JavaScript"  type="text/javascript">
			function click_model(ID){
				...
				setParentValue('tbvway',ID);
				setParentValue('tbway',cname);
								...
								<asp:DataList id="dls" runat="server" BorderColor="#ffffcc" width="100%" CssClass="small">
									...
									<ItemTemplate>
										<tr class="TableControl" onMouseover="chgStyle(this,'#fff','#06c')" onMouseout="chgStyle(this,'','')"
											style="CURSOR: hand; ">
											<td class="menulines" align="center" onClick='javascript:click_model("<%# DataBinder.Eval(Container, "DataItem.wayid") %>")' id='<%# DataBinder.Eval(Container, "DataItem.wayid") %>' height="22" ><%# DataBinder.Eval(Container, "DataItem.way") %></td>
										</tr>
									</ItemTemplate>
