<%@ page language="C#" autoeventwireup="true" inherits="Project_Module_ssource, App_Web_ssource.aspx.d7a0d114" %>
...
<title>选择客户来源</title>		
		...
		<script Language="JavaScript"  type="text/javascript">
			function click_model(ID){
				...
				setParentValue('tbvsource',ID);
				setParentValue('tbsource',cname);
								...
								<asp:DataList id="dls" runat="server" BorderColor="#ffffcc" width="100%" CssClass="small">
									<HeaderTemplate>
										<tr class="TableHeader">
											<td bgcolor="#d6e7ef" align="center" height="25" class="header">选择客户来源</td>
										</tr>
									</HeaderTemplate>
									<ItemTemplate>
										<tr class="TableControl" onMouseover="chgStyle(this,'#fff','#06c')" onMouseout="chgStyle(this,'','')"
											style="CURSOR: hand">
											<td class="menulines" align="center" onClick='javascript:click_model("<%# DataBinder.Eval(Container, "DataItem.sourceid") %>")' id='<%# DataBinder.Eval(Container, "DataItem.sourceid") %>' name='<%# DataBinder.Eval(Container, "DataItem.source") %>' height="22" >
