								...
								<asp:DataList id="dgsub" runat="server" Width=100%>
									...
									<ItemTemplate>
											...
											<TR>
												...
												<TD align=center>
													<a target="main" href='../msg/msg_send.aspx?touserid=<%# DataBinder.Eval(Container, "DataItem.id") %>,&tousername=<%# DataBinder.Eval(Container, "DataItem.username") %>,'><img src="../../icon/sms.gif" style="border:0" title="发送短信" /></a>
													<a target="main" href='../mail/mail_write.aspx?touserid=<%# DataBinder.Eval(Container, "DataItem.id") %>,&tousername=<%# DataBinder.Eval(Container, "DataItem.username") %>,'><img src="../../icon/email_new.gif" style="border:0" title="发送邮件" /></a>
												</TD>
											</TR>
										</table>
									</ItemTemplate>
