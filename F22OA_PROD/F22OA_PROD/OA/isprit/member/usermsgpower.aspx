<%@ page language="C#" autoeventwireup="true" inherits="OA_isprit_member_usermsgpower, App_Web_usermsgpower.aspx.be6dd291" %>
								...
								<asp:DataList id="dgsub" runat="server" Width=100%>
									...
									<ItemTemplate>
											...
											<TR>
												...
												<TD align=center>
													<a target="main" href='../msg/msg_send.aspx?touserid=<%# DataBinder.Eval(Container, "DataItem.id") %>,&tousername=<%# Server.UrlEncode(DataBinder.Eval(Container, "DataItem.username").ToString()) %>,'><img src="../../icon/sms.gif" style="border:0" title="发送短信" /></a>
													<a target="main" href='../mail/mail_write.aspx?touserid=<%# DataBinder.Eval(Container, "DataItem.id") %>,&tousername=<%# Server.UrlEncode(DataBinder.Eval(Container, "DataItem.username").ToString()) %>,'><img src="../../icon/email_new.gif" style="border:0" title="发送邮件" /></a>
												</TD>
											</TR>
										</table>
									</ItemTemplate>
