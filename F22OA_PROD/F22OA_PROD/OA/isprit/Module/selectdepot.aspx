<%@ page language="C#" autoeventwireup="true" inherits="OA_isprit_Module_selectdepot, App_Web_selectdepot.aspx.a91202c5" %>
...
function click_user(user_id){
	var toId   = parent_window.getElementById("TO_ID2");
	var toName = parent_window.getElementById("TO_NAME2");
...
function begin_set(){
//获取TO_ID的值
var TO_VAL=parent_window.getElementById("TO_ID2").value;
//遍历所有标签
				...
				<tr>
					...
					<td rowspan="2" align="center" valign="top" style="width: 153px;">
						<TABLE id="tbmain" cellSpacing="0" cellPadding="0" width="150" border="0" style="WIDTH: 150px; HEIGHT: 44px"
							tabIndex="3">
							<TR>
								<TD style="CURSOR: hand; HEIGHT: 12px" onclick="add_all()" align="center" bgColor="#33cccc"><FONT face="宋体" size="2">选择所有用户</FONT></TD>
							</TR>
							<TR>
								<TD style="CURSOR: hand; HEIGHT: 18px" onclick="del_all()" align="center" bgColor="#6699cc"><FONT face="宋体" size="2">取消所有用户</FONT></TD>
							</TR>
							<TR>
										...
										<asp:datalist id="dluser" runat="server" Width="100%" BackColor="White" BorderWidth="1px" GridLines="Horizontal"
											...
											<ItemTemplate>
												<tr width="100%" class="TableLine2">
													<td  id='<%# DataBinder.Eval(Container, "DataItem.depotid") %>' name='<%# DataBinder.Eval(Container, "DataItem.d_name") %>'  onclick='javascript:click_user("<%# DataBinder.Eval(Container, "DataItem.depotid") %>")'  class="menulines" align="center" style="cursor:hand"><%# DataBinder.Eval(Container, "DataItem.d_name")%></td>
												</tr>
											</ItemTemplate>
