<%@ page language="C#" autoeventwireup="true" inherits="OA_isprit_news_d_newsadd, App_Web_d_newsadd.aspx.9a188d08" %>
...
<body  style="margin:0;">
   ...
   <td style="height: 28px">
       <asp:Label ID="Label9" runat="server" Text="公告标题:" Width="80px"></asp:Label></td>
   <td style="height: 28px">
