...
strFrame+='<table   border=1   cellspacing=0   cellpadding=0   width=142   height=160   bordercolor=#99ccff   bgcolor=#99ccff   Author="wayx">';
...
function   meizzSetDay(yy,mm)       //主要的写程序**********
{
    ...
    var   day1   =   1,day2=1,firstday   =   new   Date(yy,mm-1,1).getDate();     //某月第一天的星期几
