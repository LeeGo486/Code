...
//                alert("当月销售目标合计[" + sums + "]不能小于本月销售目标[" + $("#lbl_TotalGoal").text() + "]");
//                $("#" + id).focus();
//                return false;
//            }
            $("#remark").text("数据保存中...")
...
<body>
    ...
    <div class="x-toolbar">
        ...
        <div class="mian">
            ...
            <thead>
            <tr class="head">
                <td width="180px">日期</td>
                <td width="120px">星期</td>
                <td width="150px">销售目标<label id="s_dw">(元)</label><input type="hidden" value="" id="hiddw" /></td>
            </tr>
            </thead>
            <tbody></tbody>
            </table>
