<%@ page language="C#" autoeventwireup="true" inherits="Retail_Modal_input_vipcard, App_Web_input_vipcard.aspx.a056ca89" %>
        ...
        $(function () {
            ...
            $("#Button5").click(function () {
                ...
                $("#DataBody tr").each(function () {
                    ...
                    */
                    s = s + "_" + "1";
                    v = $(this).find("input:radio").val().split('$')[1];
                    v += "_" + $(this).find("td").eq(0).children("input:hidden[id='vipid']").val();
                    s = s + "_" + v;
                });
