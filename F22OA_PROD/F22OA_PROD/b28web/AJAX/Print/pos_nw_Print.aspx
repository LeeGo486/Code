<%@ page language="C#" autoeventwireup="true" inherits="b28web_AJAX_Print_pos_nw_Print, App_Web_pos_nw_print.aspx.c366eeb9" %>
    ...
    <div id="mainContent">
            ...
            <asp:Repeater ID="rep_detail" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td width="13%"><%#Decimal.Round(Convert.ToDecimal(Eval("discount")),1)%></td>
        ...
        <div class="totle">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td width="40%">VIP卡号:</td>
                    <td colspan="3" width="60%"><asp:Literal ID="lit_vipCode" runat="server"></asp:Literal></td>
                </tr>
                <tr>
                    <td width="40%">付款方式：</td>
