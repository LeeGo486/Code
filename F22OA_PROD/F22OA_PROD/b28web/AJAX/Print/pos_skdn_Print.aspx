<%@ page language="C#" autoeventwireup="true" inherits="b28web_AJAX_Print_pos_skdn_Print, App_Web_pos_skdn_print.aspx.c366eeb9" %>
            ...
            <asp:Repeater ID="rep_detail" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td width="12%"><%#Convert.ToInt32( Eval("s_price")) %></td>
