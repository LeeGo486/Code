<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Modal.master" AutoEventWireup="true"
    CodeBehind="TxtImport.aspx.cs" Inherits="F23Web.Public.TxtImport" %>
        ...
        <fieldset>
            ...
            <div class="container ">
                ...
                <div class="float">
                    <label class="caption">
                        分隔符：</label>
                    <input class="field" type="radio" name="split" id="split0" value="0" />空格或TAB
                    <input class="field" type="radio" name="split" id="split1" value="1" checked="checked" />逗
                    号
                </div>
                <div class="spacer">
                    &nbsp;
