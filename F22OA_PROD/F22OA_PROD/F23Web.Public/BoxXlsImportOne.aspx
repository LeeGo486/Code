<%@ Page Title="一维电子表格导入" Language="C#" MasterPageFile="~/MasterPage/Modal.master" AutoEventWireup="true" CodeBehind="BoxXlsImportOne.aspx.cs" Inherits="F23Web.Public.BoxXlsImportOne" %>
                ...
                <div class="float">
                    <label class="caption">
                        选择Excel文件：</label><div class="uploadcontrol">
                            <iframe src="Upload.aspx?filetype=boxXlsOne" id="ifUpload" name="ifUpload" frameborder="no" scrolling="no" style="width: 180px;
                                height: 28px;"> </iframe>
                        </div>
                    <div id="uploading">
                    </div>
