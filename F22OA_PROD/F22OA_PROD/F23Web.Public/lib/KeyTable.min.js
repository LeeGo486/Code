...
}function A(M,H,L){console.log(L);var K=0;var I=r[M];for(var J=0;J<I.length;J++){if((I[J].x==H&&I[J].y==L)||(I[J].x==null&&I[J].y==L)||(I[J].x==H&&I[J].y==null)||(I[J].x==null&&I[J].y==null)){I[J].fn(E(H,L),H,L);
