...
(function($) {
    ...
    $.fn.treeview = function(settings) {
        var dfop =
            {
                ...
                */
                cbiconpath: "./Public/lib/wdTree/css/images/icons/",
        ...
        function buildnode(nd, ht, deep, path, isend) {
            ...
            //a
            ht.push("<a hideFocus class='bbit-tree-node-anchor' tabIndex=1 href='" + (nd.url || '#') + "'>");
        ...
        function nodeclick(e) {
            ...
            if (et.tagName == "IMG") {
                ...
                if (dfop.onnodeclick) {
                    ...
                    return dfop.onnodeclick.call(this, item);
                }
            }
