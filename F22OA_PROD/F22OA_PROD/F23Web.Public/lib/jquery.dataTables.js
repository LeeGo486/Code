            ...
            */
            ...
            if (oSettings.sAjaxSource !== null && !oSettings.oFeatures.bServerSide) {
                ...
                oSettings.fnServerData.call(oSettings.oInstance, oSettings.sAjaxSource, null, function(json) {
                    ...
                    /* Add by jackie 20100819 增加对WebMethod支持*/
                    if (typeof json.d == 'object') { json = json.d; }
        ...
        function _fnFeatureHtmlTable(oSettings) {
            ...
            */
            ...
            if (oSettings.oScroll.sY !== "") {
                var s = oSettings.oScroll.sY;
                if (s.indexOf('%') > 0) { s = $(window).height() * parseFloat(s.replace('%', '')) / 100; }
                nScrollBody.style.height = _fnStringToCss(s);
            }
