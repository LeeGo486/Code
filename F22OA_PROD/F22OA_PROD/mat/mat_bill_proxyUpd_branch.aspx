<%@ page language="C#" autoeventwireup="true" inherits="mat_mat_bill_proxyUpd_branch, App_Web_mat_bill_proxyupd_branch.aspx.e229d74d" %>
  ...
  <form id="form1" runat="server">
   ...
   <table  width="100%">
    <tr>   
        ...
        <input id="btnBack" type="button" class="btn" onclick="javascript:window.location.href='mat_bill_proxy_branch.aspx';" value="返回" />
        <script language="javascript" type="text/javascript">
