<%@ page language="C#" autoeventwireup="true" inherits="mat_mat_quote_zb, App_Web_mat_quote_zb.aspx.e229d74d" %>
...
<head id="Head1" runat="server">
 ...
 <script type="text/javascript">
     ...
     function chkCost() {
         return confirm("确认审核当前报价,审核后不能修改？");
     }

     function chkUnCost() {
         return confirm("确认需要反审核当前报价吗？");
     }
 </script>
    <title>费用明细</title>
</head>
<body>
    ...
    <div style="float:right;margin:5px 15px">
       ...
       <asp:Button ID="Button2" runat="server" Text="审核" CssClass="btn" onclick="Button2_Click"  OnClientClick="return chkCost()" />
       
       <asp:Button ID="Button3" runat="server" Text="反审核" CssClass="btn" onclick="Button3_Click"  OnClientClick="return chkUnCost()" />
    </div>
    <div>
