<%@ page language="C#" autoeventwireup="true" inherits="mat_mat_type_addx, App_Web_mat_type_addx.aspx.e229d74d" %>
...
<body  style="margin-left:5px; margin-right:5px;">
  ...
  <table width="98%">
    ...
    <tr>
    <td class="ltd" > 种类名称:</td>
    <td >
        <asp:DropDownList ID="drpType" runat="server"  style="width:99%;"></asp:DropDownList>
    </td>
    </tr>          <tr>
    <td class="ltd" > 品类名称:</td>
    <td >
