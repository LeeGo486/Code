<%@ page language="C#" autoeventwireup="true" inherits="mat_mat_bill_proxy_branch, App_Web_mat_bill_proxy_branch.aspx.e229d74d" %>
      ...
      <asp:GridView ID="gv" runat="server" AllowPaging="True" AllowSorting="True" DataKeyNames="billid"
          ...
          <Columns >           
             <asp:TemplateField HeaderText="选择" >
              ...
              <ItemTemplate>
                  <a style="text-decoration:underline" href='mat_bill_proxyUpd_branch.aspx?id=<%# Eval("billid") %>&chk_sure=<%# Eval("chk_sure") %>'  rel="gb_pageset[seach]"><%# Eval("d_name")%></a>
              </ItemTemplate>
              </asp:TemplateField>
