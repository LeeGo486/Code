<%@ page language="C#" autoeventwireup="true" inherits="mat_mat_bill_pos, App_Web_mat_bill_pos.aspx.e229d74d" %>
...
<tr> 
    <td colspan="9">
    <a id="abtnAdd" runat="server" style="width:100px" href="mat_bill_posAdd.aspx"  rel="gb_page_center[500,360]">  <input type="button" id="Button1"  runat="server" value="添加" class="btn" />  </a>
     <asp:Button ID="btnchkSure" Width="100px" runat="server" CssClass="btn" Text="上报" OnClick="btnchkSure_Click"   />
    <a id="aBtnEnd" runat="server" style="width:100px" href="mat_bill_posEnd.aspx"  rel="gb_page_center[320,280]">  <input type="button" id="BtnEnd"  runat="server" value="完成" class="btn"  />   </a>   
    ...
    <a id="a1" style="width:100px" href="mat_bill_pos_help.aspx"  rel="gb_page_center[380,150]">  <input type="button" id="Button2"  runat="server" value="总部联系" class="btn"  />   </a>   
    </td>
</tr>
<tr>
  <td  colspan="9"> 
      ...
      <asp:GridView ID="gv" runat="server" AllowPaging="True" AllowSorting="True" DataKeyNames="billid"
          ...
          onpageindexchanged="gv_PageIndexChanged" onrowcommand="gv_RowCommand"  onsorting="gv_Sorting"
          ...
          <Columns >           
             <asp:TemplateField HeaderText="选择" >
              ...
              <ItemTemplate>
                  <a style="text-decoration:underline" href='mat_bill_posUpd.aspx?id=<%# Eval("billid") %>&chk_sure=<%# Eval("chk_sure") %>'  rel="gb_pageset[seach]"><%# Eval("d_name")%></a>
              </ItemTemplate>
              </asp:TemplateField>
