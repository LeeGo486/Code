<%@ page language="C#" autoeventwireup="true" inherits="mat_mat_bill_proxyUpd, App_Web_mat_bill_posupd.aspx.e229d74d" %>
  ...
  <form id="form1" runat="server">
   ...
   <table  width="100%">
    <tr>   
        ...
        <input id="btnBack" type="button" class="btn" onclick="javascript:window.location='mat_bill_pos.aspx';" value="返回" />
        <script language="javascript" type="text/javascript">
             ...
             <table width="100%">
              <colgroup>
               ...
               <tr>
                ...
                <td class="ltd"></td><td ></td><td class="ltd"></td><td></td>
               </tr> 
