<%@ page language="C#" autoeventwireup="true" inherits="PrintTag, App_Web_n234bbfq" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function PrintCodeBar2014(size, clothingid) {
            ...
            LODOP.PRINT_INITA("1.1mm", "1.3mm", "38mm", "90mm", "HZY");
            //LODOP.SET_PRINT_PAGESIZE(1, "38mm", "85mm", "");

            LODOP.ADD_PRINT_BARCODE("63.8mm", "6.5mm", "38mm", "6.6mm", "Code93", clothingid);
            LODOP.SET_PRINT_STYLEA(0, "FontSize", 7);
            LODOP.SET_PRINT_STYLEA(0, "Horient", 3);
            ...
            LODOP.SET_PRINT_STYLEA(0, "FontName", "微软雅黑");
            LODOP.SET_PRINT_STYLEA(0, "FontSize", 6);
            LODOP.ADD_PRINT_TEXT("31.5mm", "11.1mm", "24.6mm", "5.3mm", safetype);
            LODOP.SET_PRINT_STYLEA(0, "FontName", "微软雅黑");
            LODOP.SET_PRINT_STYLEA(0, "FontSize", 6);
            LODOP.ADD_PRINT_TEXT("34.7mm", "1.1mm", "14.3mm", "5.3mm", "执行标准:");
            LODOP.SET_PRINT_STYLEA(0, "FontName", "微软雅黑");
            LODOP.SET_PRINT_STYLEA(0, "FontSize", 6);
            LODOP.ADD_PRINT_TEXT("34.7mm", "11.1mm", "21.7mm", "5.3mm", dotype);
            LODOP.SET_PRINT_STYLEA(0, "FontName", "微软雅黑");
            LODOP.SET_PRINT_STYLEA(0, "FontSize", 6);
            LODOP.ADD_PRINT_TEXT("25.4mm", "1.1mm", "7.9mm", "5.3mm", "产地:");
            LODOP.SET_PRINT_STYLEA(0, "FontName", "微软雅黑");
            LODOP.SET_PRINT_STYLEA(0, "FontSize", 6);
            LODOP.ADD_PRINT_TEXT("6.1mm", "6.6mm", "19.3mm", "5.3mm", brand);
            LODOP.SET_PRINT_STYLEA(0, "FontName", "微软雅黑");
            LODOP.SET_PRINT_STYLEA(0, "FontSize", 6);
            LODOP.SET_PRINT_STYLEA(0, "Bold", 1);
            ...
            LODOP.SET_PRINT_STYLEA(0, "FontName", "微软雅黑");
            LODOP.SET_PRINT_STYLEA(0, "FontSize", 6);
            LODOP.ADD_PRINT_TEXT("12.7mm", "6.6mm", "20.1mm", "5.3mm", clothingid);
            LODOP.SET_PRINT_STYLEA(0, "FontName", "微软雅黑");
            LODOP.SET_PRINT_STYLEA(0, "FontSize", 6);
            ...
            LODOP.ADD_PRINT_SHAPE(0, "5mm", "26.7mm", "0.3mm", "13.5mm", 0, 1, "#808080");
        ...
        function PrintCodeBarNew(size,clothingid){
            ...
            LODOP.PRINT_INITA("1mm","0mm","70.1mm","34.4mm","HZY");
            ...
            LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
            LODOP.SET_PRINT_STYLEA(0,"FontSize",6);
            LODOP.ADD_PRINT_TEXT("14.6mm","10.1mm","24.5mm","5.3mm",safetype);
            LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
            LODOP.SET_PRINT_STYLEA(0,"FontSize",6);
            ...
            LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
            LODOP.SET_PRINT_STYLEA(0,"FontSize",6);
            LODOP.ADD_PRINT_TEXT("20.4mm","0mm","39.7mm","13.5mm","成分:"+cf);
            LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
            LODOP.SET_PRINT_STYLEA(0,"FontSize",6);
    ...
    <form id="form1" runat="server">
        ...
        <table class="Mt" align="center">
            ...
            <tr>
                ...
                <td><asp:Label ID="lbspc" runat="server"></asp:Label></td>
            </tr>
            <tr>
